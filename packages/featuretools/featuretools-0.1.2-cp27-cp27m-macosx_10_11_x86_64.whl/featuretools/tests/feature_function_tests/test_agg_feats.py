...
from featuretools.features import Count, Mean, Sum, ALL_AGG_FEATS
from featuretools.features import Feature, SlidingWindow, SlidingMean
...
def test_get_depth(es):
    ...
    num_logs_greater_than_5 = sum_count_logs.GT(5)
...
def test_makes_rcount(es):
    dfs = DeepFeatureSynthesis(prediction_entity_id='sessions',
                               entityset=es,
                               filters=[],
