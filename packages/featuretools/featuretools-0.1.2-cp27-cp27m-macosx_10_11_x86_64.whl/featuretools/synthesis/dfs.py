...
def dfs(entities=None, relationships=None, entityset=None, prediction_entity=None, cutoff_time=None,
        instance_ids=None, agg_primitives=None, trans_primitives=None, max_depth=None,
        allowed_paths=None, ignore_entities=None, ignore_variables=None, max_features=None,
        seed_features=None, drop_exact=None, drop_contains=None, features_only=False, verbose=False):
    ...
    Args:
        ...
        prediction_entity (str): id of entity to predict on
        ...
        cutoff_time (pd.Dataframe or datetime): specifies what time to calculate
            ...
            'instance_id' and 'time' columns or a single value to calculate
            for all instances.

        instance_ids (list): list of instances to calculate features on. Only
            used if cutoff_time is a single value.
        ...
        verbose (str): Print progress info when calculating feature matrix. The
            time granularity is only per time group.

    Examples:
        .. code-block:: python

            from featuretools.features import Mean
    ...
    dfs_object = DeepFeatureSynthesis(prediction_entity, entityset,
