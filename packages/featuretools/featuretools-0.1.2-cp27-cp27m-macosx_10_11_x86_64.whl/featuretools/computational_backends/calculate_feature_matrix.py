...
def calculate_feature_matrix(features, calc_times=None, instance_ids=None,
                             time_last=None, entities=None, relationships=None, entityset=None,
    ...
    if calc_times is None:
        ...
        if instance_ids is None:
            prediction_entity = features[0].entity
            id_var = prediction_entity.id_variable
            instance_ids = prediction_entity.df[id_var].tolist()
    ...
    if verbose:
        tqdm.pandas(desc="calulate_feature_matrix", file=sys.stdout)
