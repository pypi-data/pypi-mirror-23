...
class EntitySet(BaseEntitySet):
    ...
    def head(self, entity_id, n=10, variable_id=None):
        df = self.entity_stores[entity_id].df
    ...
    def entity_from_csv(self, entity_id,
        ...
        return self._import_from_dataframe(entity_id, df, id_variable=id_variable,
    ...
    def entity_from_dataframe(self,
        ...
        # TODO look into handling secondary_time_index here
        # _operations?
        return self._import_from_dataframe(entity_id, dataframe.copy(), id_variable=id_variable,
                                           make_id_variable=make_id_variable,
                                           time_index=time_index,
                                           secondary_time_index=secondary_time_index,
                                           variable_types=variable_types,
    ...
    def _import_from_dataframe(self,
        ...
        if make_id_variable or id_variable not in dataframe.columns:
            if not make_id_variable:
                logger.warning("id_variable %s not found in dataframe, creating new integer column",
                               id_variable)
