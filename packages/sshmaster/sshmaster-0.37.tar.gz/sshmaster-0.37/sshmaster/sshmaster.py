...
def scp_cmd(current_host, mode, username, local_file, remote_file, keyfile=None, key_string=None, recursive=False, preserve_times=False, port=22, file_owner='default', file_mode='default', use_sudo=False, trys=10):
...
def scp_cmd_multi_try(current_host, mode, username, local_file, remote_file, keyfile=None, key_string=None, recursive=False, preserve_times=False, port=22, file_owner='default', file_mode='default', trys=10, use_sudo=False):
    ...
    while actual_trys != trys:
        ...
        try:
            scp_cmd(current_host=current_host, mode=mode, username=username, keyfile=keyfile, local_file=local_file, remote_file=remote_file, recursive=recursive, preserve_times=preserve_times, port=port, file_owner=file_owner, file_mode=file_mode)
