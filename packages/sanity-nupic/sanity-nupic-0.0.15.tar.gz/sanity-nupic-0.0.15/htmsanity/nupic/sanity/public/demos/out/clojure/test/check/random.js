...
var x__9991__auto__ = (((rng == null))?null:rng);
var m__9992__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__9991__auto__)]);
if(!((m__9992__auto__ == null))){
return (m__9992__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9992__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9992__auto__.call(null,rng));
} else {
var m__9992__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__9992__auto____$1 == null))){
return (m__9992__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9992__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9992__auto____$1.call(null,rng));
} else {
...
var x__9991__auto__ = (((rng == null))?null:rng);
var m__9992__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__9991__auto__)]);
if(!((m__9992__auto__ == null))){
return (m__9992__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9992__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9992__auto__.call(null,rng));
} else {
var m__9992__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__9992__auto____$1 == null))){
return (m__9992__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9992__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9992__auto____$1.call(null,rng));
} else {
...
var x__9991__auto__ = (((rng == null))?null:rng);
var m__9992__auto__ = (clojure.test.check.random.split[goog.typeOf(x__9991__auto__)]);
if(!((m__9992__auto__ == null))){
return (m__9992__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9992__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9992__auto__.call(null,rng));
} else {
var m__9992__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__9992__auto____$1 == null))){
return (m__9992__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9992__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9992__auto____$1.call(null,rng));
} else {
...
var x__9991__auto__ = (((rng == null))?null:rng);
var m__9992__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__9991__auto__)]);
if(!((m__9992__auto__ == null))){
return (m__9992__auto__.cljs$core$IFn$_invoke$arity$2 ? m__9992__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9992__auto__.call(null,rng,n));
} else {
var m__9992__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__9992__auto____$1 == null))){
return (m__9992__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__9992__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9992__auto____$1.call(null,rng,n));
} else {
...
var G__47472 = z;
if(((24) > (function (){var G__47473 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__47473) : clojure.test.check.random.longs.bit_count.call(null,G__47473));
})())){
return clojure.test.check.random.longs.bit_xor(G__47472,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__47472;
}
});
...
var G__47476 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__47477 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__47476;
ret = G__47477;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__9930__auto__,writer__9931__auto__,opt__9932__auto__){
return cljs.core._write(writer__9931__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__9278__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
clojure.test.check.random.next_rng = (function (){var a = (function (){var G__47478 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,clojure.test.check.random.make_java_util_splittable_random((new Date()).valueOf())], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__47478) : cljs.core.atom.call(null,G__47478));
})();
return ((function (a){
return (function (){
...
return (function (p__47479){
var map__47480 = p__47479;
var map__47480__$1 = ((((!((map__47480 == null)))?((((map__47480.cljs$lang$protocol_mask$partition0$ & (64))) || (map__47480.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47480):map__47480);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47480__$1,cljs.core.cst$kw$state);
var vec__47482 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47482,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47482,(1),null);
...
var args47485 = [];
var len__10461__auto___47488 = arguments.length;
var i__10462__auto___47489 = (0);
while(true){
if((i__10462__auto___47489 < len__10461__auto___47488)){
args47485.push((arguments[i__10462__auto___47489]));

var G__47490 = (i__10462__auto___47489 + (1));
i__10462__auto___47489 = G__47490;
continue;
} else {
}
break;
