...
var or__9278__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__9278__auto__)){
return or__9278__auto__;
} else {
var or__9278__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__9278__auto____$1)){
return or__9278__auto____$1;
} else {
var or__9278__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__9278__auto____$2)){
return or__9278__auto____$2;
} else {
var or__9278__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__10291__auto__ = a.length;
var i = (0);
while(true){
if((i < n__10291__auto__)){
var c_45205 = (a[i]);
if(cljs.core.truth_((c_45205["cljsIsDirty"]))){
(c_45205["forceUpdate"])();
} else {
}
...
var G__45208 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__45208) : reagent.impl.batching.next_tick.call(null,G__45208));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__9930__auto__,writer__9931__auto__,opt__9932__auto__){
return cljs.core._write(writer__9931__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__45210 = c;
var G__45210__$1 = (((G__45210 == null))?null:(G__45210["props"]));
if((G__45210__$1 == null)){
return null;
} else {
return (G__45210__$1["argv"]);
}
});
...
var G__45212_45213 = (c["cljsRatom"]);
if((G__45212_45213 == null)){
} else {
reagent.ratom.dispose_BANG_(G__45212_45213);
}
