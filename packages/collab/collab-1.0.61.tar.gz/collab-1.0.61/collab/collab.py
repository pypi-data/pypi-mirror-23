...
class FileObject:
    ...
    """
    def __init__(self, identifier, type, arg_num, file_name):
    ...
    def to_json(self):
        ...
        res = {'identifier' : self.identifier.to_json(), 'arg_num' : self.arg_num, }
        return res
...
class Tag:
    ...
    def to_json(self):
        ...
        Counterpart to _parse_tag().
        """
        res = {'id' : self.identifier, 'sym' : self.symbol, 'args' : [self._get_identifier_of_argument(a).to_json() for a in self.arguments]}
        return res
...
def get_inputs():
    ...
    for c,a in enumerate(inputs):
        ...
        arg_num = c
        file_name = a['file']
        res.append(FileObject(identifier, type, arg_num, file_name))
    return res
...
def add_output_file():
    ...
    type = _OUTPUT_FILE
    arg_num = _output_counter
    file_name = "%d" % _output_counter
    res = FileObject(identifier, type, arg_num, file_name)
    _output_counter += 1
