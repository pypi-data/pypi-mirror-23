...
from .basics import Identifier, parse_identifier, create_preliminary_identifier, InputObject, parse_input, OutputObject, Tag, parse_tag
...
def _get_valid_event_request_names():
    ...
    """
    res = [a[1] for a in _get_truth()['valid_event_request_types']]
    return res
...
def add_output_file():
    ...
    res = OutputObject(file_name, creation_step, creation_index)
