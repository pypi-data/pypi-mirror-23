...
class OutputObject:
    ...
    """
    def __init__(self, file_name, creation_step, creation_index):
    ...
    def to_json(self):
        """
        gives a JSON dictionary representation of this OutputObject, to be parsed by the ExecutionEnvironment.
        ...
        return res
    def to_json_as_input(self):
        """
        gives a JSON dictionary representation of this OutputObject that can be parsed as an InputObject.
        this is a counterpart to get_inputs().
        """
        res = {}
...
def parse_input(usage_index, dictionary):
    """
    creates an InputObject from a JSON dictionary structure
    Counterpart to OutputObject.to_json_as_input().
    """
    ...
    usage_index = c
    res = InputObject(identifier, file_name, creation_step, creation_index, usage_index)
    return res
