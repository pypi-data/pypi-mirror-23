...
""")
    ...
    def test_print(self):
        ...
        print( " ---- OUT: %s : %s : %s : %s " % (out, err, type(out), type(err)))
        self.assert_(str(out) == '31\n')
...
a = arange(7)''')
    ...
    def xtest_names(self):
        '''names test'''
        self.trytext('nx = 1')
        self.trytext('nx1 = 1')

    def xtest_syntaxerrors_1(self):
    ...
    def xtest_unsupportednodes(self):
        '''unsupported nodes'''
    ...
    def xtest_runtimeerrors_1(self):
        '''runtime errors test'''
        self.trytext("zero = 0")
    ...
    def xtest_list_comprehension(self):
    ...
    def xtest_index_assignment(self):
