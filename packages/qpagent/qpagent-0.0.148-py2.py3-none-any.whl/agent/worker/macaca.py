...
from agent.util.file import download
from ..config import macaca
from agent.worker import make_worker_dir
...
class Macaca(object):
    def __init__(self, task_id, data):
        ...
        self.macaca_dir = make_worker_dir(os.getcwd() + '/agent/macaca')
    ...
    def __ui_play(self):
        ...
        download(case_dir, file_name, self.case_url)
        os.chdir(self.macaca_dir)
