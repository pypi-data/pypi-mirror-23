...
def __test_load_granules():

    print("|-------- TESTING load_granules (string)-------|")
    granules = load_granules("/home/william/hyp3-api/asf-datapool-results-2017-6-6_10-25-45.csv")
    for g in granules:
        print(g)

    print("|-------- TESTING load_granules (file obj) -------|")
    f = open("/home/william/hyp3-api/asf-datapool-results-2017-6-6_10-25-45.csv")
    granules = load_granules(f)
    print(granules)


if __name__ == '__main__':
    __test_load_granules()
