...
remote value will be overwritten by the one in the settings file.

If you are using KMS-encrypted AWS environment variables, you can set
your KMS Key ARN in the ``aws_kms_key_arn`` setting. Make sure that the
values you set are encrypted in such case.
