...
boxborderw=5: x=100: y=100" -codec:a copy split0.mp4'''
    ...
    def split_8_video():
        ...
        cmd_line = "ffmpeg -ss 00:24:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:12:00 -y " + "split03.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 00:36:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:12:00 -y " + "split03.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 00:48:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:12:00 -y " + "split03.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 01:00:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:12:00 -y " + "split03.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 01:12:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -t 00:14:00 -y " + "split03.mp4"
        os.system(cmd_line)
        cmd_line = "ffmpeg -ss 01:26:00  -i " + new_video_path + " -strict -2 -vcodec copy -acodec copy -y " + "split04.mp4"
        os.system(cmd_line)
        return 0
