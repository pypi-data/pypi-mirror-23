...
class Array(SignatureField):
    ...
    def _fieldnames(self):
        return self.signature._fieldnames() if self.signature else [] # pylint: disable=protected-access

    def _filternames(self):
        return self.signature._filternames() if self.signature else [] # pylint: disable=protected-access
