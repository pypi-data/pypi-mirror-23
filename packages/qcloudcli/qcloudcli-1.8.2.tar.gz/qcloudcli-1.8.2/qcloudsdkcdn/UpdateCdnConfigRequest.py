...
class UpdateCdnConfigRequest(Request):
	...
	def get_advanceCache(self):
		return self.get_params().get('advanceCache')

	def set_advanceCache(self, advanceCache):
		self.add_param('advanceCache', advanceCache)

	def get_advanceMaxage(self):
		return self.get_params().get('advanceMaxage')

	def set_advanceMaxage(self, advanceMaxage):
		self.add_param('advanceMaxage', advanceMaxage)
