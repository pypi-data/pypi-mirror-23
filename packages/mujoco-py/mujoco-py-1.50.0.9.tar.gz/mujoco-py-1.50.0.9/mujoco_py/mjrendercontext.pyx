...
cdef class MjRenderContext(object):
    ...
    # Public wrappers
    cdef readonly mujoco_pyvScene scn
    cdef readonly mujoco_pyvCamera cam
    cdef readonly mujoco_pyvOption vopt
    cdef readonly mujoco_pyvPerturb pert
    cdef readonly mujoco_pyrContext con
