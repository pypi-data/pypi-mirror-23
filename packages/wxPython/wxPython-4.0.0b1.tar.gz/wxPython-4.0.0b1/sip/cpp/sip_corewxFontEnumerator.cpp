...
bool sipwxFontEnumerator::EnumerateFacenames( ::wxFontEncoding encoding,bool fixedWidthOnly)
{
    ...
    extern bool sipVH__core_207(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxFontEncoding,bool);

    return sipVH__core_207(sipGILState, 0, sipPySelf, sipMeth, encoding, fixedWidthOnly);
}
