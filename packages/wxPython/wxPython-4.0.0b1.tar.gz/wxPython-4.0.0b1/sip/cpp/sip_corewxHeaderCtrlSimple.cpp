...
int sipwxHeaderCtrlSimple::GetBestFittingWidth(uint idx) const
{
    ...
    extern int sipVH__core_150(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_150(sipGILState, 0, sipPySelf, sipMeth, idx);
}
