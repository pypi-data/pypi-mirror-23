 ...
 ::wxIconBundle sipwxArtProvider::CreateIconBundle(const  ::wxArtID& id,const  ::wxArtClient& client)
{
    ...
    extern  ::wxIconBundle sipVH__core_187(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArtID&,const  ::wxArtClient&);

    return sipVH__core_187(sipGILState, 0, sipPySelf, sipMeth, id, client);
}
 ...
 ::wxBitmap sipwxArtProvider::CreateBitmap(const  ::wxArtID& id,const  ::wxArtClient& client,const  ::wxSize& size)
{
    ...
    extern  ::wxBitmap sipVH__core_186(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArtID&,const  ::wxArtClient&,const  ::wxSize&);

    return sipVH__core_186(sipGILState, 0, sipPySelf, sipMeth, id, client, size);
}
