...
void sipwxModalDialogHook::Exit( ::wxDialog*dialog)
{
    ...
    extern void sipVH__core_223(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    sipVH__core_223(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
...
int sipwxModalDialogHook::Enter( ::wxDialog*dialog)
{
    ...
    extern int sipVH__core_222(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    return sipVH__core_222(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
