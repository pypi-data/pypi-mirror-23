...
bool sipwxGenericDragImage::UpdateBackingFromWindow( ::wxDC& windowDC, ::wxMemoryDC& destDC,const  ::wxRect& sourceRect,const  ::wxRect& destRect) const
{
    ...
    extern bool sipVH__core_190(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxMemoryDC&,const  ::wxRect&,const  ::wxRect&);

    return sipVH__core_190(sipGILState, 0, sipPySelf, sipMeth, windowDC, destDC, sourceRect, destRect);
}
 ...
 ::wxRect sipwxGenericDragImage::GetImageRect(const  ::wxPoint& pos) const
{
    ...
    extern  ::wxRect sipVH__core_189(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&);

    return sipVH__core_189(sipGILState, 0, sipPySelf, sipMeth, pos);
}
...
bool sipwxGenericDragImage::DoDrawImage( ::wxDC& dc,const  ::wxPoint& pos) const
{
    ...
    extern bool sipVH__core_188(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxPoint&);

    return sipVH__core_188(sipGILState, 0, sipPySelf, sipMeth, dc, pos);
}
