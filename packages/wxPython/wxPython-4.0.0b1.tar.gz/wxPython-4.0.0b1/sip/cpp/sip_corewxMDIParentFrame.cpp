 ...
 ::wxMDIClientWindow* sipwxMDIParentFrame::OnCreateClient()
{
    ...
    extern  ::wxMDIClientWindow* sipVH__core_173(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_173(sipGILState, 0, sipPySelf, sipMeth);
}
