...
bool sipwxFileSystemWatcher::RemoveTree(const  ::wxFileName& path)
{
    ...
    extern bool sipVH__core_220(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&);

    return sipVH__core_220(sipGILState, 0, sipPySelf, sipMeth, path);
}
...
bool sipwxFileSystemWatcher::AddTree(const  ::wxFileName& path,int events,const  ::wxString& filter)
{
    ...
    extern bool sipVH__core_219(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&,int,const  ::wxString&);

    return sipVH__core_219(sipGILState, 0, sipPySelf, sipMeth, path, events, filter);
}
...
bool sipwxFileSystemWatcher::Add(const  ::wxFileName& path,int events)
{
    ...
    extern bool sipVH__core_218(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&,int);

    return sipVH__core_218(sipGILState, 0, sipPySelf, sipMeth, path, events);
}
