...
void sipwxSettableHeaderColumn::SetAlignment( ::wxAlignment align)
{
    ...
    extern void sipVH__core_144(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxAlignment);

    sipVH__core_144(sipGILState, 0, sipPySelf, sipMeth, align);
}
 ...
 ::wxAlignment sipwxSettableHeaderColumn::GetAlignment() const
{
    ...
    extern  ::wxAlignment sipVH__core_143(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
