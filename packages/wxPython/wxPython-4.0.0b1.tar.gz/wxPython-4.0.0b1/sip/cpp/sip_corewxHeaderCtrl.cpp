...
void sipwxHeaderCtrl::OnColumnCountChanging(uint count)
{
    ...
    extern void sipVH__core_149(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    sipVH__core_149(sipGILState, 0, sipPySelf, sipMeth, count);
}
...
bool sipwxHeaderCtrl::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    extern bool sipVH__core_148(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,int);

    return sipVH__core_148(sipGILState, 0, sipPySelf, sipMeth, idx, widthTitle);
}
...
void sipwxHeaderCtrl::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    extern void sipVH__core_147(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayInt&);

    sipVH__core_147(sipGILState, 0, sipPySelf, sipMeth, order);
}
...
void sipwxHeaderCtrl::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    extern void sipVH__core_146(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,bool);

    sipVH__core_146(sipGILState, 0, sipPySelf, sipMeth, idx, show);
}
...
const  ::wxHeaderColumn& sipwxHeaderCtrl::GetColumn(uint idx) const
{
    ...
    extern const  ::wxHeaderColumn& sipVH__core_145(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_145(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
sipVariableDef variables_wxHeaderCtrl[] = {
    {PropertyVariable, sipName_ColumnsOrder, &methods_wxHeaderCtrl[27], &methods_wxHeaderCtrl[46], NULL, NULL},
    {PropertyVariable, sipName_ColumnCount, &methods_wxHeaderCtrl[24], &methods_wxHeaderCtrl[45], NULL, NULL},
};
