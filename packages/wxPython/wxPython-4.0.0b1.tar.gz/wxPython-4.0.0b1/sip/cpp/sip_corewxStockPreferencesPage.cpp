 ...
 ::wxWindow* sipwxStockPreferencesPage::CreateWindow( ::wxWindow*parent)
{
    ...
    extern  ::wxWindow* sipVH__core_221(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_221(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
static sipEnumMemberDef enummembers_wxStockPreferencesPage[] = {
    {sipName_Kind_Advanced, static_cast<int>( ::wxStockPreferencesPage::Kind_Advanced), 486},
    {sipName_Kind_General, static_cast<int>( ::wxStockPreferencesPage::Kind_General), 486},
};
