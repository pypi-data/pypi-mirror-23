...
void sipwxTextCompleterSimple::GetCompletions(const  ::wxString& prefix, ::wxArrayString& res)
{
    ...
    extern void sipVH__core_142(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxArrayString&);

    sipVH__core_142(sipGILState, 0, sipPySelf, sipMeth, prefix, res);
}
...
static sipEncodedTypeDef supers_wxTextCompleterSimple[] = {{509, 255, 1}};
