...
sipVariableDef variables_wxWebKitCtrl[] = {
    {PropertyVariable, sipName_Title, &methods_wxWebKitCtrl[35], &methods_wxWebKitCtrl[58], NULL, NULL},
    {PropertyVariable, sipName_Selection, &methods_wxWebKitCtrl[34], NULL, NULL, NULL},
    {PropertyVariable, sipName_ScrollPos, &methods_wxWebKitCtrl[33], &methods_wxWebKitCtrl[57], NULL, NULL},
    {PropertyVariable, sipName_PageURL, &methods_wxWebKitCtrl[32], NULL, NULL, NULL},
    {PropertyVariable, sipName_PageTitle, &methods_wxWebKitCtrl[31], &methods_wxWebKitCtrl[56], NULL, NULL},
    {PropertyVariable, sipName_PageSource, &methods_wxWebKitCtrl[30], &methods_wxWebKitCtrl[55], NULL, NULL},
};
