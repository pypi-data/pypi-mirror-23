...
void sipwxFileHistory::UseMenu( ::wxMenu*menu)
{
    ...
    extern void sipVH__core_213(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxMenu*);

    sipVH__core_213(sipGILState, 0, sipPySelf, sipMeth, menu);
}
...
void sipwxFileHistory::Save( ::wxConfigBase& config)
{
    ...
    extern void sipVH__core_215(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxConfigBase&);

    sipVH__core_215(sipGILState, 0, sipPySelf, sipMeth, config);
}
...
void sipwxFileHistory::RemoveFileFromHistory( ::size_t i)
{
    ...
    sipVH__core_124(sipGILState, 0, sipPySelf, sipMeth, i);
}
...
void sipwxFileHistory::Load(const  ::wxConfigBase& config)
{
    ...
    extern void sipVH__core_214(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxConfigBase&);

    sipVH__core_214(sipGILState, 0, sipPySelf, sipMeth, config);
}
 ...
 ::wxString sipwxFileHistory::GetHistoryFile( ::size_t index) const
{
    ...
    return sipVH__core_135(sipGILState, 0, sipPySelf, sipMeth, index);
}
