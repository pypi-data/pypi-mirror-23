...
int sipwxRadioBox::FindString(const  ::wxString& string,bool bCase) const
{
    ...
    return sipVH__core_132(sipGILState, 0, sipPySelf, sipMeth, string, bCase);
}
...
sipVariableDef variables_wxRadioBox[] = {
    {PropertyVariable, sipName_Selection, &methods_wxRadioBox[32], &methods_wxRadioBox[48], NULL, NULL},
