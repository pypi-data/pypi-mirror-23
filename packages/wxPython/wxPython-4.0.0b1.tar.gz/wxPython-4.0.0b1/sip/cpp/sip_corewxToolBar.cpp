...
sipVariableDef variables_wxToolBar[] = {
    ...
    {PropertyVariable, sipName_ToolSeparation, &methods_wxToolBar[45], &methods_wxToolBar[74], NULL, NULL},
    {PropertyVariable, sipName_ToolPacking, &methods_wxToolBar[43], &methods_wxToolBar[73], NULL, NULL},
    {PropertyVariable, sipName_ToolBitmapSize, &methods_wxToolBar[38], &methods_wxToolBar[68], NULL, NULL},
    {PropertyVariable, sipName_Margins, &methods_wxToolBar[37], &methods_wxToolBar[67], NULL, NULL},
};
