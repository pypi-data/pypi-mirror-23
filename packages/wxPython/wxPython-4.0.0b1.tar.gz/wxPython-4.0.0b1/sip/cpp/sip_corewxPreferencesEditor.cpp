...
void sipwxPreferencesEditor::Show( ::wxWindow*parent)
{
    ...
    extern void sipVH__core_179(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    sipVH__core_179(sipGILState, 0, sipPySelf, sipMeth, parent);
}
