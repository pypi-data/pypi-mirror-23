...
sipVariableDef variables_wxAuiToolBar[] = {
    {PropertyVariable, sipName_WindowStyleFlag, &methods_wxAuiToolBar[65], &methods_wxAuiToolBar[96], NULL, NULL},
    {PropertyVariable, sipName_ToolTextOrientation, &methods_wxAuiToolBar[62], &methods_wxAuiToolBar[94], NULL, NULL},
    {PropertyVariable, sipName_ToolSeparation, &methods_wxAuiToolBar[59], &methods_wxAuiToolBar[91], NULL, NULL},
    {PropertyVariable, sipName_ToolPacking, &methods_wxAuiToolBar[55], &methods_wxAuiToolBar[89], NULL, NULL},
    {PropertyVariable, sipName_ToolCount, &methods_wxAuiToolBar[47], NULL, NULL, NULL},
    {PropertyVariable, sipName_ToolBorderPadding, &methods_wxAuiToolBar[46], &methods_wxAuiToolBar[85], NULL, NULL},
    {PropertyVariable, sipName_ToolBitmapSize, &methods_wxAuiToolBar[45], &methods_wxAuiToolBar[84], NULL, NULL},
    {PropertyVariable, sipName_ToolBarFits, &methods_wxAuiToolBar[43], NULL, NULL, NULL},
    {PropertyVariable, sipName_OverflowVisible, &methods_wxAuiToolBar[42], &methods_wxAuiToolBar[82], NULL, NULL},
    {PropertyVariable, sipName_GripperVisible, &methods_wxAuiToolBar[39], &methods_wxAuiToolBar[80], NULL, NULL},
    {PropertyVariable, sipName_ArtProvider, &methods_wxAuiToolBar[35], &methods_wxAuiToolBar[76], NULL, NULL},
};
