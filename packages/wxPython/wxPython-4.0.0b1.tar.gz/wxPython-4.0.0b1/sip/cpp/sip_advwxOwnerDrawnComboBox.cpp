...
sipVariableDef variables_wxOwnerDrawnComboBox[] = {
    {PropertyVariable, sipName_WidestItemWidth, &methods_wxOwnerDrawnComboBox[33], NULL, NULL, NULL},
    {PropertyVariable, sipName_WidestItem, &methods_wxOwnerDrawnComboBox[32], NULL, NULL, NULL},
};
...
sipClassTypeDef sipTypeDef__adv_wxOwnerDrawnComboBox = {
    ...
    },
    {
        ...
        {0, 0, 1},
        56, methods_wxOwnerDrawnComboBox,
        0, 0,
