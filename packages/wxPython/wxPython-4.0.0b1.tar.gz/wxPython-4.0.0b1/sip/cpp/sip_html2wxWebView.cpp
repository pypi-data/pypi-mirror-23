...
sipVariableDef variables_wxWebView[] = {
    {PropertyVariable, sipName_ZoomType, &methods_wxWebView[35], &methods_wxWebView[62], NULL, NULL},
    {PropertyVariable, sipName_Zoom, &methods_wxWebView[34], &methods_wxWebView[61], NULL, NULL},
