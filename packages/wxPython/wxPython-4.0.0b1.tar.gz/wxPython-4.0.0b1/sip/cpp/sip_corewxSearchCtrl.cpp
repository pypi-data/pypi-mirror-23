...
sipVariableDef variables_wxSearchCtrl[] = {
    {PropertyVariable, sipName_Value, &methods_wxSearchCtrl[54], &methods_wxSearchCtrl[98], NULL, NULL},
    ...
    {PropertyVariable, sipName_Menu, &methods_wxSearchCtrl[47], &methods_wxSearchCtrl[91], NULL, NULL},
    {PropertyVariable, sipName_Margins, &methods_wxSearchCtrl[46], &methods_wxSearchCtrl[89], NULL, NULL},
    {PropertyVariable, sipName_LastPosition, &methods_wxSearchCtrl[42], NULL, NULL, NULL},
    {PropertyVariable, sipName_InsertionPoint, &methods_wxSearchCtrl[41], &methods_wxSearchCtrl[87], NULL, NULL},
    {PropertyVariable, sipName_Hint, &methods_wxSearchCtrl[40], &methods_wxSearchCtrl[86], NULL, NULL},
    {PropertyVariable, sipName_DescriptiveText, &methods_wxSearchCtrl[39], &methods_wxSearchCtrl[84], NULL, NULL},
    {PropertyVariable, sipName_DefaultStyle, &methods_wxSearchCtrl[38], &methods_wxSearchCtrl[83], NULL, NULL},
    {PropertyVariable, sipName_CancelButtonVisible, &methods_wxSearchCtrl[61], &methods_wxSearchCtrl[100], NULL, NULL},
    {PropertyVariable, sipName_SearchButtonVisible, &methods_wxSearchCtrl[66], &methods_wxSearchCtrl[102], NULL, NULL},
};
