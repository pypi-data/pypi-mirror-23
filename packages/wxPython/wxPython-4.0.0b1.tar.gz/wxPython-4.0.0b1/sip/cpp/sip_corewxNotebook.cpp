 ...
 ::wxValidator* sipwxNotebook::GetValidator()
{
    ...
    extern  ::wxValidator* sipVH__core_106(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxNotebook::SetValidator(const  ::wxValidator& validator)
{
    ...
    extern void sipVH__core_107(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxValidator&);

    sipVH__core_107(sipGILState, 0, sipPySelf, sipMeth, validator);
}
 ...
 ::wxWindow* sipwxNotebook::GetMainWindowOfCompositeControl()
{
    ...
    extern  ::wxWindow* sipVH__core_108(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxNotebook::DoGetPosition(int*x,int*y) const
{
    ...
    sipVH__core_109(sipGILState, 0, sipPySelf, sipMeth, x, y);
}
...
void sipwxNotebook::DoSetSize(int x,int y,int width,int height,int sizeFlags)
{
    ...
    extern void sipVH__core_110(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int,int);

    sipVH__core_110(sipGILState, 0, sipPySelf, sipMeth, x, y, width, height, sizeFlags);
}
...
void sipwxNotebook::DoSetClientSize(int width,int height)
{
    ...
    extern void sipVH__core_111(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int);

    sipVH__core_111(sipGILState, 0, sipPySelf, sipMeth, width, height);
}
...
void sipwxNotebook::DoSetSizeHints(int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    ...
    extern void sipVH__core_112(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int,int,int);

    sipVH__core_112(sipGILState, 0, sipPySelf, sipMeth, minW, minH, maxW, maxH, incW, incH);
}
...
void sipwxNotebook::DoMoveWindow(int x,int y,int width,int height)
{
    ...
    extern void sipVH__core_113(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int,int);

    sipVH__core_113(sipGILState, 0, sipPySelf, sipMeth, x, y, width, height);
}
...
void sipwxNotebook::DoSetWindowVariant( ::wxWindowVariant variant)
{
    ...
    extern void sipVH__core_114(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindowVariant);

    sipVH__core_114(sipGILState, 0, sipPySelf, sipMeth, variant);
}
 ...
 ::wxBorder sipwxNotebook::GetDefaultBorder() const
{
    ...
    extern  ::wxBorder sipVH__core_115(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxNotebook::SetImageList( ::wxImageList*imageList)
{
    ...
    extern void sipVH__core_133(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxImageList*);

    sipVH__core_133(sipGILState, 0, sipPySelf, sipMeth, imageList);
}
...
int sipwxNotebook::GetPageImage( ::size_t nPage) const
{
    ...
    extern int sipVH__core_123(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__core_123(sipGILState, 0, sipPySelf, sipMeth, nPage);
}
...
bool sipwxNotebook::SetPageImage( ::size_t page,int image)
{
    ...
    extern bool sipVH__core_134(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t,int);

    return sipVH__core_134(sipGILState, 0, sipPySelf, sipMeth, page, image);
}
 ...
 ::wxString sipwxNotebook::GetPageText( ::size_t nPage) const
{
    ...
    extern  ::wxString sipVH__core_135(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__core_135(sipGILState, 0, sipPySelf, sipMeth, nPage);
}
...
bool sipwxNotebook::SetPageText( ::size_t page,const  ::wxString& text)
{
    ...
    extern bool sipVH__core_136(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t,const  ::wxString&);

    return sipVH__core_136(sipGILState, 0, sipPySelf, sipMeth, page, text);
}
...
int sipwxNotebook::SetSelection( ::size_t page)
{
    ...
    return sipVH__core_123(sipGILState, 0, sipPySelf, sipMeth, page);
}
...
bool sipwxNotebook::AddPage( ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    extern bool sipVH__core_137(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__core_137(sipGILState, 0, sipPySelf, sipMeth, page, text, select, imageId);
}
...
bool sipwxNotebook::DeletePage( ::size_t page)
{
    ...
    extern bool sipVH__core_138(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__core_138(sipGILState, 0, sipPySelf, sipMeth, page);
}
...
bool sipwxNotebook::InsertPage( ::size_t index, ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    extern bool sipVH__core_139(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t, ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__core_139(sipGILState, 0, sipPySelf, sipMeth, index, page, text, select, imageId);
}
...
void sipwxNotebook::SetPageSize(const  ::wxSize& size)
{
    ...
    extern void sipVH__core_140(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxSize&);

    sipVH__core_140(sipGILState, 0, sipPySelf, sipMeth, size);
}
...
int sipwxNotebook::HitTest(const  ::wxPoint& pt,long*flags) const
{
    ...
    extern int sipVH__core_141(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&,long*);

    return sipVH__core_141(sipGILState, 0, sipPySelf, sipMeth, pt, flags);
}
...
sipVariableDef variables_wxNotebook[] = {
    ...
    {PropertyVariable, sipName_Selection, &methods_wxNotebook[29], &methods_wxNotebook[45], NULL, NULL},
