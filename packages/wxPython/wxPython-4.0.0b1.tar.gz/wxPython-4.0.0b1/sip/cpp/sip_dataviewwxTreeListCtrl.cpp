...
sipVariableDef variables_wxTreeListCtrl[] = {
    {PropertyVariable, sipName_View, &methods_wxTreeListCtrl[52], NULL, NULL, NULL},
    {PropertyVariable, sipName_SortColumn, &methods_wxTreeListCtrl[50], &methods_wxTreeListCtrl[74], NULL, NULL},
