 ...
 ::wxString sipwxFileType_MessageParameters::GetParamValue(const  ::wxString& name) const
{
    ...
    extern  ::wxString sipVH__core_206(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    return sipVH__core_206(sipGILState, 0, sipPySelf, sipMeth, name);
}
