...
bool sipwxDialogLayoutAdapter::DoLayoutAdaptation( ::wxDialog*dialog)
{
    ...
    extern bool sipVH__core_167(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    return sipVH__core_167(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
