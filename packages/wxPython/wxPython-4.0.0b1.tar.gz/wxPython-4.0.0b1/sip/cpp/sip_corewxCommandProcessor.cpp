...
void sipwxCommandProcessor::Store( ::wxCommand*command)
{
    ...
    extern void sipVH__core_217(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxCommand*);

    sipVH__core_217(sipGILState, 0, sipPySelf, sipMeth, command);
}
...
bool sipwxCommandProcessor::Submit( ::wxCommand*command,bool storeIt)
{
    ...
    extern bool sipVH__core_216(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxCommand*,bool);

    return sipVH__core_216(sipGILState, 0, sipPySelf, sipMeth, command, storeIt);
}
