...
with open('requirements.txt') as requirements:
    ...
    aiofiles_url = install_requires.pop()
    aiofiles_url = aiofiles_url.strip('\n')
    aiofiles_url += "#egg=aiofiles-ext-0.4.0"

    install_requires.append('aiofiles-ext')
