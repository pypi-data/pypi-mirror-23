...
from onyx.equity import ufo_equity_index_futures, ufo_equity_index_contract
...
class UnitTest(OnyxTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.cnt, _ = ufo_equity_index_contract.prepare_for_test()[0]
        self.sec = ufo_equity_index_futures.prepare_for_test()[0]
    ...
    def test_Children(self):
        ...
        self.assertEqual(kids, {self.cnt, "EUR/USD"})
