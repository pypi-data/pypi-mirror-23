...
from onyx.core import GetVal, OnyxTestCase, EvalBlock
from onyx.equity import ufo_equity_asset
...
class UnitTest(OnyxTestCase):
    ...
    def test_Ticker(self):
        ...
        with EvalBlock() as eb:
            eb.change_value("Settings", "Platform", "Google")
            self.assertEqual(GetVal("EQ NG/ LN", "Ticker"), "NG")

        with EvalBlock() as eb:
            eb.change_value("Settings", "Platform", "Yahoo")
            self.assertEqual(GetVal("EQ NG/ LN", "Ticker"), "NG")

        with EvalBlock() as eb:
            eb.change_value("Settings", "Platform", "WSJ")
            self.assertEqual(GetVal("EQ NG/ LN", "Ticker"), "NG.")
