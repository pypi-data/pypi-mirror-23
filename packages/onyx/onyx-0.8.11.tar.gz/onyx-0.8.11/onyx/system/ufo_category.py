...
from onyx.core import ObjNamesByType, ValueType
from onyx.core import UfoBase, StringField, ListField
...
def prepare_for_test():
    ...
    AddIfMissing(Category(Name="Nth. America",
                          ObjTypes=["EquityAsset"], TargetVT="Region"))
    ...
    AddIfMissing(Category(Name="USA",
                          ObjTypes=["EquityAsset"], TargetVT="Country"))
