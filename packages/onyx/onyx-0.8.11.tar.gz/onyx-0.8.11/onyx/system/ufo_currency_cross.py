...
from onyx.core import Curve, Knot, UfoBase
from onyx.core import ReferenceField, StringField, ValueType, RetainedFactory
...
def prepare_for_test():
    ...
    for cross, value in marks.items():
        cross = GetObj(cross)
        cross.update_timeseries([Date.today(), value])
