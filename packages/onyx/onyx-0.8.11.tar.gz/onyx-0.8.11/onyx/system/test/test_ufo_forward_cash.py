...
from onyx.system.ufo_cash_balance import CashBalance
from onyx.system import ufo_forward_cash
...
class UnitTest(OnyxTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.fwdusd, self.fwdeur = ufo_forward_cash.prepare_for_test()[:2]
