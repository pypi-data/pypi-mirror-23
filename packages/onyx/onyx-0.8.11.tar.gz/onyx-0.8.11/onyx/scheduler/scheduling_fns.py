...
def arg_combine(option, value):
    return "--{0:s}={1!s}".format(option, value)
...
class JobsHandler(tornado.web.RequestHandler):
    ...
    def get(self, job_id=None):
        logger.debug("GET: job_id is {0!s}".format(job_id))
    ...
    def put(self, job_id=None):
        logger.debug("PUT: job_id is {0!s}".format(job_id))
        self.set_header("Access-Control-Allow-Origin", "*")
        ...
        try:
            ...
            if job_status == "pause":
                ...
                if job_id in self.application.paused:
                    ...
                    logger.info("PUT: job was resumed")
    ...
    def delete(self, job_id=None):
        logger.debug("DELETE: job_id is {0!s}".format(job_id))
        self.set_header("Access-Control-Allow-Origin", "*")
        if job_id is None:
            self.set_status(404)
            return
    ...
    def post(self, job_id=None):
        logger.debug("POST: job_id is {0!s}".format(job_id))
        self.set_header("Access-Control-Allow-Origin", "*")
    ...
    def options(self, job_id=None):
        logger.debug("OPTIONS: job_id is {0!s}".format(job_id))
        self.set_header("Access-Control-Allow-Origin", "*")
...
class SchedulingServer(tornado.web.Application):
    # -------------------------------------------------------------------------
    def __init__(self, jobstores, executors, handlers=None, **kwds):
