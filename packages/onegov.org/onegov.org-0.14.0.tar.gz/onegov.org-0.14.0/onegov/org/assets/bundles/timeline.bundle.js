...
var TimelineMessages = React.createClass({displayName: "TimelineMessages",
                ...
                messages.map(function(m, ix) {
                    ...
                    return (
                        React.createElement("li", {key: m.id}, 
                                ...
                                showDate(ix) && React.createElement("div", {className: "date"}, React.createElement("span", null, m.date)), 
                            
                            React.createElement("div", {className: 'message message-' + m.type + ' ' + (showDate(ix) && 'first-of-day' || ''), 
...
var Timeline = function(container) {
    ...
    container.timeline = ReactDOM.render(
        React.createElement(TimelineMessages, {feed: feed, messages: messages, order: order}), el.get(0)
    );
