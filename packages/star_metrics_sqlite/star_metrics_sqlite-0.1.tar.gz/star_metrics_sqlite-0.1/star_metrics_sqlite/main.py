...
def main():
    ...
    logger = setup_logging('star_' + metric_name, args, run_uuid)
    ...
    if metric_name == 'star_first_pass':
        ...
        star_alignreads_metrics.run_pass_1(run_uuid, bam, fasta, engine, logger, metric_name,
        ...
        star_genomegenerate_metrics.run(run_uuid, bam, fasta, engine, logger, metric_name,
        ...
        log_out_path = get_param(args, 'log_out_path')
        sj_out_tab_path = get_param(args, 'sj_out_tab_path')
        star_alignreads_metrics.run_pass_2(run_uuid, bam, fasta, engine, logger, metric_name,
                                           log_final_out_path, log_out_path, sj_out_tab_path)
    else:
