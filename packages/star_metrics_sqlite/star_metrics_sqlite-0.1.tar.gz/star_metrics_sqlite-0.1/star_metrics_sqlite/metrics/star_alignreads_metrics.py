...
def star_log_out_to_df(metric_path, engine, bam, run_state, fasta, run_uuid, logger):
    df_list = list()
...
def run_pass_1(run_uuid, bam, fasta, engine, logger, metric_name,
               log_final_out_path, log_out_path, sj_out_tab_path):
    run_state = 'pass_1'
    year = star_log_out_to_df(log_out_path, engine, bam, run_state, fasta, run_uuid, logger)
...
def run_pass_2(run_uuid, bam, fasta, engine, logger, metric_name,
               log_final_out_path, log_out_path, sj_out_tab_path):
    run_state = 'pass_2'
    year = star_log_out_to_df(log_out_path, engine, bam, run_state, fasta, run_uuid, logger)
    star_log_final_out_to_df(log_final_out_path, engine, year, run_state, run_uuid, logger)
