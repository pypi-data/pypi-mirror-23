...
class Ui_WMask(object):
    def setupUi(self, WMask):
        ...
        self.saveROIButton = QtWidgets.QPushButton(WMask)
        self.saveROIButton.setObjectName("saveROIButton")
        self.horizontalLayout_4.addWidget(self.saveROIButton)
        self.loadROIButton = QtWidgets.QPushButton(WMask)
        self.loadROIButton.setObjectName("loadROIButton")
        self.horizontalLayout_4.addWidget(self.loadROIButton)
    ...
    def retranslateUi(self, WMask):
        ...
        self.openImageButton.setText(_translate("WMask", "Open image"))
        self.applyButton.setText(_translate("WMask", "Apply mask"))
        self.saveMaskButton.setText(_translate("WMask", "Save mask"))
        self.saveROIButton.setText(_translate("WMask", "Save ROIs"))
        self.loadROIButton.setText(_translate("WMask", "Load ROIs"))
