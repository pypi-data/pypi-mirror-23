...
def Image(image_file_name):
    """
    Loads and returns an image file with the given file name.

        IMAGE = coda.Image("Example.png");
    """
    return pygame.image.load(image_file_name).convert_alpha()
...
class SpriteSheet:
    ...
    def image_at(self, index):
        ...
        image.blit(self.sheet, (0, 0), self.rectangle)
        return image
