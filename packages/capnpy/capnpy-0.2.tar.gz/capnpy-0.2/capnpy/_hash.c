...
static PyObject *__pyx_pw_6capnpy_5_hash_1inthash(PyObject *__pyx_self, PyObject *__pyx_arg_v) {
  ...
  assert(__pyx_arg_v); {
    __pyx_v_v = __Pyx_PyInt_As_long(__pyx_arg_v); if (unlikely((__pyx_v_v == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_6capnpy_5_hash_inthash(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_v) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash_inthash(__pyx_v_v, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
...
static PyObject *__pyx_pw_6capnpy_5_hash_3longhash(PyObject *__pyx_self, PyObject *__pyx_arg_v) {
  ...
  assert(__pyx_arg_v); {
    __pyx_v_v = __Pyx_PyInt_As_unsigned_long(__pyx_arg_v); if (unlikely((__pyx_v_v == (unsigned long)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_6capnpy_5_hash_2longhash(CYTHON_UNUSED PyObject *__pyx_self, unsigned long __pyx_v_v) {
  ...
  __Pyx_RefNannySetupContext("longhash", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash_longhash(__pyx_v_v, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_t_1 = PyBytes_GET_SIZE(__pyx_v_a); if (unlikely(__pyx_t_1 == -1)) __PYX_ERR(0, 27, __pyx_L1_error)
 ...
 *     cdef long x
 */
  __pyx_t_4 = __Pyx_PyObject_AsUString(__pyx_v_a); if (unlikely((!__pyx_t_4) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_v_p = __pyx_t_4;
 ...
 *     while True:
 */
  __pyx_t_5 = _Py_HashSecret.prefix;
  __pyx_v_x = __pyx_t_5;
 ...
 *         x = -2
 */
  __pyx_v_x = (__pyx_v_x ^ _Py_HashSecret.suffix);
...
static PyObject *__pyx_pw_6capnpy_5_hash_5strhash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("strhash (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("strhash", 1, 3, 3, 1); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("strhash", 1, 3, 3, 2); __PYX_ERR(0, 26, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "strhash") < 0)) __PYX_ERR(0, 26, __pyx_L3_error)
      }
    ...
    __pyx_v_start = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_start == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_size == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("strhash", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("capnpy._hash.strhash", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a), (&PyBytes_Type), 1, "a", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
...
static PyObject *__pyx_pf_6capnpy_5_hash_4strhash(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, long __pyx_v_start, long __pyx_v_size) {
  ...
  __Pyx_RefNannySetupContext("strhash", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash_strhash(__pyx_v_a, __pyx_v_start, __pyx_v_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     return tuplehash(a.data.as_longs, len(a))             # <<<<<<<<<<<<<<
 */
  __pyx_t_3 = Py_SIZE(((PyObject *)__pyx_v_a)); if (unlikely(__pyx_t_3 == -1)) __PYX_ERR(0, 82, __pyx_L1_error)
...
static PyObject *__pyx_pf_6capnpy_5_hash_6__tuplehash_for_tests(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_hashes) {
  ...
  __Pyx_RefNannySetupContext("__tuplehash_for_tests", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash___tuplehash_for_tests(__pyx_v_hashes, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     cdef array.array a = array.array('l', hashes)
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_array, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_array, __pyx_t_1) < 0) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
