...
from idealab_tools.data_exchange import load_dat
import os
...
#
#b_matlab = load_dat.import_data(b_filename,float)
#B_matlab = load_dat.import_data(B_filename,float)
#W_matlab = load_dat.import_data(W_filename,float)
#M_matlab = load_dat.import_data(M_filename,float)
#u_matlab = load_dat.import_data(u_filename,float)
#x_matlab = load_dat.import_data(x_filename,float)
#A_matlab = load_dat.import_data(A_filename,float)
#
...
def compare_matrices(A,filename,directory=None, format = float):
    ...
    B=load_dat.import_data(full_path,format = format)
