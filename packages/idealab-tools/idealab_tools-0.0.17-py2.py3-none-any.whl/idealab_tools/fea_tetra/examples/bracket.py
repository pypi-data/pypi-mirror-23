...
coordinates = load_dat.import_data(os.path.join(directory,'coordinates.dat'),float)
elements = load_dat.import_data(os.path.join(directory,'elements.dat'),int) - 1
dirichlet = load_dat.import_data(os.path.join(directory,'dirichlet.dat'),int) - 1
neumann = load_dat.import_data(os.path.join(directory,'neumann.dat'),int) - 1
