...
class QualiITF:
    ...
    @staticmethod
    def exec_createPkLogPath(globalInputs):
    ...
    @staticmethod
    def QualiITFService_Category():
        return "QualiITF"

    @staticmethod
    def QualiITFService_prop_accessToken():
        return "Tag"

    @staticmethod
    def QualiITFService_prop_backendUrl():
        return "URL"

    @staticmethod
    def QualiITFService_TargetName():
        return "QualiITF Service Instance"

    @staticmethod
    def QualiITFService_exec_getAllParams():
        return "getAllParams"

    @staticmethod
    def QualiITFService_exec_getAllParamsExtended():
        return "getAllParamsExtended"

    @staticmethod
    def QualiITFService_exec_updateMessageBoardStatus():
        return "updateMessageBoardStatus"

    @staticmethod
    def QualiITFService_exec_saveTestRunStatistics():
        return "saveTestRunStatistics"

    @staticmethod
    def QualiITFService_exec_saveReservationId():
        return "saveReservationId"
    ...
    @staticmethod
    def exec_sendToTltrepoReportsPath(tltrepoIP, tltrepoPort, tltrepoUser, tltrepoPass, tltrepoRemoteUnixPath,
    ...
    # -------------------------------------------------------------
    @staticmethod
    def exec_getAllParams(globalInputs, qualiITFBackendUrl, qualiITFAccessToken, addDescription="no"):
        proxyDict = {
            "http": "",
            "https": "",
            "ftp": ""
        ...
        myUrl = qualiITFBackendUrl + '/v1/themes/' + QualiITF.getThemeName(globalInputs) + \
                ...
                '/whatifs/' + QualiITF.getWhatifName(globalInputs) + '/details?addDescription=' + addDescription
    ...
    # -------------------------------------------------------------
    @staticmethod
    def exec_getAllParamsExtended(qualiITFBackendUrl, qualiITFAccessToken, ThemeName, SuiteName, TestName, WhatifName,
                                  addDescription="no"):
        globalInputs = {}
        globalInputs["ThemeName"] = ThemeName
        globalInputs["SuiteName"] = SuiteName
        globalInputs["TestName"] = TestName
        globalInputs["WhatifName"] = WhatifName
        return QualiITF.exec_getAllParams(globalInputs, qualiITFBackendUrl, qualiITFAccessToken, addDescription)
