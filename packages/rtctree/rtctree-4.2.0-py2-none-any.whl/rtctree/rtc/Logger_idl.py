# Python stubs generated by omniidl from /home/geoff/src/rtm/rtctree/idl/Logger.idl
...
_0_OpenRTM = omniORB.openModule("rtctree.rtc.OpenRTM", r"/home/geoff/src/rtm/rtctree/idl/Logger.idl")
_0_OpenRTM__POA = omniORB.openModule("rtctree.rtc.OpenRTM__POA", r"/home/geoff/src/rtm/rtctree/idl/Logger.idl")
...
class _objref_Logger (_0_SDOPackage._objref_SDOService):
    ...
    def publish(self, *args):
        return _omnipy.invoke(self, "publish", _0_OpenRTM.Logger._d_publish, args)

    def close(self, *args):
        return _omnipy.invoke(self, "close", _0_OpenRTM.Logger._d_close, args)

    __methods__ = ["publish", "close"] + _0_SDOPackage._objref_SDOService.__methods__
