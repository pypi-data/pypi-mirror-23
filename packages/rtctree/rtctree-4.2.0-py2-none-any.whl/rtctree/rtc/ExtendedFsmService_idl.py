# Python stubs generated by omniidl from /home/geoff/src/rtm/rtctree/idl/ExtendedFsmService.idl
...
_0_RTC = omniORB.openModule("rtctree.rtc.RTC", r"/home/geoff/src/rtm/rtctree/idl/ExtendedFsmService.idl")
_0_RTC__POA = omniORB.openModule("rtctree.rtc.RTC__POA", r"/home/geoff/src/rtm/rtctree/idl/ExtendedFsmService.idl")
...
class _objref_ExtendedFsmService (_0_SDOPackage._objref_SDOService):
    ...
    def get_current_state(self, *args):
        return _omnipy.invoke(self, "get_current_state", _0_RTC.ExtendedFsmService._d_get_current_state, args)

    def set_fsm_structure(self, *args):
        return _omnipy.invoke(self, "set_fsm_structure", _0_RTC.ExtendedFsmService._d_set_fsm_structure, args)

    def get_fsm_structure(self, *args):
        return _omnipy.invoke(self, "get_fsm_structure", _0_RTC.ExtendedFsmService._d_get_fsm_structure, args)

    __methods__ = ["get_current_state", "set_fsm_structure", "get_fsm_structure"] + _0_SDOPackage._objref_SDOService.__methods__
