...
- `Dynamic serializer for Documents <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/basic_usage_examples.html#sample-serializer>`_.
- `Search filter backend <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/advanced_usage_examples.html#search>`_.
- `Ordering filter backend <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/advanced_usage_examples.html#ordering>`_.
- `Filtering filter backend <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/advanced_usage_examples.html#filtering>`_ (big variety of
  ...
  implemented.
- `Faceted search filter backend <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/advanced_usage_examples.html#faceted-search>`_.
- `Pagination (Page number and limit/offset pagination) <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/advanced_usage_examples.html#pagination>`_
...
is to read the `quick start tutorial <http://django-elasticsearch-dsl-drf.readthedocs.io/en/0.2.6/quick_start.html>`_.
