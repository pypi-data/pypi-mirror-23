...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcoho(void); /*proto*/
PyMODINIT_FUNC initcoho(void)
#else
PyMODINIT_FUNC PyInit_coho(void); /*proto*/
PyMODINIT_FUNC PyInit_coho(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_coho(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init coho.__init__", 0, __pyx_lineno, __pyx_filename);
    }
