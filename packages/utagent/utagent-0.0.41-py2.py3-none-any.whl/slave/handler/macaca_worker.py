...
class MacacaWorker(object):
    def __init__(self, macaca_dir, data):
        self.macaca_type = self.__post_get('task_type', data)
        self.macaca_dir = macaca_dir
        self.app_name = self.__post_get('app_name', data)
        self.version_name = self.__post_get('version_name', data)
        self.module_name = self.__post_get('module_name', data)
        self.case_name = self.__post_get('case_name', data)
        self.case_url = self.__post_get('case_url', data)
