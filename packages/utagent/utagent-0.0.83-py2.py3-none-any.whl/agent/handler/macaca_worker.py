...
class MacacaWorker(object):
    ...
    def __run_uirecorder(self):
        self.app_name = self.__post_get('app_name', self.data)
        self.description = self.__post_get('description', self.data)
        self.test_type = self.__post_get('test_type', self.data)
        self.app_id = self.__post_get('app_id', self.data)
        self.version_id = self.__post_get('version_id', self.data)
        ...
        api.upload_case_file(self.app_name, self.description, self.test_type, self.app_id, self.version_id, self.module_id, case_file)
