...
setup(
  ...
  url = 'https://github.com/eliacer95/django-pack-notification', # use the URL to the github repo
  download_url = 'https://github.com/eliacer95/django-pack-notification/tarball/1.0.1',
