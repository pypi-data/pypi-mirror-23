...
class StaticHtmlGenerator:
    ...
    def _import_switch(self, conf_name):
        ...
        """
        return importlib.import_module("{conf_dir}.{conf_name}".format(conf_dir=self.conf_import_path,conf_name=conf_name)).Switch()
    ...
    def render_index(self, *, output_filename, pagetitle):
        ...
        """
        rendered = self.jinja2_env.get_template('index.html').render(switches=self.rendered_switches, pagetitle=pagetitle)
...
if __name__ == '__main__':
    ...
    shg.render_switch('amber', output_filename='amber.html', pagetitle='Canni Demo: Amber Wurm')
