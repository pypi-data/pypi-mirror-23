...
def DijkstraShortestPath(*args):
  return _pywrapgraph.DijkstraShortestPath(*args)
DijkstraShortestPath = _pywrapgraph.DijkstraShortestPath

def BellmanFordShortestPath(*args):
  return _pywrapgraph.BellmanFordShortestPath(*args)
BellmanFordShortestPath = _pywrapgraph.BellmanFordShortestPath

def AStarShortestPath(*args):
  return _pywrapgraph.AStarShortestPath(*args)
