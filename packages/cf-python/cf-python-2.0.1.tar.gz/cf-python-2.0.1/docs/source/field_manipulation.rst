...
data array that has the given domain item values (e.g. particular
coordinate values)
...
([]) and uses an extended Python slicing syntax which is similar to
:ref:`numpy array indexing <numpy:arrays.indexing>`:
