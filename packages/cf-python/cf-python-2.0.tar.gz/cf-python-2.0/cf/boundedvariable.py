...
class BoundedVariable(Variable):
    '''Base class for a CF dimension coordinate, auxiliary coordinate and
...
The lower cell bounds in a `cf.Data` object.
...
'''
    ...
    def upper_bounds(self):
        '''The upper cell bounds in a `cf.Data` object.
...
'''
        print "DEPRECATION WARNING: v.subspace[indices] has been deprecated. Use v[indices] instead."
