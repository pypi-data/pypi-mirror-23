...
#        self.assertFalse(cf.TimeDuration(2, 'days') >= cf.Data(0.03, '100'))
    ...
    def test_TimeDuration_interval(self):        
        ...
        self.assertTrue(cf.D(5, hour=6).interval(cf.dt(2004, 3, 2), end=True) ==
                        (cf.dt('2004-02-26 00:00:00'), cf.dt('2004-03-02 00:00:00')))
        ...
        self.assertTrue(cf.D(5, hour=6).interval(cf.dt(2004, 3, 2, calendar='360_day'), end=True) ==
                        (cf.dt('2004-02-27 00:00:00', '360_day'), cf.dt('2004-03-02 00:00:00', '360_day')))
        ...
        self.assertTrue(cf.h(19897.6).interval(cf.dt(1984, 2, 3, 0), end=True) ==
                        (cf.dt('1981-10-26 22:24:00'), cf.dt('1984-02-03 00:00:00')))
    #--- End: def
