Version 1.5.4.post6 - 19 July 2017
----------------------------------

* Fix for nc_dimensions in regridding
	
Version 1.5.4.post5 - 18 July 2017
----------------------------------

* Fix unparseable units for STASH code 3298 in STASH_to_CF.txt
