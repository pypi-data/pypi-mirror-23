...
long_description = """API change at version 2.0
=========================

* **Note:** There have been some API changes between version 1.x and
2.x of cf-python. Version 1.x will not get any new functionality, but
will be patched for the foreseeable future. The latest 1.x release is
`version 1.5.4.post5
<https://pypi.python.org/pypi/cf-python/1.5.4.post5>`_
...
setup(name = "cf-python",
      ...
      version      = version,
      description  = "Python interface to the data model for CF-1.6",
