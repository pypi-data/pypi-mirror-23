...
#    '''
#'''
#    print 'DCH var_fpartial 1'
#    N, var, avg, sw, ddof, f, wmin, wmax = out
#
#    if out1 is None:
#        print 'DCH var_fpartial 2'
#        # ------------------------------------------------------------
#        # var = sw(var+avg**2)
#        # avg = sw*avg
#        # ------------------------------------------------------------
...
https://en.wikipedia.org/wiki/Pooled_variance#Population-based_statistics
    ...
    if not weighted:
        ...
        raise ValueError(
"Can only calculate a weighted variance with 0 or 1 delta degrees of freedom: ddof={}".format(
    ddof))
