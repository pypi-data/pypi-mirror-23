...
class QueryTest(unittest.TestCase):
    ...
    def test_Query_datetime1(self):
        for chunksize in self.chunk_sizes:    
            ...
            self.assertTrue((d==cf.eq(cf.dt('2001-01-03 21:57:57'))).equals(cf.Data([[False, True], [False, False]])), repr((d==cf.eq(cf.dt('2001-01-03 21:57:57'))).array))
    ...
    def test_Query_dteq_dtne_dtge_dtgt_dtle_dtlt(self):
        for chunksize in self.chunk_sizes:    
            cf.CHUNKSIZE(chunksize)
            d = cf.Data([[1., 5.], [6, 2]], 'days since 2000-12-29 21:57:57')   
            self.assertTrue((d==cf.dteq('2001-01-03 21:57:57')).equals(cf.Data([[False, True], [False, False]])), d.dtarray)
