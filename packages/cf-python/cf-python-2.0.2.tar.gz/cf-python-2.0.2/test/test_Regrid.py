...
#    test_only('test_Data_section',)
    ...
    def test_Field_regrids(self):
        ...
        for chunksize in self.chunk_sizes:
            ...
            f1 = cf.read1(self.filename1)
            f2 = cf.read1(self.filename2)
            f3 = cf.read1(self.filename3)
            ...
            self.assertTrue(f3.equals(f1.regrids(dst, method='conservative',
                            ...
                            'destination = global dict, CHUNKSIZE = %s' % chunksize)
            f4 = cf.read1(self.filename4)
            f5 = cf.read1(self.filename5)
    ...
    def test_Field_regridc(self):
        ...
        for chunksize in self.chunk_sizes:
            cf.CHUNKSIZE(chunksize)
            f1 = cf.read1(self.filename7)
            f2 = cf.read1(self.filename8)
            f3 = cf.read1(self.filename9)
            ...
            f4 = cf.read1(self.filename1)
            f5 = cf.read1(self.filename2)
            f6 = cf.read1(self.filename10)
