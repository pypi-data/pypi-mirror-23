...
class FieldTest(unittest.TestCase):
    def setUp(self):
        ...
        self.test_only = []
#        self.test_only = ['test_Field___len__', 'test_Field___add__', 'test_Field___mul__']

    def test_FieldList___add__(self):
    ...
    def test_FieldList___mul__(self):
        if self.test_only and inspect.stack()[0][3] not in self.test_only:
            return
 ...
 <CF Field: eastward_wind(atmosphere_hybrid_height_coordinate(1), grid_latitude(10), grid_longitude(9)) m s-1>]'''
    ...
    def test_FieldList_append(self):
        ...
        f.append(cf.read1(self.filename))
        self.assertTrue(len(f) == 1)
        self.assertTrue(isinstance(f, cf.FieldList))
