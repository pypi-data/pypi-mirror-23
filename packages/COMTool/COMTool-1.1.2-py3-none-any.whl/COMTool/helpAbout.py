...
<div><div>COMTool is a Open source project create by </div><a style="vertical-align: middle;" href="http://www.neucrack.com"><img src="'''+sys.prefix+"/"+ parameters.strDataDirName+'''/logo2.png" width=109 height=32></img></a></div><br><br>
