...
class _BaseObject(object):
    ...
    def load_object(self, obj_type, obj_id):
        ...
        # TODO: Remove the try/except statement and properly handle cases where jupyter are not found
        # TODO: Fix `datasets` route since that only returns non-analysis jupyter
        try:
