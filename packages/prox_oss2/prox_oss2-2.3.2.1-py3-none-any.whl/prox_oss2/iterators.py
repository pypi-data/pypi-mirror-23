...
class BucketIterator(_BaseIterator):
    ...
    每次迭代返回的是 :class:`SimplifiedBucketInfo <prox_oss2.models.SimplifiedBucketInfo>` 对象。

    :param service: :class:`Service <prox_oss2.Service>` 对象
...
class ObjectIterator(_BaseIterator):
    ...
    每次迭代返回的是 :class:`SimplifiedObjectInfo <prox_oss2.models.SimplifiedObjectInfo>` 对象。
    当 `SimplifiedObjectInfo.is_prefix()` 返回True时，表明是公共前缀（目录）。

    :param bucket: :class:`Bucket <prox_oss2.Bucket>` 对象
...
class MultipartUploadIterator(_BaseIterator):
    ...
    每次返回 :class:`MultipartUploadInfo <prox_oss2.models.MultipartUploadInfo>` 对象。
...
class PartIterator(_BaseIterator):
    ...
    每次返回 :class:`PartInfo <prox_oss2.models.PartInfo>` 对象。
...
class LiveChannelIterator(_BaseIterator):
    ...
    每次迭代返回的是 :class:`LiveChannelInfo <prox_oss2.models.LiveChannelInfo>` 对象。
