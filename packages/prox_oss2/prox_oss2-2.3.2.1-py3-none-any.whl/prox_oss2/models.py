...
class PartInfo(object):
    ...
    该文件既用于 :func:`list_parts <prox_oss2.Bucket.list_parts>` 的输出，也用于 :func:`complete_multipart_upload
    <prox_oss2.Bucket.complete_multipart_upload>` 的输入。
...
class ListObjectsResult(RequestResult):
    def __init__(self, resp):
        ...
        #: 下一次罗列的分页标记符，即，可以作为 :func:`list_objects <prox_oss2.Bucket.list_objects>` 的 `marker` 参数。
        self.next_marker = ''
...
class SimplifiedBucketInfo(object):
    """:func:`list_buckets <prox_oss2.Service.list_objects>` 结果中的单个元素类型。"""
...
class ListBucketsResult(RequestResult):
    def __init__(self, resp):
        ...
        #: 下一次罗列的分页标记符，即，可以作为 :func:`list_buckets <prox_oss2.Service.list_buckets>` 的 `marker` 参数。
        self.next_marker = ''
...
class LiveChannelInfo(object):
    ...
    :type class:`LiveChannelInfoTarget <prox_oss2.models.LiveChannelInfoTarget>`
...
class LiveChannelStat(object):
    ...
    :param video: 视频描述信息。
    :type video: class:`LiveChannelVideoStat <prox_oss2.models.LiveChannelVideoStat>`

    :param audio: 音频描述信息。
    :type audio: class:`LiveChannelAudioStat <prox_oss2.models.LiveChannelAudioStat>`"""
