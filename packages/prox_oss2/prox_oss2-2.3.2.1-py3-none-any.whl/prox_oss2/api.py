...
`http_date` 函数把Unix Time转换为HTTP Date；而 `http_to_unixtime` 则做相反的转换。如 ::
    ...
    >>> import prox_oss2, time
    >>> unix_time = int(time.time())             # 当前UNIX Time，设其值为 1449313829
    >>> date_str = prox_oss2.http_date(unix_time)     # 得到 'Sat, 05 Dec 2015 11:10:29 GMT'
    >>> prox_oss2.http_to_unixtime(date_str)          # 得到 1449313829
...
datetime.date之间相互转换。如 ::
    ...
    >>> import prox_oss2
    >>> d = prox_oss2.iso8601_to_date('2015-12-05T00:00:00.000Z')  # 得到 datetime.date(2015, 12, 5)
    >>> date_str = prox_oss2.date_to_iso8601(d)                    # 得到 '2015-12-05T00:00:00.000Z'
    >>> prox_oss2.iso8601_to_unixtime(date_str)                    # 得到 1449273600
"""
...
class _Base(object):
    ...
    def _do(self, method, bucket_name, key, **kwargs):
        ...
        req = http.Request(method, self._make_url(bucket_name, key),
                           app_name=self.app_name, proxies=self.proxies,
                           **kwargs)
...
class Service(_Base):
    ...
    用法 ::
        ...
        >>> import prox_oss2
        >>> auth = prox_oss2.Auth('your-access-key-id', 'your-access-key-secret')
        >>> service = prox_oss2.Service(auth, 'oss-cn-hangzhou.aliyuncs.com')
    ...
    def list_buckets(self, prefix='', marker='', max_keys=100):
        ...
        :return: 罗列的结果
        :rtype: prox_oss2.models.ListBucketsResult
        """
        resp = self._do('GET', '', '',
...
class Bucket(_Base):
    ...
    用法（假设Bucket属于杭州区域） ::
        ...
        >>> import prox_oss2
        >>> auth = prox_oss2.Auth('your-access-key-id', 'your-access-key-secret')
        >>> bucket = prox_oss2.Bucket(auth, 'http://oss-cn-hangzhou.aliyuncs.com', 'your-bucket')
    ...
    def list_objects(self, prefix='', delimiter='', marker='', max_keys=100):
        ...
        :return: :class:`ListObjectsResult <prox_oss2.models.ListObjectsResult>`
        """
    ...
    def put_object(self, key, data,
        ...
        :return: :class:`PutObjectResult <prox_oss2.models.PutObjectResult>`
        """
    ...
    def append_object(self, key, position, data,
        ...
        :return: :class:`AppendObjectResult <prox_oss2.models.AppendObjectResult>`

        :raises: 如果 `position` 和当前文件长度不一致，抛出 :class:`PositionNotEqualToLength <prox_oss2.exceptions.PositionNotEqualToLength>` ；
                 如果当前文件不是可追加类型，抛出 :class:`ObjectNotAppendable <prox_oss2.exceptions.ObjectNotAppendable>` ；
                 还会抛出其他一些异常
        """
        headers = utils.set_content_type(http.CaseInsensitiveDict(headers), key)
    ...
    def get_object(self, key,
        ...
        :raises: 如果文件不存在，则抛出 :class:`NoSuchKey <prox_oss2.exceptions.NoSuchKey>` ；还可能抛出其他异常
        """
    ...
    def get_object_to_file(self, key, filename,
        ...
        :return: 如果文件不存在，则抛出 :class:`NoSuchKey <prox_oss2.exceptions.NoSuchKey>` ；还可能抛出其他异常
        """
    ...
    def head_object(self, key, headers=None):
        ...
        :return: :class:`HeadObjectResult <prox_oss2.models.HeadObjectResult>`

        :raises: 如果Bucket不存在或者Object不存在，则抛出 :class:`NotFound <prox_oss2.exceptions.NotFound>`
        """
    ...
    def get_object_meta(self, key):
        ...
        :return: :class:`GetObjectMetaResult <prox_oss2.models.GetObjectMetaResult>`
    ...
    def update_object_meta(self, key, headers):
        ...
        :return: :class:`RequestResult <prox_oss2.models.RequestResults>`
        """
    ...
    def delete_object(self, key):
        ...
        :return: :class:`RequestResult <prox_oss2.models.RequestResult>`
        """
    ...
    def put_object_acl(self, key, permission):
        ...
        :param str key: 文件名
        :param str permission: 可以是oss2.OBJECT_ACL_DEFAULT、prox_oss2.OBJECT_ACL_PRIVATE、prox_oss2.OBJECT_ACL_PUBLIC_READ或
            prox_oss2.OBJECT_ACL_PUBLIC_READ_WRITE。
    ...
    def get_object_acl(self, key):
        ...
        :return: :class:`GetObjectAclResult <prox_oss2.models.GetObjectAclResult>`
        """
    ...
    def batch_delete_objects(self, key_list):
        ...
        :return: :class:`BatchDeleteObjectsResult <prox_oss2.models.BatchDeleteObjectsResult>`
        """
        if not key_list:
    ...
    def init_multipart_upload(self, key, headers=None):
        ...
        :return: :class:`InitMultipartUploadResult <prox_oss2.models.InitMultipartUploadResult>`
        """
        headers = utils.set_content_type(http.CaseInsensitiveDict(headers), key)
    ...
    def complete_multipart_upload(self, key, upload_id, parts, headers=None):
        ...
        :type parts: list of `PartInfo <prox_oss2.models.PartInfo>`
    ...
    def list_multipart_uploads(self,
        ...
        :return: :class:`ListMultipartUploadsResult <prox_oss2.models.ListMultipartUploadsResult>`
        """
        resp = self.__do_object('GET', '',
                                params={'uploads': '',
                                        'prefix': prefix,
    ...
    def list_parts(self, key, upload_id,
        ...
        :return: :class:`ListPartsResult <prox_oss2.models.ListPartsResult>`
        """
    ...
    def get_symlink(self, symlink_key):
        ...
        :return: :class:`GetSymlinkResult <prox_oss2.models.GetSymlinkResult>`

        :raises: 如果文件的符号链接不存在，则抛出 :class:`NoSuchKey <prox_oss2.exceptions.NoSuchKey>` ；还可能抛出其他异常
        """
    ...
    def create_bucket(self, permission=None):
        ...
        :param str permission: 指定Bucket的ACL。可以是oss2.BUCKET_ACL_PRIVATE（推荐、缺省）、prox_oss2.BUCKET_ACL_PUBLIC_READ或是
            prox_oss2.BUCKET_ACL_PUBLIC_READ_WRITE。
        """
        if permission:
    ...
    def delete_bucket(self):
        ...
        ":raises: 如果试图删除一个非空Bucket，则抛出 :class:`BucketNotEmpty <prox_oss2.exceptions.BucketNotEmpty>`
        """
    ...
    def put_bucket_acl(self, permission):
        ...
        :param str permission: 新的ACL，可以是oss2.BUCKET_ACL_PRIVATE、prox_oss2.BUCKET_ACL_PUBLIC_READ或
            prox_oss2.BUCKET_ACL_PUBLIC_READ_WRITE
        """
    ...
    def get_bucket_acl(self):
        ...
        :return: :class:`GetBucketAclResult <prox_oss2.models.GetBucketAclResult>`
        """
    ...
    def put_bucket_cors(self, input):
        ...
        :param input: :class:`BucketCors <prox_oss2.models.BucketCors>` 对象或其他
        """
    ...
    def get_bucket_cors(self):
        ...
        :return: :class:`GetBucketCorsResult <prox_oss2.models.GetBucketCorsResult>`
        """
    ...
    def put_bucket_lifecycle(self, input):
        ...
        :param input: :class:`BucketLifecycle <prox_oss2.models.BucketLifecycle>` 对象或其他
        """
    ...
    def get_bucket_lifecycle(self):
        ...
        :return: :class:`GetBucketLifecycleResult <prox_oss2.models.GetBucketLifecycleResult>`

        :raises: 如果没有设置Lifecycle，则抛出 :class:`NoSuchLifecycle <prox_oss2.exceptions.NoSuchLifecycle>`
        """
    ...
    def get_bucket_location(self):
        ...
        :return: :class:`GetBucketLocationResult <prox_oss2.models.GetBucketLocationResult>`
        """
    ...
    def put_bucket_logging(self, input):
        ...
        :param input: :class:`BucketLogging <prox_oss2.models.BucketLogging>` 对象或其他
        """
    ...
    def get_bucket_logging(self):
        ...
        :return: :class:`GetBucketLoggingResult <prox_oss2.models.GetBucketLoggingResult>`
        """
    ...
    def put_bucket_referer(self, input):
        ...
        :param input: :class:`BucketReferer <prox_oss2.models.BucketReferer>` 对象或其他
        """
    ...
    def get_bucket_referer(self):
        ...
        :return: :class:`GetBucketRefererResult <prox_oss2.models.GetBucketRefererResult>`
        """
    ...
    def put_bucket_website(self, input):
        ...
        :param input: :class:`BucketWebsite <prox_oss2.models.BucketWebsite>`
        """
    ...
    def get_bucket_website(self):
        ...
        :return: :class:`GetBucketWebsiteResult <prox_oss2.models.GetBucketWebsiteResult>`

        :raises: 如果没有设置静态网站托管，那么就抛出 :class:`NoSuchWebsite <prox_oss2.exceptions.NoSuchWebsite>`
        """
    ...
    def create_live_channel(self, channel_name, input):
        ...
        :return: :class:`CreateLiveChannelResult <prox_oss2.models.CreateLiveChannelResult>`
        """
    ...
    def get_live_channel(self, channel_name):
        ...
        :return: :class:`GetLiveChannelResult <prox_oss2.models.GetLiveChannelResult>`
        """
    ...
    def list_live_channel(self, prefix='', marker='', max_keys=100):
        ...
        return: :class:`ListLiveChannelResult <prox_oss2.models.ListLiveChannelResult>`
        """
    ...
    def get_live_channel_stat(self, channel_name):
        ...
        return: :class:`GetLiveChannelStatResult <prox_oss2.models.GetLiveChannelStatResult>`
        """
    ...
    def get_live_channel_history(self, channel_name):
        ...
        return: :class:`GetLiveChannelHistoryResult <prox_oss2.models.GetLiveChannelHistoryResult>`
        """
