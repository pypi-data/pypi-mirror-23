...
print({
    "__file__": __file__,
    "os.listdir(coconut)": os.listdir(os.path.join(os.path.dirname(os.path.abspath(__file__)), "coconut")),
})
...
try:
    ...
    try:
        from coconut.dependencies import (
            requirements,
            extras,
        )
    except:
        import traceback
        traceback.print_exc()
        from coconut import dependencies
