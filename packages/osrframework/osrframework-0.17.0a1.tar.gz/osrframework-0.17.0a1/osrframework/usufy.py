...
visit """ + general.LICENSE_URL + "\n"
    ...
    if args.license:
        ...
        # Executing the corresponding process...
            ...
            print("-------")
            print(general.success("success"))
            print("-------")
            # Generating summary files for each ...
            if args.extension:
                print("-------")
                print(general.success("1"))
                print("-------")
                # Storing the file...
                ...
                if not args.maltego:
                    ...
                    print("-------")
                    print(general.success("6"))
                    print("-------")                        
                print("-------")
                print(general.success("2"))
                print("-------")
            print("-------")
            print(general.success("jeje"))
            print("-------")                        
