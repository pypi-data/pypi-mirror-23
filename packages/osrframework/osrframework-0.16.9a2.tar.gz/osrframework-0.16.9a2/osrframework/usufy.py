        ...
        for struct in fuzzingStructures:
            ...
            try:
                ...
                if nick in html:
                    ...
                    print colorama.Fore.GREEN + "\tPossible usufy found!!!\n"
            except:
...
def getPageWrapper(p, nick, rutaDescarga, avoidProcessing = True, avoidDownload = True, outQueue=None):
    ...
    try:
        ...
        print colorama.Fore.RED + "ERROR: something happened when processing " + str(p) +". You may like to deactivate this wrapper if the error persist."
        return []
...
def processNickList(nicks, platforms=None, rutaDescarga="./", avoidProcessing=True, avoidDownload=True, nThreads=12, maltego=False, verbosity=1, logFolder="./logs"):
    ...
    for nick in nicks:
        ...
        try:
            ...
            pool.terminate()
            print colorama.Fore.YELLOW + colorama.Style.BRIGHT + "[!] The following platforms were not processed:"
            pending = ""
            for p in platforms:
                processed = False
    ...
    if args.license:
        ...
        # Executing the corresponding process...
            ...
            if not args.maltego:
                ...
                print colorama.Style.BRIGHT + str(startTime) +"\tStarting search in " + str(len(listPlatforms)) + " platform(s)... Relax!"
                print
                print colorama.Style.BRIGHT + "\tPress <Ctrl + C> to stop..."
                print
            ...
            # Printing the results if requested
                ...
                #print res
                print colorama.Style.BRIGHT + unicode(general.usufyToTextExport(res))
                ...
                for ext in args.extension:
                    ...
                    print "\t" + colorama.Style.BRIGHT + fileHeader + "." + ext
                ...
                print
                print "Total time used:\t" + colorama.Style.BRIGHT + str(endTime-startTime)
                print "Average seconds/query:\t" + colorama.Style.BRIGHT + str((endTime-startTime).total_seconds()/len(listPlatforms)) +" seconds"
                print
