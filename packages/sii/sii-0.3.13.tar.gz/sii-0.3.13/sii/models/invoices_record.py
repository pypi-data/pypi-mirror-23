...
class CustomStringField(fields.String):
    ...
    #             get_error_message(
    #                 field_name=attr, value=value,
    #                 error_msg='El campo no es un String valido'
    #             )
    #         )
...
class RegistroFacturasEmitidas(RegistroFacturas):
    ...
    # TODO lista_facturas = fields.List(fields.Nested(Factura), validate=validate.Length(max=10000, error='No puede haber más de 10000 facturas'))
