...
_model.SHARED_PTR_DISOWN_swigconstant(_model)
...
class ModelHawkesFixedExpKernLogLikList(ModelHawkesList):
    ...
    def hessian(self, coeffs: 'ArrayDouble const &', out: 'ArrayDouble &') -> "void":
        ...
        return _model.ModelHawkesFixedExpKernLogLikList_hessian(self, coeffs, out)
...
_model.LinkType_identity_swigconstant(_model)
LinkType_identity = _model.LinkType_identity

_model.LinkType_exponential_swigconstant(_model)
