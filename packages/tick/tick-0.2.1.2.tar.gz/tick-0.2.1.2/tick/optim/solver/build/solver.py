...
class SVRG(StoSolver):
    ...
    def __init__(self, *args):
        """
        __init__(SVRG self, unsigned long epoch_size, double tol, RandType rand_type, double step, int seed, SVRG::VarianceReductionMethod variance_reduction) -> SVRG
        __init__(SVRG self, unsigned long epoch_size, double tol, RandType rand_type, double step, int seed) -> SVRG
        """
...
class SDCA(StoSolver):
    ...
    def init_stored_variables(self) -> "void":
        """init_stored_variables(SDCA self)"""
        return _solver.SDCA_init_stored_variables(self)
