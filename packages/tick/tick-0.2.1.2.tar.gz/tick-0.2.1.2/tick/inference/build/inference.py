...
class ModelGeneralizedLinearWithIntercepts(ModelGeneralizedLinear):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', n_threads: 'int const'=1):
        ...
        """
        this = _inference.new_ModelGeneralizedLinearWithIntercepts(features, labels, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_n_coeffs(self) -> "unsigned long":
        ...
        return _inference.ModelGeneralizedLinearWithIntercepts_get_n_coeffs(self)
...
class ModelHawkesFixedSumExpKernLogLik(Model):
    ...
    def __init__(self, decay: 'ArrayDouble const &', n_cores: 'unsigned int const'=1):
        """
        __init__(ModelHawkesFixedSumExpKernLogLik self, ArrayDouble const & decay, unsigned int const n_cores=1) -> ModelHawkesFixedSumExpKernLogLik
        __init__(ModelHawkesFixedSumExpKernLogLik self, ArrayDouble const & decay) -> ModelHawkesFixedSumExpKernLogLik
        """
        this = _inference.new_ModelHawkesFixedSumExpKernLogLik(decay, n_cores)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def get_decay(self) -> "SArrayDoublePtr":
        """get_decay(ModelHawkesFixedSumExpKernLogLik self) -> SArrayDoublePtr"""
        return _inference.ModelHawkesFixedSumExpKernLogLik_get_decay(self)


    def set_decay(self, decay: 'ArrayDouble &') -> "void":
        """set_decay(ModelHawkesFixedSumExpKernLogLik self, ArrayDouble & decay)"""
        return _inference.ModelHawkesFixedSumExpKernLogLik_set_decay(self, decay)
...
class ModelHawkesFixedExpKernLeastSqList(ModelHawkesLeastSqList):
    ...
    def __init__(self, decays: 'SArrayDouble2dPtr const', max_n_threads: 'int const'=1, optimization_level: 'unsigned int const'=0):
        ...
        """
        this = _inference.new_ModelHawkesFixedExpKernLeastSqList(decays, max_n_threads, optimization_level)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class ModelHawkesFixedSumExpKernLeastSqList(ModelHawkesLeastSqList):
    ...
    def __init__(self, decays: 'ArrayDouble const &', n_baselines: 'ulong const', period_length: 'double const', max_n_threads: 'unsigned int const'=1, optimization_level: 'unsigned int const'=0):
        ...
        """
        this = _inference.new_ModelHawkesFixedSumExpKernLeastSqList(decays, n_baselines, period_length, max_n_threads, optimization_level)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class ModelHawkesFixedExpKernLogLikList(ModelHawkesList):
    ...
    def loss_and_grad(self, coeffs: 'ArrayDouble const &', out: 'ArrayDouble &') -> "double":
        ...
        return _inference.ModelHawkesFixedExpKernLogLikList_loss_and_grad(self, coeffs, out)


    def hessian_norm(self, coeffs: 'ArrayDouble const &', vector: 'ArrayDouble const &') -> "double":
        """hessian_norm(ModelHawkesFixedExpKernLogLikList self, ArrayDouble const & coeffs, ArrayDouble const & vector) -> double"""
        return _inference.ModelHawkesFixedExpKernLogLikList_hessian_norm(self, coeffs, vector)


    def hessian(self, coeffs: 'ArrayDouble const &', out: 'ArrayDouble &') -> "void":
        """hessian(ModelHawkesFixedExpKernLogLikList self, ArrayDouble const & coeffs, ArrayDouble & out)"""
        return _inference.ModelHawkesFixedExpKernLogLikList_hessian(self, coeffs, out)
    ...
    def incremental_set_data(self, timestamps: 'SArrayDoublePtrList1D const &', end_time: 'double') -> "void":
        ...
        return _inference.ModelHawkesFixedExpKernLogLikList_incremental_set_data(self, timestamps, end_time)


    def compute_weights(self) -> "void":
        """compute_weights(ModelHawkesFixedExpKernLogLikList self)"""
        return _inference.ModelHawkesFixedExpKernLogLikList_compute_weights(self)
...
class ModelLinRegWithIntercepts(ModelGeneralizedLinearWithIntercepts, ModelLipschitz):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtr const', labels: 'SArrayDoublePtr const', n_threads: 'int const'):
        ...
        this = _inference.new_ModelLinRegWithIntercepts(features, labels, n_threads)
        try:
            self.this.append(this)
        except:
            self.this = this
