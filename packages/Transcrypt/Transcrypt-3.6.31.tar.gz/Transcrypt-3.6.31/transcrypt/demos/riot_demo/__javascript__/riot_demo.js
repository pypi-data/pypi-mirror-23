"use strict";
// Transcrypt'ed from Python, 2017-07-07 16:08:29
function riot_demo () {
				...
				__init__: function (__all__) {
					...
					var _recurse = function (col, g) {
						...
						var css = ';'.join (function () {
							var __accu0__ = [];
							var __iterable0__ = lu;
							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
								var __left0__ = __iterable0__ [__index0__];
								var i = __left0__ [0];
								var j = __left0__ [1];
								__accu0__.append (str (i) + ': hsl({}, {}%, {}%)'.format.apply (null, hsl [j]));
							}
							return __accu0__;
						} ());
						var __iterable0__ = s;
					...
					var _col = function (col) {
						return (function __lambda__ () {
							...
							return (function __lambda__ (g) {
								return _recurse.apply (null, [col].concat ([g]).concat (parts));
							});
						});
					};
					var colors = dict ({});
					var __iterable0__ = hsl.py_keys ();
					for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
						var col = __iterable0__ [__index0__];
						colors [col] = _col (col);
					}
					var cprint = function () {
				...
				__init__: function (__all__) {
					...
					var RiotTag = __class__ ('RiotTag', [object], {
						...
						get _setup_tag () {return __get__ (this, function (self, tag) {
							...
							self.riot_tag = tag;
							var handlers = dict ({});
							var __iterable0__ = lifecycle_ev;
							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
								var ev = __iterable0__ [__index0__];
