				...
				__init__: function (__all__) {
					...
					var B = __class__ ('B', [A], {
						get __init__ () {return __get__ (this, function (self, x, y) {
							...
							A.__init__.apply (null, [self].concat ([y]).concat ([x]).concat (args).concat ([__kwargtrans__ (__merge__ ({m: n, n: m}, kwargs))]));
						});}
					});
					...
					var run = function (autoTester) {
						...
						g.apply (null, tuple ([1, 2, 3]).concat ([__kwargtrans__ (dict ({'p': 'aP', 'q': 'aQ', 'r': 'anR'}))]));
