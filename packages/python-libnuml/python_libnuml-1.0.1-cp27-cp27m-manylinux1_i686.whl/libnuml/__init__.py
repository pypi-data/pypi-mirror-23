...
NUML_DEFAULT_LEVEL = _libnuml.NUML_DEFAULT_LEVEL
NUML_DEFAULT_VERSION = _libnuml.NUML_DEFAULT_VERSION
NUML_XMLNS_L1 = _libnuml.NUML_XMLNS_L1
NUML_XMLNS_L1V1 = _libnuml.NUML_XMLNS_L1V1
...
class NMBase(_object):
    ...
    def getCVTerms(self, *args):
        ...
        getCVTerms(NMBase self) -> List
        """
        return _libnuml.NMBase_getCVTerms(self, *args)
...
class Dimension(NUMLList):
    ...
    def getCompositeValue(self):
        ...
        return _libnuml.Dimension_getCompositeValue(self)
...
class DimensionDescription(NUMLList):
    ...
    def getCompositeDescription(self):
        ...
        return _libnuml.DimensionDescription_getCompositeDescription(self)
