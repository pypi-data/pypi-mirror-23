    ...
    def __new__(cls, fac_id=None, lot_cd=None, end_tm=None, size=None,
        ...
        for num in range(unit_cnt):
            ...
            if f_type == 'line':
                ...
                rr, cc = draw.line_aa(adot_x, adot_y, bdot_x, bdot_y)
                ...
                wfFailList = [np.random.choice(pattern, p=adjusted_per) if patt == pattern[0] else patt for patt in pattFail]
