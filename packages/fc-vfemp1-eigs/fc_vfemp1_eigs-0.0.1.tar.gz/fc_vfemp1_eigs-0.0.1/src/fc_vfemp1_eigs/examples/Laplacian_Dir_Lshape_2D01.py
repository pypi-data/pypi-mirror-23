...
from fc_vfemp1.operators import Loperator,Lmass,Hoperator,Hmass
from fc_vfemp1.FEM import NormL2,AssemblyP1
from fc_vfemp1.BVP import BVP,PDE

from fc_vfemp1_eigs.sys import get_geo
from fc_vfemp1_eigs.lib import eBVPsolve,LaplacianEigenOnRectangle,scaleEigensVec,PrintCopyright,print_separator,errors
...
def run(**kwargs):
  ...
  print('   * Dirichlet on [1,2,3,4,5,6]')
  print('       u = 0')
  print_separator()
