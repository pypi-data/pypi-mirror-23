...
class ModelHandle(ObjectHandle):
    ...
    """
    def __init__(self, identifier, properties, parameters, outputs, timestamp=None):
...
class DefaultModelRegistry(MongoDBStore):
    ...
    def __init__(self, mongo):
        ...
        """
        super(DefaultModelRegistry, self).__init__(mongo.get_database().models)

    def clear(self):
        """Clear MongoDB collection containing registered models."""
