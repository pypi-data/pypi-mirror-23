...
def collisionresult__getNumContacts(wid):
...
def collisionresult__getContacts(wid, outv):
...
def collisionresult__getCollidingBodyNodes(wid):
...
def collisionresult__renderContact(inv6, size, scale):
...
def addBallJointConstraint(wid, skid1, bid1, skid2, bid2, inv3):
...
def world__setCollisionDetector(wid, detector_type):
...
def skeleton__setRootJointToWeld(wid, skid):
...
def skeleton__getAccelerations(wid, skid, outv):
...
def bodynode__getNumShapeNodes(wid, skid, bid):
...
def bodynode__setMass(wid, skid, bid, mass):
...
def bodynode__setInertia(wid, skid, bid, inv33):
...
def bodynode__getAngularJacobian(wid, skid, bid, outm):
...
def bodynode__getWorldJacobian(wid, skid, bid, inv3, outm):
...
def bodynode__getLinearJacobianDeriv(wid, skid, bid, inv3, outm):
...
def bodynode__getAngularJacobianDeriv(wid, skid, bid, outm):
...
def dof__setDampingCoefficient(wid, skid, dofid, _coeff):
...
def dof__getConstraintImpulse(wid, skid, dofid):
...
def dof__setConstraintImpulse(wid, skid, dofid, _impulse):
...
def joint__getActuatorType(wid, skid, jid):
...
def joint__setPositionLimitEnforced(wid, skid, jid, _isPositionLimitEnforced):
...
def joint__isPositionLimitEnforced(wid, skid, jid):
...
def joint__hasPositionLimit(wid, skid, jid, _index):
...
def joint__getPositionLowerLimit(wid, skid, jid, _index):
...
def joint__setPositionLowerLimit(wid, skid, jid, _index, _position):
...
def joint__getPositionUpperLimit(wid, skid, jid, _index):
...
def joint__setPositionUpperLimit(wid, skid, jid, _index, _position):
...
def joint__getSpringStiffness(wid, skid, jid, _index):
...
def joint__setSpringStiffness(wid, skid, jid, _index, _k):
...
def joint__getDampingCoefficient(wid, skid, jid, _index):
...
def joint__setDampingCoefficient(wid, skid, jid, _index, _coeff):
...
def joint__getCoulombFriction(wid, skid, jid, _index):
...
def joint__setCoulombFriction(wid, skid, jid, _index, _friction):
...
def universal_joint__getAxis1(wid, skid, jid):
...
def universal_joint__setAxis1(wid, skid, jid, inv3):
...
def universal_joint__getAxis2(wid, skid, jid):
...
def universal_joint__setAxis2(wid, skid, jid, inv3):
...
def euler_joint__getAxisOrder(wid, skid, jid):
...
def euler_joint__setAxisOrder(wid, skid, jid, axisorder):
...
def shapenode__setRelativeTransform(wid, skid, bid, sid, inv44):
...
def shapenode__hasVisualAspect(wid, skid, bid, sid):
...
def shapenode__hasCollisionAspect(wid, skid, bid, sid):
...
def shapenode__getVisualAspectRGBA(wid, skid, bid, sid):
...
def shapenode__setVisualAspectRGBA(wid, skid, bid, sid, inv4):
...
def shape__getBoundingBoxMax(wid, skid, bid, sid):
...
def ellipsoid_shape__setSize(wid, skid, bid, sid, inv3):
...
def cylindershape__getRadius(wid, skid, bid, sid):
...
def cylindershape__setRadius(wid, skid, bid, sid, _radius):
...
def cylindershape__getHeight(wid, skid, bid, sid):
...
def cylindershape__setHeight(wid, skid, bid, sid, _height):
...
def multisphereshape__addSphere(wid, skid, bid, sid, inv4):
...
def multisphereshape__getSpheres(wid, skid, bid, sid, outv):
...
def multisphereshape__getNumSpheres(wid, skid, bid, sid):
