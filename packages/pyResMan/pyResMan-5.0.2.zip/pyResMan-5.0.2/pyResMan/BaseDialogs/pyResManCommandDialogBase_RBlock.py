...
###########################################################################
## Class CommandDialogBase_RBlock
###########################################################################

class CommandDialogBase_RBlock ( wx.Dialog ):
    
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"R-BLOCK", pos = wx.DefaultPosition, size = wx.Size( 534,274 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        _boxsizerRBlockData = wx.BoxSizer( wx.HORIZONTAL )
        
        self.m_staticText57 = wx.StaticText( self, wx.ID_ANY, u"Type", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText57.Wrap( -1 )
        _boxsizerRBlockData.Add( self.m_staticText57, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
        
        _choiceTypeChoices = [ u"ACK", u"NAK" ]
        self._choiceType = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, _choiceTypeChoices, 0 )
        self._choiceType.SetSelection( 0 )
        _boxsizerRBlockData.Add( self._choiceType, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
        
        
        bSizer90.Add( _boxsizerRBlockData, 1, wx.EXPAND, 5 )
