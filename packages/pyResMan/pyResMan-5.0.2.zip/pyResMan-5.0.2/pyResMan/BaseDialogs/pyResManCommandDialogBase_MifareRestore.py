...
###########################################################################
## Class CommandDialogBase_MifareRestore
###########################################################################

class CommandDialogBase_MifareRestore ( wx.Dialog ):
    
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Mifare Restore", pos = wx.DefaultPosition, size = wx.Size( 374,140 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self._statictextCommandName = wx.StaticText( self, wx.ID_ANY, u"Mifare Restore", wx.DefaultPosition, wx.DefaultSize, 0 )
