...
###########################################################################
## Class CommandDialogBase_MifareBlockRead
###########################################################################

class CommandDialogBase_MifareBlockRead ( wx.Dialog ):
    
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Mifare Block Read", pos = wx.DefaultPosition, size = wx.Size( 374,132 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self._statictextCommandName = wx.StaticText( self, wx.ID_ANY, u"Mifare Block Read", wx.DefaultPosition, wx.DefaultSize, 0 )
