...
###########################################################################
## Class CommandDialogBase_MifareBlockWrite
###########################################################################

class CommandDialogBase_MifareBlockWrite ( wx.Dialog ):
    
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Mifare Block Read", pos = wx.DefaultPosition, size = wx.Size( 374,171 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self.m_staticText86 = wx.StaticText( self, wx.ID_ANY, u"Data", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self._textctrlData.SetMaxLength( 32 ) 
        bSizer146.Add( self._textctrlData, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
        ...
        self._statictextCommandName = wx.StaticText( self, wx.ID_ANY, u"Mifare Block Write", wx.DefaultPosition, wx.DefaultSize, 0 )
