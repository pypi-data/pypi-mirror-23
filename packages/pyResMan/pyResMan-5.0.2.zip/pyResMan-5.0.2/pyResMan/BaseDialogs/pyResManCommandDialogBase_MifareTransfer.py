...
###########################################################################
## Class CommandDialogBase_MifareTransfer
###########################################################################

class CommandDialogBase_MifareTransfer ( wx.Dialog ):
    
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Mifare Transfer", pos = wx.DefaultPosition, size = wx.Size( 400,135 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self._statictextCommandName = wx.StaticText( self, wx.ID_ANY, u"Mifare Transfer", wx.DefaultPosition, wx.DefaultSize, 0 )
