...
###########################################################################
## Class CommandDialogBase_MifareDecrementTransfer
###########################################################################

class CommandDialogBase_MifareDecrementTransfer ( wx.Dialog ):
    
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Mifare Decrement Transfer", pos = wx.DefaultPosition, size = wx.Size( 374,171 ), style = wx.DEFAULT_DIALOG_STYLE )
