...
class GoogleSheets:
    ...
    def _get_credentials(self):
        print 'GoogleSheets._get_credentials'
        ...
        if not credentials or credentials.invalid:
            print 'Try read credential inf o from secret file [{}]'.format(self.client_secret_file)
    ...
    def read_range(self, sheet, cell_from, cell_to):
