...
def main():
    ...
    parser.add_argument('-c', type=str, help='Build configuration (debug, release, pre-release', default='debug')
    parser.add_argument('-platform', type=str, help='Build platform (windows, android, ios. (in-future: steam, os-x)', default='android')
