...
class PreprocessorTransformerAdapter(IPreprocessor, BaseEstimator, TransformerMixin):
...
class RegexPreprocessorTransformerAdapter(RegexReplacerAdapter, BaseEstimator, TransformerMixin):
