...
def class_factory(typeof):
    ...
    """
    all_classes = inspect.getmembers(smc.elements.network, inspect.isclass)
    for clazz in all_classes:
        if hasattr(clazz[1], 'typeof') and clazz[1].typeof == typeof:
            return clazz[1]
...
class Searchable(object):
    ...
    def create_unknown(self):
        ...
        """
        created=[]
        if self.klazz.typeof in ['ip_list', 'expression', 'group']:
            return created
