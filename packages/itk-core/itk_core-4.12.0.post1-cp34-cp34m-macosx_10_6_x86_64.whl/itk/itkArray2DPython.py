...
class itkArray2DD(vnl_matrixPython.vnl_matrixD):
    ...
    def GetElement(self, row: 'unsigned long', col: 'unsigned long') -> "double const &":
    ...
    def SetElement(self, row: 'unsigned long', col: 'unsigned long', value: 'double const &') -> "void":
...
class itkArray2DF(vnl_matrixPython.vnl_matrixF):
    ...
    def GetElement(self, row: 'unsigned long', col: 'unsigned long') -> "float const &":
    ...
    def SetElement(self, row: 'unsigned long', col: 'unsigned long', value: 'float const &') -> "void":
...
class itkArray2DUI(vnl_matrixPython.vnl_matrixUI):
    ...
    def GetElement(self, row: 'unsigned long', col: 'unsigned long') -> "unsigned int const &":
    ...
    def SetElement(self, row: 'unsigned long', col: 'unsigned long', value: 'unsigned int const &') -> "void":
