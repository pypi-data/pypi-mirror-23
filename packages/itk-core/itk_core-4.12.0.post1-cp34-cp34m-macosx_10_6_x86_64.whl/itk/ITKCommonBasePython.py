...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_ITKCommonBasePython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_ITKCommonBasePython')
...
class itkThreadPool(itkObject):
    ...
    def AssignWork(self, worker: 'itkThreadJob') -> "_opaque_pthread_t *":
        """AssignWork(itkThreadPool self, itkThreadJob worker) -> _opaque_pthread_t *"""
        return _ITKCommonBasePython.itkThreadPool_AssignWork(self, worker)


    def InitializeThreads(self, maxThreads: 'unsigned int') -> "void":
        """InitializeThreads(itkThreadPool self, unsigned int maxThreads)"""
        return _ITKCommonBasePython.itkThreadPool_InitializeThreads(self, maxThreads)


    def WaitForJobOnThreadHandle(self, handle: '_opaque_pthread_t *') -> "bool":
        """WaitForJobOnThreadHandle(itkThreadPool self, _opaque_pthread_t * handle) -> bool"""
        return _ITKCommonBasePython.itkThreadPool_WaitForJobOnThreadHandle(self, handle)
...
itkThreadPool.AssignWork = new_instancemethod(_ITKCommonBasePython.itkThreadPool_AssignWork, None, itkThreadPool)
itkThreadPool.InitializeThreads = new_instancemethod(_ITKCommonBasePython.itkThreadPool_InitializeThreads, None, itkThreadPool)
itkThreadPool.WaitForJobOnThreadHandle = new_instancemethod(_ITKCommonBasePython.itkThreadPool_WaitForJobOnThreadHandle, None, itkThreadPool)
