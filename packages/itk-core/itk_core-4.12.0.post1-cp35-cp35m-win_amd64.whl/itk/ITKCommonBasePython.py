...
class itkThreadPool(itkObject):
    ...
    def AssignWork(self, worker: 'itkThreadJob') -> "void *":
        """AssignWork(itkThreadPool self, itkThreadJob worker) -> void *"""
    ...
    def WaitForJobOnThreadHandle(self, handle: 'void *') -> "bool":
        """WaitForJobOnThreadHandle(itkThreadPool self, void * handle) -> bool"""
