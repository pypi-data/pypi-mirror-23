...
class itkThreadPool(itkObject):
    ...
    def AssignWork(self, worker: 'itkThreadJob') -> "unsigned long":
        """AssignWork(itkThreadPool self, itkThreadJob worker) -> unsigned long"""
    ...
    def WaitForJobOnThreadHandle(self, handle: 'unsigned long') -> "bool":
        """WaitForJobOnThreadHandle(itkThreadPool self, unsigned long handle) -> bool"""
