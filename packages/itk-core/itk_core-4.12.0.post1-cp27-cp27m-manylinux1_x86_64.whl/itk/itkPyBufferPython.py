...
class itkPyVnlD(object):
    ...
    def _GetVnlVectorViewFromArray(arr, shape):
    ...
    def _GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlD__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlD__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlF__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlF__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlSC__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlSC__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlSI__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlSI__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlSL__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlSL__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlSS__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlSS__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlUC__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlUC__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlUI__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlUI__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlUL__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlUL__GetVnlMatrixViewFromArray(arr, shape):
...
def itkPyVnlUS__GetVnlVectorViewFromArray(arr, shape):
...
def itkPyVnlUS__GetVnlMatrixViewFromArray(arr, shape):
