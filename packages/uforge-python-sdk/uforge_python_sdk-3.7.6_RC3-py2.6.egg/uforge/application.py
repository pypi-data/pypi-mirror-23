...
class Api(_CommonAPIClass):
	...
	class _Users(_CommonAPIClass):
		...
		class _Deployments(_CommonAPIClass):
			def __call__(self, Did=None, Depid=None):
				self.Did = Did
				self.Depid = Depid
				return self
			...
			#URL: users/{uid}/deployments/{depid}
			def Terminate(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/users/' + str(self._get('Uid')) + '/deployments/' + str(self._get('Depid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
