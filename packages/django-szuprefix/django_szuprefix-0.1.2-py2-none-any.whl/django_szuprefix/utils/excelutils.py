...
class ExcelDumpsMixin(object):
    ...
    def get_xls_headers(self):
        ...
        if not hs:
            ...
            from util.modelutils import get_related_field
    ...
    def get_object_accessor_value(self,record, accessor):
        ...
        return accessor.resolve(record, quiet=True)
    ...
    def export_to_xls_in_background(self):
        ...
        from common_config.models import ExcelTask
        task = ExcelTask()
    ...
    def export_to_xls(self):
        ...
        accessories = [Accessor(f) for f in self.get_xls_fields()]
        for item in self.object_list:
            r.append([self.get_object_accessor_value(item, a) for a in accessories])
