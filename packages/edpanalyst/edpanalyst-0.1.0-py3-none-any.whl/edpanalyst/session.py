...
class PopulationModel(object):
    ...
    def column_relevance(
        ...
        return self.relation(
            response_columns, predictor_columns, Stat.MI,
            given_columns=given_columns, given_values=given_values,
            prob_greater_than=prob_greater_than, random_seed=random_seed)
