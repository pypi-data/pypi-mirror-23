...
def batch_service_run(service_name, verb, inputs,
                      ...
                      wait_for_completion,
                      context=cli_context):
    _batch_service_run(service_name, verb, inputs,
                       outputs, parameters, job_name,
                       wait_for_completion,
                       context)


def _batch_service_run(service_name, verb, inputs,
                       outputs, parameters, job_name,
                       wait_for_completion,
                       context=cli_context):
    """
...
def batch_service_create(driver_file, service_name, title, verb, inputs,
                         ...
                         context=cli_context):
    _batch_service_create(driver_file, service_name, title, verb, inputs,
                          outputs, parameters, dependencies, custom_ice_url,
                          context)


def _batch_service_create(driver_file, service_name, title, verb, inputs,
                          outputs, parameters, dependencies, custom_ice_url='',
                          context=cli_context):
    """
    Processing for creating a new batch service
