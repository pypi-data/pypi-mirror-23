...
realtime_view_service_header_to_fn_dict = OrderedDict([('Name', TraversalFunction(('AppName',))),
                                                       ('Service_Id', TraversalFunction(('Id',))),
                                                       ('Package_Id', TraversalFunction(('PackageId',)))])
...
realtime_list_service_header_to_fn_dict = OrderedDict([('Name', TraversalFunction(('AppName',))),
                                                       ('Service_Id', TraversalFunction(('Id',))),
                                                       ('Last_Updated', TraversalFunction(('UpdatedAt',))),
                                                       ('Package_Id', TraversalFunction(('PackageId',))),
                                                       ('State', TraversalFunction(('State',)))])
