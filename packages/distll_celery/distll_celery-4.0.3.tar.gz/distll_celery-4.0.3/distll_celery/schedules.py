...
class schedule(BaseSchedule):
    ...
    def is_due(self, last_run_at):
        ...
        .. admonition:: Scheduler max interval variance
            ...
            the :pypi:`django-distll_celery-beat` database scheduler the value
            is 5 seconds.
        """
...
class crontab(BaseSchedule):
    ...
    def _delta_to_next(self, last_run_at, next_hour, next_minute):
        ...
        and returns a :class:`~distll_celery.utils.time.ffwd` for the next
    ...
    def is_due(self, last_run_at):
        ...
        SeeAlso:
            :meth:`distll_celery.schedules.schedule.is_due` for more information.
        """
        rem_delta = self.remaining_estimate(last_run_at)
