...
Snapshots (:mod:`distll_celery.events.snapshot`) can be used to
...
from distll_celery.five import items, python_2_unicode_compatible, values
from distll_celery.utils.functional import LRUCache, memoize, pass1
...
class Task(object):
    ...
    def event(self, type_, timestamp=None, local_received=None, fields=None,
        ...
        # see implementation in distll_celery.states.state.__lt__
