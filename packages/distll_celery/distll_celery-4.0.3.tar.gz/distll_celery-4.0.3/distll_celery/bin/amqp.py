# -*- coding: utf-8 -*-
"""The :program:`distll_celery amqp` command.

.. program:: distll_celery amqp
"""
...
from distll_celery.utils.functional import padlist

from distll_celery.bin.base import Command
from distll_celery.five import string_t
from distll_celery.utils.serialization import strtobool
...
class AMQPAdmin(object):
    """The distll_celery :program:`distll_celery amqp` utility."""
...
class amqp(Command):
    ...
    Examples:
        .. code-block:: console
            ...
            $ distll_celery amqp help

            $ distll_celery amqp exchange.delete name
            $ distll_celery amqp queue.delete queue
            $ distll_celery amqp queue.delete queue yes yes
    """
