...
def _compat_periodic_task_decorator(*args, **kwargs):
    from distll_celery.task import periodic_task
...
COMPAT_MODULES = {
    ...
    'distll_celery.task': {
        ...
        'schedules': 'distll_celery.schedules',
        'chords': 'distll_celery.canvas',
    }
}

#: We exclude these from dir(distll_celery)
DEPRECATED_ATTRS = set(COMPAT_MODULES['distll_celery'].keys()) | {'subtask'}
