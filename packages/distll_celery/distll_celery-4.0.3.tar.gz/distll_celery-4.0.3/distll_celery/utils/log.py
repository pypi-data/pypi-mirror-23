...
from distll_celery.five import string_t, text_t
...
RESERVED_LOGGER_NAMES = {'distll_celery', 'distll_celery.task'}

# Sets up our logging hierarchy.
#
# Every logger in the distll_celery package inherits from the "distll_celery"
# logger, and every task logger inherits from the "distll_celery.task"
# logger.
base_logger = logger = _get_logger('distll_celery')
...
task_logger = get_logger('distll_celery.task')
worker_logger = get_logger('distll_celery.worker')
