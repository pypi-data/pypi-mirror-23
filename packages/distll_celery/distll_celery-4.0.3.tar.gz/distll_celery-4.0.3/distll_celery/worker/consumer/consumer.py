...
from distll_celery.exceptions import InvalidTaskError, NotRegistered
from distll_celery.five import buffer_t, items, python_2_unicode_compatible, values
from distll_celery.utils.functional import noop
from distll_celery.utils.log import get_logger
from distll_celery.utils.nodenames import gethostname
from distll_celery.utils.objects import Bunch
from distll_celery.utils.text import truncate
from distll_celery.utils.time import humanize_seconds, rate

from distll_celery.worker import loops
from distll_celery.worker.state import (
...
class Consumer(object):
    ...
    class Blueprint(bootsteps.Blueprint):
        ...
        name = 'Consumer'
        default_steps = [
            'distll_celery.worker.consumer.connection:Connection',
            'distll_celery.worker.consumer.mingle:Mingle',
            'distll_celery.worker.consumer.events:Events',
            'distll_celery.worker.consumer.gossip:Gossip',
            'distll_celery.worker.consumer.heart:Heart',
            'distll_celery.worker.consumer.control:Control',
            'distll_celery.worker.consumer.tasks:Tasks',
            'distll_celery.worker.consumer.consumer:Evloop',
            'distll_celery.worker.consumer.agent:Agent',
        ]
    ...
    def _update_prefetch_count(self, index=0):
        ...
        Note:
            ...
            :option:`--autoscale=1,0 <distll_celery worker --autoscale>`).
        """
