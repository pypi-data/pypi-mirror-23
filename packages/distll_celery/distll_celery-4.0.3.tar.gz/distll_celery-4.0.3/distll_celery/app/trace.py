...
from distll_celery import states, signals
from distll_celery._state import _task_stack
from distll_celery.app.task import Task as BaseTask, Context
from distll_celery.exceptions import Ignore, Reject, Retry, InvalidTaskError
from distll_celery.five import monotonic, text_t
from distll_celery.utils.log import get_logger
from distll_celery.utils.nodenames import gethostname
from distll_celery.utils.objects import mro_lookup
from distll_celery.utils.saferepr import saferepr
...
def task_has_custom(task, attr):
    ...
    return mro_lookup(task.__class__, attr, stop={BaseTask, object},
                      monkey_patched=['distll_celery.app.task'])
...
def setup_worker_optimizations(app, hostname=None):
    ...
    from distll_celery.worker import request as request_module
