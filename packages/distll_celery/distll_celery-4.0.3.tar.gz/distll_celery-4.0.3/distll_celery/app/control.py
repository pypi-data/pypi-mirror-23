...
Server implementation is in :mod:`distll_celery.worker.control`.
"""
...
from distll_celery.exceptions import DuplicateNodenameWarning
...
the distll_celery worker `-n` option.\
"""
...
class Control(object):
    ...
    def rate_limit(self, task_name, rate_limit, destination=None, **kwargs):
        ...
        Arguments:
            ...
            rate_limit (int, str): The rate limit as tasks per second,
                ...
                see :attr:`distll_celery.task.base.Task.rate_limit` for
                more information).
    ...
    def broadcast(self, command, arguments=None, destination=None,
        ...
        """Broadcast a control command to the distll_celery workers.
