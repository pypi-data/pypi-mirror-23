...
from distll_celery.worker.components import Beat, Hub, Pool, Timer
...
class test_Hub:
    ...
    @patch('distll_celery.worker.components.set_event_loop')
    @patch('distll_celery.worker.components.get_event_loop')
