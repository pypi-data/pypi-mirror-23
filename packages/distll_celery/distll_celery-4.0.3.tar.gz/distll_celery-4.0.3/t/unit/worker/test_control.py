...
from distll_celery.five import Queue as FastQueue
from distll_celery.utils.timer2 import Timer
from distll_celery.worker import WorkController as _WC  # noqa
from distll_celery.worker import consumer
from distll_celery.worker import control
from distll_celery.worker import state as worker_state
from distll_celery.worker.request import Request
from distll_celery.worker.state import revoked
from distll_celery.worker.pidbox import Pidbox, gPidbox
from distll_celery.utils.collections import AttributeDict
...
class test_Pidbox:
    ...
    def test_shutdown(self):
        with patch('distll_celery.worker.pidbox.ignore_errors') as eig:
            parent = Mock()
            pbox = Pidbox(parent)
...
class test_ControlPanel:
    ...
    @patch('distll_celery.worker.worker.logger.debug')
