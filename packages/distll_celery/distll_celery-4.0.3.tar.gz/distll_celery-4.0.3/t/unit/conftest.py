...
from distll_celery.backends.cache import CacheBackend, DummyClient
# we have to import the pytest plugin fixtures here,
# in case user did not do the `python setup.py develop` yet,
# that installs the pytest plugin into the setuptools registry.
from distll_celery.contrib.pytest import (
    celery_app, celery_enable_logging, depends_on_current_app,
)
from distll_celery.contrib.testing.app import Trap, TestApp
from distll_celery.contrib.testing.mocks import (
...
def setup_session(scope='session'):
    ...
    from distll_celery._state import set_default_app
