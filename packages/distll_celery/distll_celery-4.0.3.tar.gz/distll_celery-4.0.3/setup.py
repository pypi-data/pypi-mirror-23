...
- For CPython 2.6, PyPy 1.x, Jython 2.6, CPython 3.2->3.3; use Celery 3.1:
    ...
    $ pip install 'distll_celery<4'

- For CPython 2.5, Jython 2.5; use Celery 3.0:

    $ pip install 'distll_celery<3.1'

- For CPython 2.4; use Celery 2.2:

    $ pip install 'distll_celery<2.3'
"""
...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'distll_celery = distll_celery.__main__:main',
        ],
        'pytest11': [
            'distll_celery = distll_celery.contrib.pytest',
        ],
    },
)
