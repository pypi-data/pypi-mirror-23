...
from distll_celery.exceptions import NotRegistered, InvalidTaskError
    ...
    def unregister(self, name):
        ...
        Arguments:
            name (str): name of the task to unregister, or a
                :class:`distll_celery.task.base.Task` with a valid `name` attribute.

        Raises:
            distll_celery.exceptions.NotRegistered: if the task is not registered.
        """
        try:
