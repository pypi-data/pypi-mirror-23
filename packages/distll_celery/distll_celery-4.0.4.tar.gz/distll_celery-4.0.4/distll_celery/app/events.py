...
class Events(object):
    ...
    receiver_cls = 'distll_celery.events.receiver:EventReceiver'
    dispatcher_cls = 'distll_celery.events.dispatcher:EventDispatcher'
    state_cls = 'distll_celery.events.state:State'
