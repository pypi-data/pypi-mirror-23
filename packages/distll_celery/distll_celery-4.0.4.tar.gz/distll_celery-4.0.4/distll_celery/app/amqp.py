...
from distll_celery.utils.text import indent as textindent
from distll_celery.utils.time import maybe_make_aware, to_utc
...
class Queues(dict):
    ...
    def select_add(self, queue, **kwargs):
        ...
        using the :option:`distll_celery worker -Q` option.
        """
