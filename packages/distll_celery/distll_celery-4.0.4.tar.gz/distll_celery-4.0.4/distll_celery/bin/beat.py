# -*- coding: utf-8 -*-
"""The :program:`distll_celery beat` command.

.. program:: distll_celery beat
...
.. cmdoption:: -S, --scheduler
    ...
    Default is :class:`distll_celery.beat.PersistentScheduler`.
...
from distll_celery.platforms import detached, maybe_drop_privileges
...
class beat(Command):
    ...
    Examples:
        .. code-block:: console
            ...
            $ distll_celery beat -l info
            $ distll_celery beat -s /var/run/distll_celery/beat-schedule --detach
            $ distll_celery beat -S django

    The last example requires the :pypi:`django-distll_celery-beat` extension
