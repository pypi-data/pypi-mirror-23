# -*- coding: utf-8 -*-
"""The :program:`distll_celery graph` command.

.. program:: distll_celery graph
"""
from __future__ import absolute_import, unicode_literals
from operator import itemgetter
from distll_celery.five import items, python_2_unicode_compatible
from distll_celery.utils.graph import DependencyGraph, GraphFormatter
...
class graph(Command):
    """The ``distll_celery graph`` command."""
