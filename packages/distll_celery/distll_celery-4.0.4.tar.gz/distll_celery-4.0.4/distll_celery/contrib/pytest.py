...
def celery_session_app(request,
    ...
    mark = request.node.get_marker('distll_celery')
...
def celery_parameters():
    ...
    as parameters when instantiating :class:`~distll_celery.Celery`.
    """
    return {}
...
def celery_worker_parameters():
    ...
    The dict returned by your fixture will then be used
    as parameters when instantiating :class:`~distll_celery.worker.WorkController`.
    """
    return {}
