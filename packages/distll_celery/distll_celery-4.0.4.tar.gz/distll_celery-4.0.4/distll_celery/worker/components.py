...
from distll_celery._state import _set_task_join_will_block
...
from distll_celery.utils.log import worker_logger as logger
...
class Beat(bootsteps.StartStopStep):
    ...
    def create(self, w):
        from distll_celery.beat import EmbeddedService
