...
import threading
import weakref
from distll_celery.local import Proxy
...
class _TLS(threading.local):
    #: Apps with the :attr:`~distll_celery.app.base.BaseApp.set_as_current` attribute
...
def _get_current_app():
    if default_app is None:
        ...
        from distll_celery.app.base import Celery
