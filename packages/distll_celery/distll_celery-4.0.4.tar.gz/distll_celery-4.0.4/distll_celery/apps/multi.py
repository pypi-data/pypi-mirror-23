...
from distll_celery.five import UserList, items
from distll_celery.platforms import IS_WINDOWS, Pidfile, signal_name
from distll_celery.utils.nodenames import (
...
class MultiParser(object):
    ...
    def __init__(self, cmd='distll_celery worker',
                 append='', prefix='', suffix='',
                 range_prefix='distll_celery'):
        self.cmd = cmd
        self.append = append
        self.prefix = prefix
        self.suffix = suffix
