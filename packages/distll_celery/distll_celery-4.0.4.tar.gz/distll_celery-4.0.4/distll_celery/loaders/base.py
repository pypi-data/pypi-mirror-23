...
from distll_celery.five import reraise, string_t
from distll_celery.utils.collections import DictAttribute, force_mapping
from distll_celery.utils.functional import maybe_list
from distll_celery.utils.imports import (
...
class BaseLoader(object):
    ...
    Loaders handles,
        ...
        * Reading distll_celery client/worker configurations.
    ...
    def on_worker_init(self):
        """Called when the worker (:program:`distll_celery worker`) starts."""
        pass

    def on_worker_shutdown(self):
        """Called when the worker (:program:`distll_celery worker`) shuts down."""
        pass
    ...
    def cmdline_config_parser(
            self, args, namespace='distll_celery',
            re_type=re.compile(r'\((\w+)\)'),
            extra_types={'json': json.loads},
            override_types={'tuple': 'json',
                            'list': 'json',
                            'dict': 'json'}):
        from distll_celery.app.defaults import Option, NAMESPACES
