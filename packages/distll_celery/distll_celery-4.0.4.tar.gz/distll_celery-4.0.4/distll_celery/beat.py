...
class ScheduleEntry(object):
    ...
    Arguments:
        ...
        schedule (~distll_celery.schedules.schedule): see :attr:`schedule`.
    ...
    #: The schedule (:class:`~distll_celery.schedules.schedule`)
    schedule = None
    ...
    def is_due(self):
        """See :meth:`~distll_celery.schedule.schedule.is_due`."""
...
class Scheduler(object):
    ...
    The :program:`distll_celery beat` program may instantiate this class
    ...
    def install_default_entries(self, data):
        ...
        if self.app.conf.result_expires and \
            ...
            if 'distll_celery.backend_cleanup' not in data:
                entries['distll_celery.backend_cleanup'] = {
                    'task': 'distll_celery.backend_cleanup',
...
class Service(object):
    ...
    def start(self, embedded_process=False):
        ...
        if embedded_process:
            ...
            platforms.set_process_title('distll_celery beat')
    ...
    def get_scheduler(self, lazy=False,
                      extension_namespace='distll_celery.beat_schedulers'):
