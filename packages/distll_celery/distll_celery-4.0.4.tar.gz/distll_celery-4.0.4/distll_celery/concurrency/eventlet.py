...
"""
RACE_MODS = ('billiard.', 'distll_celery.', 'kombu.')


#: Warn if we couldn't patch early enough,
#: and thread/socket depending distll_celery modules have already been loaded.
...
from distll_celery import signals  # noqa
