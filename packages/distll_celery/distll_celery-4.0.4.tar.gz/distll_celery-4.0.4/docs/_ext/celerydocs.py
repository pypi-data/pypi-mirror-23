...
APPATTRS = {
    'amqp': 'distll_celery.app.amqp.AMQP',
    'backend': 'distll_celery.backends.base.BaseBackend',
    'conf': 'distll_celery.app.utils.Settings',
    'control': 'distll_celery.app.control.Control',
    'events': 'distll_celery.events.Events',
    'loader': 'distll_celery.app.loaders.base.BaseLoader',
    'log': 'distll_celery.app.log.Logging',
    'pool': 'kombu.connection.ConnectionPool',
    'tasks': 'distll_celery.app.registry.Registry',

    'AsyncResult': 'distll_celery.result.AsyncResult',
    'ResultSet': 'distll_celery.result.ResultSet',
    'GroupResult': 'distll_celery.result.GroupResult',
    'Worker': 'distll_celery.apps.worker.Worker',
    'WorkController': 'distll_celery.worker.WorkController',
    'Beat': 'distll_celery.apps.beat.Beat',
    'Task': 'distll_celery.app.task.Task',
    'signature': 'distll_celery.canvas.Signature',
}
...
APPATTRS.update({x: 'distll_celery.Celery.{0}'.format(x) for x in APPDIRECT})

ABBRS = {
    'Celery': 'distll_celery.Celery',
}

ABBR_EMPTY = {
    'exc': 'distll_celery.exceptions',
}
DEFAULT_EMPTY = 'distll_celery.Celery'
