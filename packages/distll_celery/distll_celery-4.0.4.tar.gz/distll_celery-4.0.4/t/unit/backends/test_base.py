...
from distll_celery import chord, group, uuid
from distll_celery.backends.base import (
    BaseBackend,
    KeyValueStoreBackend,
    DisabledBackend,
    _nulldict,
)
from distll_celery.exceptions import ChordError, TimeoutError
from distll_celery.five import items, bytes_if_py2, range
from distll_celery.result import result_from_tuple
from distll_celery.utils import serialization
from distll_celery.utils.functional import pass1
from distll_celery.utils.serialization import subclass_exception
from distll_celery.utils.serialization import find_pickleable_exception as fnpe
from distll_celery.utils.serialization import UnpickleableExceptionWrapper
from distll_celery.utils.serialization import get_pickleable_exception as gpe
...
class test_BaseBackend_interface:
    ...
    def test_apply_chord(self, unlock='distll_celery.chord_unlock'):
...
class test_BaseBackend_dict:
    ...
    def test_chord_error_from_stack_raises(self):
        ...
        group = self.patching('distll_celery.group')
...
class test_KeyValueStoreBackend:
    ...
    @patch('distll_celery.backends.base.GroupResult')
    @patch('distll_celery.backends.base.maybe_signature')
    ...
    def _chord_part_context(self, b):
        ...
        b.client = Mock()
        with patch('distll_celery.backends.base.GroupResult') as GR:
