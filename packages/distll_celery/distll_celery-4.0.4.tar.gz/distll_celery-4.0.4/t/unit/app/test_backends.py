...
from distll_celery.app import backends
from distll_celery.backends.amqp import AMQPBackend
from distll_celery.backends.cache import CacheBackend
...
class test_backends:
    ...
    def test_sym_raises_ValuError(self, app):
        with patch('distll_celery.app.backends.symbol_by_name') as sbn:
