...
from distll_celery.bin.multi import main, MultiTool, __doc__ as doc
...
class test_MultiTool:
    ...
    def test_Cluster(self):
        ...
        assert c.cmd == 'distll_celery worker'
...
class test_MultiTool_functional:
    ...
    def test_splash(self):
        ...
        self.t.splash()
        assert 'distll_celery multi' in self.fh.getvalue()
    ...
    @patch('distll_celery.bin.multi.MultiTool')
