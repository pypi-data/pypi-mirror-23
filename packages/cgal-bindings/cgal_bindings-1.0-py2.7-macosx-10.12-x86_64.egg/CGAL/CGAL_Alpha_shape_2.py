...
_CGAL_Alpha_shape_2.EXTERIOR_swigconstant(_CGAL_Alpha_shape_2)
EXTERIOR = _CGAL_Alpha_shape_2.EXTERIOR

_CGAL_Alpha_shape_2.SINGULAR_swigconstant(_CGAL_Alpha_shape_2)
SINGULAR = _CGAL_Alpha_shape_2.SINGULAR

_CGAL_Alpha_shape_2.REGULAR_swigconstant(_CGAL_Alpha_shape_2)
REGULAR = _CGAL_Alpha_shape_2.REGULAR

_CGAL_Alpha_shape_2.INTERIOR_swigconstant(_CGAL_Alpha_shape_2)
INTERIOR = _CGAL_Alpha_shape_2.INTERIOR

_CGAL_Alpha_shape_2.GENERAL_swigconstant(_CGAL_Alpha_shape_2)
GENERAL = _CGAL_Alpha_shape_2.GENERAL

_CGAL_Alpha_shape_2.REGULARIZED_swigconstant(_CGAL_Alpha_shape_2)
