...
class TestInformationForExcerptsGrammar(unittest.TestCase):
    def setUp(self):
        self.grammar = get_record_grammar('information_for_excerpts')
...
class TestInformationForExcerptsGrammarException(unittest.TestCase):
    def setUp(self):
        self.grammar = get_record_grammar('information_for_excerpts')
