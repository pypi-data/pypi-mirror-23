...
def process(mol, hydrogens=True, generate_coords=True, infer_bonds=True):
    ...
    return json.dumps(_pybel_to_object(mol), separators=(',', ':'))
...
def _dumps(obj):
    """Outputs json with formatting edits."""
