...
def decompress(compressed) -> bytearray:
    """Decompresses and returns the given compressed data.

    :param compressed: The compressed Yaz0 file data.

    :raises AssertionError: The Yaz0 header in the compressed data is invalid.

    :return: The decompressed Yaz0 data.
    :rtype: bytearray
    """
