...
from sequenza.misc import SeqzLoger
...
def main():
    ...
    parser = DefaultHelpParser(
        ...
        description=('Sequenza Utils is an ensemble of tools capable '
                     'of perform various tasks, primarily aimed to convert '
                     'bam/pileup files to a format usable by the sequenza '
                     'R package'),
        add_help=True,
