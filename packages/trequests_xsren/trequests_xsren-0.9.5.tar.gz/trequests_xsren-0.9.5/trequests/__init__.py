    ...
    def send(self, request, stream=False, timeout=None, verify=True,
        ...
        if proxies:
            if proxies.get('http', None):
                proxy_host, proxy_port, proxy_username, proxy_password = self._parse_proxy_url(proxies['http'])
            elif proxies.get('https', None):
                proxy_host, proxy_port, proxy_username, proxy_password = self._parse_proxy_url(proxies['https'])
