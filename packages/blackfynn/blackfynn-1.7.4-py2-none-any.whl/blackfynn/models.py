...
class BaseDataNode(BaseNode):
    ...
    def __init__(self, name, type,
        ...
        #: str: the state of the object, ``READY``, ``UNAVAILABLE``, or ``ERROR``
        self.state = None
    ...
    def get_property(self, key, category='Blackfynn'):
        ...
        Example::
            ...
            pkg.insert_property('quality', 85.0)
...
class BaseCollection(BaseDataNode):
    ...
    def upload_files(self, *files):
        ...
        Note:
            Will be depreciated. Please use ``.upload()`` method instead.
        """
        self._check_exists()
...
class TimeSeries(DataPackage):
    ...
    def end(self):
        """
        The end time of time series data (over all channels)
        """
        self._check_exists()
    ...
    def insert_annotation(self,layer,annotation,start=None,end=None,channel_ids=None,annotation_description=None):
        ...
        Args:
            ...
            end (optional): start of annotation
...
class TimeSeriesChannel(BaseDataNode):
    ...
    def end(self):
        """
        The end time of channel data (microseconds since Epoch)
        """
        return self._end
...
class Tabular(DataPackage):
    ...
    def get_data(self,limit=1000, offset=0,order_by = None, order_direction='ASC'):
        ...
        Args:
            ...
            order_direction: Ascending ('ASC') or descending ('DES')
...
class Dataset(BaseCollection):
    ...
    def add_collaborators(self, *collaborator_ids):
        ...
        Args:
            collaborator_ids: List of collaborator IDs to add (Users)
        """
        self._check_exists()
