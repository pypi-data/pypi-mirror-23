...
class CyberGlove():
            ...
            if os.path.exists(mapping_file):
                ...
                if os.path.exists(recordings_file):
                    raise Exception("Recordings exist, but calibration mapping is missing.\n" +
                                    ...
                                    "To generate mapping run following command in console:\n" +
                ...
                raise Exception("You have to record calibration for cyberglove.\n" +
                                "mapping file: (not found) {}\n".format(mapping_file) +
                                "To calibrate cyberglove call following command in console:\n" +
    ...
    def _reader(self, queue):
        ...
        while True:
            ...
            if not re.match(self._time_regex, data):
                ...
                data = self._sync()
            if len(data) < self._packet_len:
                print('Read packet too short')
                data = self._sync()
    ...
    def _sync(self):
        ...
        while find is None:
            ...
            if time.time() - self._last_resync < 2.0:
                raise Exception('Re-syncing occurred twice within 2 sec.\n' +
                                'Unplug and plug your cyberglove. Quitting')
