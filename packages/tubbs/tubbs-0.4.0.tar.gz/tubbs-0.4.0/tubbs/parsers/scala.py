...
class ScalaParser(Parser):
    ...
    @tatsumasu()
    def _constrAnnotation_(self):  # noqa
        self._token('@')
        self._regularType_()
        self._argListExpr_()
    ...
    @tatsumasu()
    def _classTemplateOpt_(self):  # noqa
        with self._choice():
            with self._option():
                self._token('extends')
                self._classTemplate_()
    ...
    @tatsumasu()
    def _traitTemplateOpt_(self):  # noqa
        with self._choice():
            with self._option():
                self._token('extends')
...
class ScalaSemantics(object):
    ...
    def constrAnnotation(self, ast):  # noqa
        return ast
    ...
    def classTemplateOpt(self, ast):  # noqa
        return ast

    def traitTemplateOpt(self, ast):  # noqa
        return ast
    ...
    def constrExpr(self, ast):  # noqa
        return ast

    def constrBlock(self, ast):  # noqa
        return ast
