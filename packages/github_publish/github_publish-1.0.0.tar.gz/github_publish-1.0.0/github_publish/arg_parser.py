...
class ArgHandler():
    def __init__(self,
        ...
        self.download.add_argument(*self.tag_name.args, **self.tag_name.kwargs)
        ...
        self.edit.add_argument(*self.tag_name.args, **self.tag_name.kwargs)
        ...
        self.info.add_argument(*self.tag_name.args, **self.tag_name.kwargs)
        ...
        self.release.add_argument(*self.tag_name.args, **self.tag_name.kwargs)
        ...
        self.upload.add_argument(*self.tag_name.args, **self.tag_name.kwargs)
