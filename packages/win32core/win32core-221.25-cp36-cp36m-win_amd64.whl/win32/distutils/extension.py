...
class WinExt(Extension):
    ...
    def __init__(
        ...
        define_macros: List[tuple] = define_macros or []
        define_macros.append(('DISTUTILS_BUILD', None))
        define_macros.append(('_CRT_SECURE_NO_WARNINGS', None))

        self.pch_header: str = pch_header
        self.extra_swig_commands: List[str] = extra_swig_commands or []
        self.windows_h_version: int = windows_h_version
        self.optional_headers: List[str] = optional_headers
        self.is_regular_dll: bool = is_regular_dll
        self.platforms = platforms
        self.implib_name: str = implib_name
        self.external_modules: List[str] = external_modules
        self.build_temp_library_dirs: List[str] = build_temp_library_dirs
        ...
        self.unicode_mode: bool = unicode_mode
    ...
    def parse_def_file(self, path) -> List[str]:
