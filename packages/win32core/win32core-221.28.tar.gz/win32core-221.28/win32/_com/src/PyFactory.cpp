...
CPyFactory::CPyFactory(REFCLSID guidClassID) : m_guidClassID(guidClassID),
											   m_cRef(1)
{
...
STDMETHODIMP_(ULONG)
CPyFactory::AddRef(void)
{
	return InterlockedIncrement(&m_cRef);
}

STDMETHODIMP_(ULONG)
CPyFactory::Release(void)
{
...
BOOL LoadGatewayModule(PyObject **ppModule)
{
	...
	pPyModule = PyImport_ImportModule("win32.com.server.policy");
	if (!pPyModule)
	{
