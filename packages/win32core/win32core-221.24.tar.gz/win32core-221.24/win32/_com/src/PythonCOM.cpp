...
static PyObject *pythoncom_CoMarshalInterface(PyObject *self, PyObject *args)
{
	...
	if (!PyArg_ParseTuple(args, "OOOk|k:CoMarshalInterface",
		...
		return NULL;
	if (PyWinObject_AsIID(obriid, &riid) && PyCom_InterfaceFromPyObject(obIStream, IID_IStream, (void **)&pIStream, FALSE) && PyCom_InterfaceFromPyObject(obUnk, IID_IUnknown, (void **)&pIUnknown, FALSE))
	{
		PY_INTERFACE_PRECALL;
...
static PyObject *pythoncom_CoUnmarshalInterface(PyObject *self, PyObject *args)
{
	...
	if (!PyArg_ParseTuple(args, "OO:CoUnmarshalInterface",
		...
		return NULL;
	if (PyWinObject_AsIID(obriid, &riid) && PyCom_InterfaceFromPyObject(obIStream, IID_IStream, (void **)&pIStream, FALSE))
	{
		PY_INTERFACE_PRECALL;
...
static char *modName = "win32._com";

extern BOOL initunivgw(PyObject *parentDict);

/* Module initialisation */
PYWIN_MODULE_INIT_FUNC(_com)
{
	...
	PYWIN_MODULE_INIT_PREPARE(_com, pythoncom_methods,
	...
	if (PyType_Ready(&PyOleEmptyType) == -1 || PyType_Ready(&PyOleMissingType) == -1 || PyType_Ready(&PyOleArgNotFoundType) == -1)
		PYWIN_MODULE_INIT_RETURN_ERROR;
