...
from win32.distutils.util import generate_libs, archive_headers, extract_headers
...
class win32_build_ext(build_ext):
    def finalize_options(self) -> None:
        ...
        for ext in self.extensions:
            ...
            for include_dir in copy(ext.include_dirs):
                ext.include_dirs += [
                    os.path.join(self.build_temp, 'include', include_dir)
                ]
    ...
    def extract_headers(self) -> None:
        include_dir: str = os.path.join(self.build_temp, 'include')
    ...
    def find_swig(self):
        ...
        lib: str = os.path.join(os.path.dirname(swig), 'swig_lib')
