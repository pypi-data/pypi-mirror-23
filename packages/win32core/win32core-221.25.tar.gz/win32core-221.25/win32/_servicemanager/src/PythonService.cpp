...
PYWIN_MODULE_INIT_FUNC(_servicemanager)
{
	PYWIN_MODULE_INIT_PREPARE(_servicemanager, servicemanager_functions,
...
int _tmain(int argc, TCHAR **argv)
{
	...
	Py_Initialize();
	PyEval_InitThreads();
	module = PyImport_ImportModule("win32.servicemanager");
	if (!module)
		goto failed;
