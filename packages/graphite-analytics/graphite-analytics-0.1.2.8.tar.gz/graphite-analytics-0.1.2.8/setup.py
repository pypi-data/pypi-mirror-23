...
setup(
  ...
  packages = ['graphite'],
  package_data={
    'graphite' : ['capture.js', 'templates/css/styles.css', 'templates/js/Chart.PieceLabel.js', 'templates/html/render.html', 'templates/fonts/Antro-Vectra.otf', 'templates/images/Calendar-icon.png'],
  },
  version = '0.1.2.8',
