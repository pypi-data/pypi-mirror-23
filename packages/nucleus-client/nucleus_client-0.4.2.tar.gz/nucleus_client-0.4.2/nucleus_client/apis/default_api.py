...
class DefaultApi(object):
    ...
    def add_api_key(self, client_id, user, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_api_key(client_id, user, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_api_key_with_http_info(client_id, user, **kwargs)
        else:
            (data) = self.add_api_key_with_http_info(client_id, user, **kwargs)
            return data

    def add_api_key_with_http_info(self, client_id, user, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_api_key_with_http_info(client_id, user, callback=callback_function)
        ...
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `add_api_key`")
    ...
    def add_entity_identity(self, client_id, entity_id, entity_identity, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_entity_identity(client_id, entity_id, entity_identity, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str client_id:  (required)
        :param str entity_id:  (required)
        :param EntityIdentity entity_identity:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_entity_identity_with_http_info(client_id, entity_id, entity_identity, **kwargs)
        else:
            (data) = self.add_entity_identity_with_http_info(client_id, entity_id, entity_identity, **kwargs)
            return data

    def add_entity_identity_with_http_info(self, client_id, entity_id, entity_identity, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_entity_identity_with_http_info(client_id, entity_id, entity_identity, callback=callback_function)
        ...
        all_params = ['client_id', 'entity_id', 'entity_identity']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_entity_identity" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `add_entity_identity`")
        # verify the required parameter 'entity_id' is set
        if ('entity_id' not in params) or (params['entity_id'] is None):
            raise ValueError("Missing the required parameter `entity_id` when calling `add_entity_identity`")
        # verify the required parameter 'entity_identity' is set
        if ('entity_identity' not in params) or (params['entity_identity'] is None):
            raise ValueError("Missing the required parameter `entity_identity` when calling `add_entity_identity`")

        resource_path = '/entity-identities'.replace('{format}', 'json')
        path_params = {}
        ...
        body_params = None
        if 'entity_identity' in params:
            body_params = params['entity_identity']
    ...
    def add_task_type(self, task_type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_task_type(task_type, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param TaskType task_type:  (required)
        :return: TaskType
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_task_type_with_http_info(task_type, **kwargs)
        else:
            (data) = self.add_task_type_with_http_info(task_type, **kwargs)
            return data

    def add_task_type_with_http_info(self, task_type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_task_type_with_http_info(task_type, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_task_type" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'task_type' is set
        if ('task_type' not in params) or (params['task_type'] is None):
            raise ValueError("Missing the required parameter `task_type` when calling `add_task_type`")

        resource_path = '/task-types'.replace('{format}', 'json')
        path_params = {}
    ...
    def add_view_and_recalc(self, view, **kwargs):
        """
        
        Add a view for a specific client and recalculate it.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_view_and_recalc(view, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_view_and_recalc_with_http_info(view, **kwargs)
        else:
            (data) = self.add_view_and_recalc_with_http_info(view, **kwargs)
            return data

    def add_view_and_recalc_with_http_info(self, view, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_view_and_recalc_with_http_info(view, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_view_and_recalc" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'view' is set
        if ('view' not in params) or (params['view'] is None):
            raise ValueError("Missing the required parameter `view` when calling `add_view_and_recalc`")

        resource_path = '/experimental/views'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_task_type(self, task_type_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_task_type(task_type_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str task_type_id:  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_task_type_with_http_info(task_type_id, **kwargs)
        else:
            (data) = self.delete_task_type_with_http_info(task_type_id, **kwargs)
            return data

    def delete_task_type_with_http_info(self, task_type_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_task_type_with_http_info(task_type_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_task_type" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'task_type_id' is set
        if ('task_type_id' not in params) or (params['task_type_id'] is None):
            raise ValueError("Missing the required parameter `task_type_id` when calling `delete_task_type`")

        resource_path = '/task-types/{task_type_id}'.replace('{format}', 'json')
        path_params = {}
        if 'task_type_id' in params:
            path_params['task_type_id'] = params['task_type_id']
    ...
    def get_activities_with_http_info(self, client_id, activity_type, **kwargs):
        ...
        all_params = ['client_id', 'activity_type', 'integration_id', 'page', 'per_page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
    ...
    def get_activities_count(self, client_id, activity_type, **kwargs):
        """
        
        Get count of activities for in a custom dataset
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_activities_count(client_id, activity_type, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_activities_count_with_http_info(client_id, activity_type, **kwargs)
        else:
            (data) = self.get_activities_count_with_http_info(client_id, activity_type, **kwargs)
            return data

    def get_activities_count_with_http_info(self, client_id, activity_type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_activities_count_with_http_info(client_id, activity_type, callback=callback_function)
        ...
        all_params = ['client_id', 'activity_type', 'integration_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_activities_count" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `get_activities_count`")
        # verify the required parameter 'activity_type' is set
        if ('activity_type' not in params) or (params['activity_type'] is None):
            raise ValueError("Missing the required parameter `activity_type` when calling `get_activities_count`")

        resource_path = '/activities/count'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_entities(self, client_id, **kwargs):
        """
        
        Get a list of entities for a client.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entities(client_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_entities_with_http_info(client_id, **kwargs)
        else:
            (data) = self.get_entities_with_http_info(client_id, **kwargs)
            return data

    def get_entities_with_http_info(self, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entities_with_http_info(client_id, callback=callback_function)
        ...
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `get_entities`")
    ...
    def get_entity(self, entity_id, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entity(entity_id, client_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_entity_with_http_info(entity_id, client_id, **kwargs)
        else:
            (data) = self.get_entity_with_http_info(entity_id, client_id, **kwargs)
            return data

    def get_entity_with_http_info(self, entity_id, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entity_with_http_info(entity_id, client_id, callback=callback_function)
        ...
        all_params = ['entity_id', 'client_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        # verify the required parameter 'entity_id' is set
        if ('entity_id' not in params) or (params['entity_id'] is None):
            raise ValueError("Missing the required parameter `entity_id` when calling `get_entity`")
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `get_entity`")

        resource_path = '/entities/{entity_id}'.replace('{format}', 'json')
        path_params = {}
        if 'entity_id' in params:
            path_params['entity_id'] = params['entity_id']
    ...
    def get_entity_identities(self, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entity_identities(client_id, callback=callback_function)
        ...
        :param int page: 
        :param str entity_id: 
        :return: list[EntityIdentity]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_entity_identities_with_http_info(client_id, **kwargs)
        else:
            (data) = self.get_entity_identities_with_http_info(client_id, **kwargs)
            return data

    def get_entity_identities_with_http_info(self, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entity_identities_with_http_info(client_id, callback=callback_function)
        ...
        all_params = ['client_id', 'page', 'entity_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entity_identities" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `get_entity_identities`")
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[EntityIdentity]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'),
                                            _return_http_data_only=params.get('_return_http_data_only'))

    def get_entity_identity(self, integration_id, external_key, entity_id, client_id, **kwargs):
        """
        
        Get an identity by entity, integration id, and external key.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entity_identity(integration_id, external_key, entity_id, client_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_entity_identity_with_http_info(integration_id, external_key, entity_id, client_id, **kwargs)
        else:
            (data) = self.get_entity_identity_with_http_info(integration_id, external_key, entity_id, client_id, **kwargs)
            return data

    def get_entity_identity_with_http_info(self, integration_id, external_key, entity_id, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_entity_identity_with_http_info(integration_id, external_key, entity_id, client_id, callback=callback_function)
        ...
        all_params = ['integration_id', 'external_key', 'entity_id', 'client_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entity_identity" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `get_entity_identity`")
        # verify the required parameter 'external_key' is set
        if ('external_key' not in params) or (params['external_key'] is None):
            raise ValueError("Missing the required parameter `external_key` when calling `get_entity_identity`")
        # verify the required parameter 'entity_id' is set
        if ('entity_id' not in params) or (params['entity_id'] is None):
            raise ValueError("Missing the required parameter `entity_id` when calling `get_entity_identity`")
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `get_entity_identity`")

        resource_path = '/entity-identities/key-{integration_id}-{external_key}'.replace('{format}', 'json')
        path_params = {}
        if 'integration_id' in params:
            path_params['integration_id'] = params['integration_id']
    ...
    def get_task_type(self, task_type_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_task_type(task_type_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_task_type_with_http_info(task_type_id, **kwargs)
        else:
            (data) = self.get_task_type_with_http_info(task_type_id, **kwargs)
            return data

    def get_task_type_with_http_info(self, task_type_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_task_type_with_http_info(task_type_id, callback=callback_function)
        ...
        # verify the required parameter 'task_type_id' is set
        if ('task_type_id' not in params) or (params['task_type_id'] is None):
            raise ValueError("Missing the required parameter `task_type_id` when calling `get_task_type`")
    ...
    def get_task_type_by_name(self, task_type_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_task_type_by_name(task_type_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str task_type_name:  (required)
        :return: TaskType
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_task_type_by_name_with_http_info(task_type_name, **kwargs)
        else:
            (data) = self.get_task_type_by_name_with_http_info(task_type_name, **kwargs)
            return data

    def get_task_type_by_name_with_http_info(self, task_type_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_task_type_by_name_with_http_info(task_type_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_task_type_by_name" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'task_type_name' is set
        if ('task_type_name' not in params) or (params['task_type_name'] is None):
            raise ValueError("Missing the required parameter `task_type_name` when calling `get_task_type_by_name`")

        resource_path = '/task-types/name-{task_type_name}'.replace('{format}', 'json')
        path_params = {}
        if 'task_type_name' in params:
            path_params['task_type_name'] = params['task_type_name']
    ...
    def get_task_types(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_task_types(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_task_types_with_http_info(**kwargs)
        else:
            (data) = self.get_task_types_with_http_info(**kwargs)
            return data

    def get_task_types_with_http_info(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_task_types_with_http_info(callback=callback_function)
    ...
    def get_view_details(self, client_id, **kwargs):
        """
        
        Get a list of view details for a client.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_view_details(client_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_view_details_with_http_info(client_id, **kwargs)
        else:
            (data) = self.get_view_details_with_http_info(client_id, **kwargs)
            return data

    def get_view_details_with_http_info(self, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_view_details_with_http_info(client_id, callback=callback_function)
        ...
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `get_view_details`")

        resource_path = '/view-details'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_task_type(self, task_type_id, task_type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_task_type(task_type_id, task_type, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_task_type_with_http_info(task_type_id, task_type, **kwargs)
        else:
            (data) = self.update_task_type_with_http_info(task_type_id, task_type, **kwargs)
            return data

    def update_task_type_with_http_info(self, task_type_id, task_type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_task_type_with_http_info(task_type_id, task_type, callback=callback_function)
        ...
        all_params = ['task_type_id', 'task_type']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        # verify the required parameter 'task_type_id' is set
        if ('task_type_id' not in params) or (params['task_type_id'] is None):
            raise ValueError("Missing the required parameter `task_type_id` when calling `update_task_type`")
        # verify the required parameter 'task_type' is set
        if ('task_type' not in params) or (params['task_type'] is None):
            raise ValueError("Missing the required parameter `task_type` when calling `update_task_type`")
