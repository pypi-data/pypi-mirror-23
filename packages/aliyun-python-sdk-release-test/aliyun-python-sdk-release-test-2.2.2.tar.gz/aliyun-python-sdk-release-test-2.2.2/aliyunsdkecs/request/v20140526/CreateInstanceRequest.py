...
class CreateInstanceRequest(RpcRequest):
	...
	def get_DataDisk1Encrypted(self):
		return self.get_query_params().get('DataDisk.1.Encrypted')

	def set_DataDisk1Encrypted(self,DataDisk1Encrypted):
		self.add_query_param('DataDisk.1.Encrypted',DataDisk1Encrypted)
	...
	def get_DataDisk4Encrypted(self):
		return self.get_query_params().get('DataDisk.4.Encrypted')

	def set_DataDisk4Encrypted(self,DataDisk4Encrypted):
		self.add_query_param('DataDisk.4.Encrypted',DataDisk4Encrypted)
	...
	def get_DataDisk3Encrypted(self):
		return self.get_query_params().get('DataDisk.3.Encrypted')

	def set_DataDisk3Encrypted(self,DataDisk3Encrypted):
		self.add_query_param('DataDisk.3.Encrypted',DataDisk3Encrypted)
	...
	def get_DataDisk2Encrypted(self):
		return self.get_query_params().get('DataDisk.2.Encrypted')

	def set_DataDisk2Encrypted(self,DataDisk2Encrypted):
		self.add_query_param('DataDisk.2.Encrypted',DataDisk2Encrypted)
