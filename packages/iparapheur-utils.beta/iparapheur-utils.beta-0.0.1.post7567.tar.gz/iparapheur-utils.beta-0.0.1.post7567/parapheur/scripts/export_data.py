...
def bureaux_handler():
    ...
    bar = progressbar.ProgressBar(max_value=len(bureaux))
...
def types_handler():
    ...
    bar = progressbar.ProgressBar(max_value=len(types))
...
def calque_handler():
    ...
    bar = progressbar.ProgressBar(max_value=len(calques))
...
def advanced_handler():
    ...
    pprint.header("\nExporting advanced configuration ...")
