...
class Connection:
    ...
    def get_pipe_schema_def_url(self, pipe_id, sample_size):
        return self.get_pipe_url(pipe_id) + "/generate-schema-definition?sample_size=%s" % sample_size
    ...
    def get_pipe_schema_def(self, pipe_id, sample_size=1000):
        # TODO: wrap in a utility-method and add error-detection
        response = self.do_get_request(self.get_pipe_schema_def_url(pipe_id, sample_size))
        if response.status_code == 404:
            return None
