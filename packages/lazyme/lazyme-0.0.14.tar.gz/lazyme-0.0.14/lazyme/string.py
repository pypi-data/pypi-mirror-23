...
formatter = {
    ...
    'bold': '\033[1m',
    'faint': '\033[2m',
    'italic': '\033[3m',        # Doesn't work on Mac terminal.
    'underline': '\033[4m',
    'blinking': '\033[5m',
    'fast_blinking': '\033[6m', # Doesn't work on Mac terminal.
    'reverse': '\033[7m',       # Doesn't work on Mac terminal.
    'hide': '\033[8m',
    'strikethrough': '\033[9m', # Doesn't work on Mac terminal.
}
