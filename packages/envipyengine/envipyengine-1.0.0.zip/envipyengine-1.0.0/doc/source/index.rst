...
If the value of 'engine' is empty then set it to the the full path of the 'taskengine' executable in your ENVI installation::
...
To execute a task, use the :code:`execute()` method on the Task object.  A GSF Job object is returned after the job has been submitted::
    ...
    >>> input_raster = dict(url='', factory='URLRaster')
