/* sync-sample.c generated by valac 0.32.1, the Vala compiler
 * generated from sync-sample.vala, do not modify */
...
static void ___lambda4__gtk_adjustment_value_changed (GtkAdjustment* _sender, gpointer self);
static void __lambda5_ (SyncSample* self);
static void ___lambda5__gtk_adjustment_value_changed (GtkAdjustment* _sender, gpointer self);
...
SyncSample* sync_sample_construct (GType object_type) {
	...
	gtk_window_set_default_size ((GtkWindow*) self, 500, 50);
