...
__version__ = '$Id: 677592850ac2147460819f276f3ac93cbda3166d $'
...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ur', 'az', 'vo', 'hi', 'th', 'ka', 'ta', 'cy', 'mk', 'mg', 'oc',
            'lv', 'bs', 'new', 'tl', 'tt', 'ky', 'tg', 'te', 'sq', 'pms', 'br',
            ...
            'cdo', 'or', 'fo', 'mzn', 'li', 'hsb', 'sah', 'mai', 'sa', 'vec',
            'ilo', 'os', 'mrj', 'xmf', 'hif', 'mhr', 'roa-tara', 'bh', 'eml',
            'pam', 'diq', 'ps', 'sd', 'nso', 'hak', 'se', 'bcl', 'mi', 'nah',
            'nds-nl', 'gan', 'zh-classical', 'vls', 'rue', 'wuu', 'szl', 'bo',
            'glk', 'vep', 'sc', 'fiu-vro', 'co', 'lrc', 'crh', 'tk', 'kv',
            'km', 'csb', 'frr', 'gv', 'as', 'so', 'ace', 'lad', 'zea', 'ay',
            ...
            'jam', 'kbd', 'dty', 'ha', 'tyv', 'tet', 'tpi', 'ki', 'ig', 'na',
