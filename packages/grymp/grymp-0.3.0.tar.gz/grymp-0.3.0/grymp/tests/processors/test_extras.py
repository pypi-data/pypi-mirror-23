...
class TestExtras(unittest.TestCase):
    ...
    def test_translate_name_directory_btnet(self):
        self.assertEqual(
            Extras._translate_name('A.d-E.F-Grym@BTNET'),
            'A d - E F')
    ...
    def test_translate_name_file_btnet(self):
        self.assertEqual(
            Extras._translate_name(
                'Foo.Bar.baz.Bat.(Blim.Blom)-Grym@BTNET.mkv'),
            'Foo Bar baz Bat (Blim Blom).mkv')
