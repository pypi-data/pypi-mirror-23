...
# http://stackoverflow.com/a/1094933/2765666
def format_bytes(num):
    """
    Turn a number of bytes into a more human-friendly representation.

    :param num: The number of bytes to format.
    :return: The formatted number of bytes, e.g. '123.4 MiB'.
    """
    num = abs(num)
