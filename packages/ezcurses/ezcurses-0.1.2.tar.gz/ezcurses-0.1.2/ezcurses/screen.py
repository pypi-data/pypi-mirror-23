...
class Screen:
    ...
    def draw(self, clear=False):
        ...
        :param clear: clear for the next draw, default False
        '''
        self._area.refresh()
        if clear:
            self._area.clear()
...
class Pad(Screen):
    ...
    def draw(self, orig=None, top_left=None, bottom_right=None, clear=False):
        '''
        Draw out the changes.
...
class ezscreen:
    '''
    The ezscreen is a context manager that handles the setup and resetting of
    the terminal for curses programming.
