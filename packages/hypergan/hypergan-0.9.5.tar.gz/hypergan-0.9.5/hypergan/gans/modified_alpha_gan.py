...
class ModifiedAlphaGAN(BaseGAN):
    """ 
    """
    ...
    def create(self):
        ...
        with tf.device(self.device):
            ...
            z_hat_mod = (z_hat + tf.random_uniform(ops.shape(z_hat), -1, 1))/2
            ...
            x_hat_mod = self.generator.reuse(z_hat_mod)
            ...
            stacked_xg = ops.concat([x, x_hat, x_hat_mod, g], axis=0)
