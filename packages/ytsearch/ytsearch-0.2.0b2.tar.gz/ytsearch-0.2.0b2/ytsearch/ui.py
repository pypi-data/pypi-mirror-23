...
class SearchResults:
    ...
    def event_PLAY_STREAM_AUDIO(self, index, user=False):
        ...
        :return: bool: True if playlist adding mode should be stopped.
                       False otherwise.
        '''
    ...
    def event_MODE_PLAYER(self, _, user=False):
        ...
        :user: bool: True if the user called this, False otherwise.
        :return: bool: True if the MODE_PLAYER hook should be called,
                       False otherwise.
                 bool: True if playlist adding mode should be stopped.
                       False otherwise. 
        '''
    ...
    def event_MODE_SEARCH(self, _, user=False, force=False):
        ...
        :force: bool: True if you want to force this switch,
                      False otherwise.
        :return: bool: True if the MODE_SEARCH hook should be called,
                       False otherwise.
                 bool: True if playlist adding mode should be stopped.
                       False otherwise. 
        '''
    ...
    def event_MODE_ORIGINAL(self, _, user=False):
        ...
        :user: bool: True if the user called this, False otherwise.
        :return: bool: True if the MODE_ORIGINAL hook should be called,
                       False otherwise.
                 bool: True if playlist adding mode should be stopped.
                       False otherwise. 
        '''
    ...
    def event_MODE_EDIT_PLAYLIST(self, _, user=False):
        ...
        self.widgets.contents[5] = (self.input_placeholder, ('given', 1))
        return False
    ...
    def event_PLAYLIST_ADD(self, index, user=False):
        ...
        if name is not None:
            ...
            if any(v['name'] == video.name for v  in self.playlists[name]):
                index = self.playlists[name].index(data)
                del self.playlists[name][index]
                self.set_video_status(video, 'Removed')
            else:
