...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkQuadEdgeMeshPointPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkQuadEdgeMeshPointPython')
...
class itkQuadEdgeMeshPointF2GQEULULBBT(itkPointPython.itkPointF2):
    """Proxy of C++ itkQuadEdgeMeshPointF2GQEULULBBT class."""
...
class itkQuadEdgeMeshPointF3GQEULULBBT(itkPointPython.itkPointF3):
    """Proxy of C++ itkQuadEdgeMeshPointF3GQEULULBBT class."""
