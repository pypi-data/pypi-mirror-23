...
def get_file_links(url, include_links_from_linked_pages=False, no_of_files_limit=0, no_of_processes_specified_by_user=None,
    ...
    def check_count(count):
        ...
        if no_of_files_limit and count > no_of_files_limit:
...
def download(source, target="download", mb_per_file_limit=0, no_of_processes_specified_by_user=None):
    """
    ...
    if source:
        ...
        for link in source:
            ...
            if mb != "?" and mb_per_file_limit is not None and float(mb) > mb_per_file_limit:
...
def trawl(url, include_links_from_linked_pages=False, no_of_files_limit=0, no_of_processes_specified_by_user=None,
          whitelist=None, blacklist=None, target="download", mb_per_file_limit=0, quiet=False):
    """
    ...
    include_links_from_linked_pages : bool
    no_of_files_limit : int
    no_of_processes_specified_by_user : int
    whitelist : str or list
    blacklist : str or list
    target : str
    mb_per_file_limit : float
