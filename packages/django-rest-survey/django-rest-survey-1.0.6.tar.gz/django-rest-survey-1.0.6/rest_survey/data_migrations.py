...
def create_aldeia_survey(schema, apps):
    ...
    s2 = Section.objects.create(
        survey=survey,
        title=u'Informações gerais sobre a aldeia ou bairro'
    )
    ...
    s6 = Section.objects.create(
        survey=survey,
        title=u'Sistema de transporte e comunicação'
    )
...
def create_imovel_survey(schema, apps):
    ...
    s1 = Section.objects.create(
        survey=survey,
        title=u'Identificação'
    )

    s2 = Section.objects.create(
        survey=survey,
        title=u'Situação do Imóvel'
    )
    ...
    s3 = Section.objects.create(
        survey=survey,
        title=u'Características do Imóvel'
    )
    ...
    q12 = Question.objects.create(
        survey=survey,
        section=s4,
        text=u'4.2 Tem poço no terreno e a água é utilizada para o consumo doméstico?',
        type=QUESTION_TYPE_RADIO,
        options=[
            u'Sim',
            u'Não'
    ...
    q23 = Question.objects.create(
        survey=survey,
        section=s4,
        text=u'4.11.1 Caso "Sim", informe o tipo de tratamento?',
        type=QUESTION_TYPE_RADIO,
        parent=q22,
        parent_value=u'Sim',
        options=[
    ...
    q25 = Question.objects.create(
        survey=survey,
        section=s4,
        text=u'4.12.1 No caso de "Sim", quais os motivos pelos quais não usam?',
        type=QUESTION_TYPE_CHECKBOXES,
        options=[
            u'Gosto ruim',
            u'Cheiro ruim',
    ...
    s7 = Section.objects.create(
        survey=survey,
        title=u'Destino dos resíduos sólidos (lixo)'
    )
