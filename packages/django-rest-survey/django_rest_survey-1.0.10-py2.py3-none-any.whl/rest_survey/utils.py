...
def build_question(question):
    ...
    if question.type == QUESTION_TYPE_GRID:
        question_data[question_name]['type'] = 'Backgrid'
        if question.options and len(question.options)==2:
            if 'columns' in question.options[0]:
                question_data[question_name]['columns'] = question.options[0]['columns']
            if 'rows' in question.options[1]:
                question_data[question_name]['rows'] = question.options[1]['rows']
