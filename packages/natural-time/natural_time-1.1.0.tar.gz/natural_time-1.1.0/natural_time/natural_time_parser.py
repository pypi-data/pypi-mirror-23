        ...
        try:
            ...
            if st_tagged[i][1] == 'am':
                ...
                if st_tagged[i][1] == 'sec':
                    new_tag = ['rel_t', [None, None, num]]
                elif st_tagged[i][1] == 'min':
                    new_tag = ['rel_t', [None, num, None]]
                elif st_tagged[i][1] == 'hr':
                    new_tag = ['rel_t', [num, None, None]]
                elif st_tagged[i][1] == 'day':
                    new_tag = ['rel_t', [num*24, None, None]]
                elif st_tagged[i][1] == 'wk':
                    new_tag = ['rel_t', [num*24*7, None, None]]
                elif st_tagged[i][1] == 'mth':
                    new_tag = ['rel_t', [num*24*7*31, None, None]]
                elif st_tagged[i][1] == 'yr':
                    new_tag = ['rel_t', [num*24*365, None, None]]
