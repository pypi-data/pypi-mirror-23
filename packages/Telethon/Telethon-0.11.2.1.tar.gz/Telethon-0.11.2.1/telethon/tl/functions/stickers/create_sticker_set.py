...
class CreateStickerSetRequest(MTProtoRequest):
    ...
    def __str__(self):
        return '(stickers.createStickerSet (ID: 0x9bd86e6a) = (masks={}, user_id={}, title={}, short_name={}, stickers={}))'.format(str(self.masks), str(self.user_id), str(self.title), str(self.short_name), None if not self.stickers else [str(_) for _ in self.stickers])
