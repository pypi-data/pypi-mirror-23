...
class GetTopPeersRequest(MTProtoRequest):
    ...
    def __str__(self):
        return '(contacts.getTopPeers (ID: 0xd4982db5) = (correspondents={}, bots_pm={}, bots_inline={}, phone_calls={}, groups={}, channels={}, offset={}, limit={}, hash={}))'.format(str(self.correspondents), str(self.bots_pm), str(self.bots_inline), str(self.phone_calls), str(self.groups), str(self.channels), str(self.offset), str(self.limit), str(self.hash))
