...
class EditBannedRequest(MTProtoRequest):
    ...
    def __str__(self):
        return '(channels.editBanned (ID: 0xbfd915cd) = (channel={}, user_id={}, banned_rights={}))'.format(str(self.channel), str(self.user_id), str(self.banned_rights))
