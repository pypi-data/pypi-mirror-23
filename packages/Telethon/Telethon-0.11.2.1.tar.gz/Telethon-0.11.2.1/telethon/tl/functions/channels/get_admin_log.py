...
class GetAdminLogRequest(MTProtoRequest):
    ...
    def on_send(self, writer):
        ...
        if self.admins:
            ...
            for admins_item in self.admins:
                if admins_item:
                    admins_item.on_send(writer)
    ...
    def __str__(self):
        return '(channels.getAdminLog (ID: 0x33ddf480) = (channel={}, q={}, events_filter={}, admins={}, max_id={}, min_id={}, limit={}))'.format(str(self.channel), str(self.q), str(self.events_filter), None if not self.admins else [str(_) for _ in self.admins], str(self.max_id), str(self.min_id), str(self.limit))
