...
class Channel(MTProtoRequest):
    ...
    def __init__(self, id, title, photo, date, version, creator=None, left=None, broadcast=None, verified=None, megagroup=None, restricted=None, democracy=None, signatures=None, min=None, access_hash=None, username=None, restriction_reason=None, admin_rights=None, banned_rights=None):
        """
    ...
    def empty():
        ...
        return Channel(None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None)
    ...
    def __str__(self):
        return '(channel (ID: 0xcb44b1c) = (creator={}, left={}, broadcast={}, verified={}, megagroup={}, restricted={}, democracy={}, signatures={}, min={}, id={}, access_hash={}, title={}, username={}, photo={}, date={}, version={}, restriction_reason={}, admin_rights={}, banned_rights={}))'.format(str(self.creator), str(self.left), str(self.broadcast), str(self.verified), str(self.megagroup), str(self.restricted), str(self.democracy), str(self.signatures), str(self.min), str(self.id), str(self.access_hash), str(self.title), str(self.username), str(self.photo), str(self.date), str(self.version), str(self.restriction_reason), str(self.admin_rights), str(self.banned_rights))
