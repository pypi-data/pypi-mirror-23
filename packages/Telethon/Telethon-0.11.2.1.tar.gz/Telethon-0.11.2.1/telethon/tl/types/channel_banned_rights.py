...
class ChannelBannedRights(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelBannedRights (ID: 0x58cf4249) = (view_messages={}, send_messages={}, send_media={}, send_stickers={}, send_gifs={}, send_games={}, send_inline={}, embed_links={}, until_date={}))'.format(str(self.view_messages), str(self.send_messages), str(self.send_media), str(self.send_stickers), str(self.send_gifs), str(self.send_games), str(self.send_inline), str(self.embed_links), str(self.until_date))
