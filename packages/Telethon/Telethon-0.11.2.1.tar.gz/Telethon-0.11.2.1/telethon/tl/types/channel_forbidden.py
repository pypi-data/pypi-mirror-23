...
class ChannelForbidden(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelForbidden (ID: 0x289da732) = (broadcast={}, megagroup={}, id={}, access_hash={}, title={}, until_date={}))'.format(str(self.broadcast), str(self.megagroup), str(self.id), str(self.access_hash), str(self.title), str(self.until_date))
