...
class ChannelParticipantAdmin(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelParticipantAdmin (ID: 0xa82fa898) = (can_edit={}, user_id={}, inviter_id={}, promoted_by={}, date={}, admin_rights={}))'.format(str(self.can_edit), str(self.user_id), str(self.inviter_id), str(self.promoted_by), str(self.date), str(self.admin_rights))
