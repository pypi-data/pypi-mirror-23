...
class InitConnectionRequest(MTProtoRequest):
    ...
    def __str__(self):
        return '(initConnection (ID: 0xc7481da6) = (api_id={}, device_model={}, system_version={}, app_version={}, system_lang_code={}, lang_pack={}, lang_code={}, query={}))'.format(str(self.api_id), str(self.device_model), str(self.system_version), str(self.app_version), str(self.system_lang_code), str(self.lang_pack), str(self.lang_code), str(self.query))
