...
class ChannelAdminLogEvent(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEvent (ID: 0x3b5a3e40) = (id={}, date={}, user_id={}, action={}))'.format(str(self.id), str(self.date), str(self.user_id), str(self.action))
