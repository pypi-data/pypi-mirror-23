...
class ChannelAdminLogEventsFilter(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventsFilter (ID: 0xea107ae4) = (join={}, leave={}, invite={}, ban={}, unban={}, kick={}, unkick={}, promote={}, demote={}, info={}, settings={}, pinned={}, edit={}, delete={}))'.format(str(self.join), str(self.leave), str(self.invite), str(self.ban), str(self.unban), str(self.kick), str(self.unkick), str(self.promote), str(self.demote), str(self.info), str(self.settings), str(self.pinned), str(self.edit), str(self.delete))
