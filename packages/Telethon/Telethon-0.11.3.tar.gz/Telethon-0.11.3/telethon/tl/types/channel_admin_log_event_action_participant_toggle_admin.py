...
class ChannelAdminLogEventActionParticipantToggleAdmin(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionParticipantToggleAdmin (ID: 0xd5676710) = (prev_participant={}, new_participant={}))'.format(str(self.prev_participant), str(self.new_participant))
