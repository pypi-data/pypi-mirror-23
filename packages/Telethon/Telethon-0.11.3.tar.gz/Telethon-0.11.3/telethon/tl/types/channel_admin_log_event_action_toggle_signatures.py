...
class ChannelAdminLogEventActionToggleSignatures(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionToggleSignatures (ID: 0x26ae0971) = (new_value={}))'.format(str(self.new_value))
