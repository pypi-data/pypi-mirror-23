...
class ChannelAdminLogEventActionParticipantInvite(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionParticipantInvite (ID: 0xe31c34d8) = (participant={}))'.format(str(self.participant))
