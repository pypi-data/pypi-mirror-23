...
class StickersTg(MTProtoRequest):
    ...
    def __str__(self):
        return '(messages.stickers_tg (ID: 0x8a8ecd32) = (hash={}, stickers={}))'.format(str(self.hash), None if not self.stickers else [str(_) for _ in self.stickers])
