...
class ChannelParticipantBanned(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelParticipantBanned (ID: 0x222c1886) = (left={}, user_id={}, kicked_by={}, date={}, banned_rights={}))'.format(str(self.left), str(self.user_id), str(self.kicked_by), str(self.date), str(self.banned_rights))
