...
class ChannelAdminRights(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminRights (ID: 0x5d7ceba5) = (change_info={}, post_messages={}, edit_messages={}, delete_messages={}, ban_users={}, invite_users={}, invite_link={}, pin_messages={}, add_admins={}))'.format(str(self.change_info), str(self.post_messages), str(self.edit_messages), str(self.delete_messages), str(self.ban_users), str(self.invite_users), str(self.invite_link), str(self.pin_messages), str(self.add_admins))
