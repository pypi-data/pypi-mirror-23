...
class ChannelAdminLogEventActionChangeUsername(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionChangeUsername (ID: 0x6a4afc38) = (prev_value={}, new_value={}))'.format(str(self.prev_value), str(self.new_value))
