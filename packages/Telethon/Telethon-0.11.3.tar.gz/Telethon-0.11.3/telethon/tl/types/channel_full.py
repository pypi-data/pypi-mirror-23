...
class ChannelFull(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelFull (ID: 0x95cb5f57) = (can_view_participants={}, can_set_username={}, id={}, about={}, participants_count={}, admins_count={}, kicked_count={}, banned_count={}, read_inbox_max_id={}, read_outbox_max_id={}, unread_count={}, chat_photo={}, notify_settings={}, exported_invite={}, bot_info={}, migrated_from_chat_id={}, migrated_from_max_id={}, pinned_msg_id={}))'.format(str(self.can_view_participants), str(self.can_set_username), str(self.id), str(self.about), str(self.participants_count), str(self.admins_count), str(self.kicked_count), str(self.banned_count), str(self.read_inbox_max_id), str(self.read_outbox_max_id), str(self.unread_count), str(self.chat_photo), str(self.notify_settings), str(self.exported_invite), None if not self.bot_info else [str(_) for _ in self.bot_info], str(self.migrated_from_chat_id), str(self.migrated_from_max_id), str(self.pinned_msg_id))
