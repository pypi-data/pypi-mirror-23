...
class ChannelAdminLogEventActionChangeTitle(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionChangeTitle (ID: 0xe6dfb825) = (prev_value={}, new_value={}))'.format(str(self.prev_value), str(self.new_value))
