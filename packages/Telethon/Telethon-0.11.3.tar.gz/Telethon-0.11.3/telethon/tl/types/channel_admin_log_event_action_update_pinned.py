...
class ChannelAdminLogEventActionUpdatePinned(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionUpdatePinned (ID: 0xe9e82c18) = (message={}))'.format(str(self.message))
