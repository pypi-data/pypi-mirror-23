...
class ChannelAdminLogEventActionEditMessage(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionEditMessage (ID: 0x709b2405) = (prev_message={}, new_message={}))'.format(str(self.prev_message), str(self.new_message))
