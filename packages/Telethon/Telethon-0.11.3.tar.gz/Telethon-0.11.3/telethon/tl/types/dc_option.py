...
class DcOption(MTProtoRequest):
    ...
    def __str__(self):
        return '(dcOption (ID: 0x5d8c6cc) = (ipv6={}, media_only={}, tcpo_only={}, cdn={}, static={}, id={}, ip_address={}, port={}))'.format(str(self.ipv6), str(self.media_only), str(self.tcpo_only), str(self.cdn), str(self.static), str(self.id), str(self.ip_address), str(self.port))
