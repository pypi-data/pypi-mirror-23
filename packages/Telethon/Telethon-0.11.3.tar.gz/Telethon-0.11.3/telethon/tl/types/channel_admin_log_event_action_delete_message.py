...
class ChannelAdminLogEventActionDeleteMessage(MTProtoRequest):
    ...
    def __str__(self):
        return '(channelAdminLogEventActionDeleteMessage (ID: 0x42e047bb) = (message={}))'.format(str(self.message))
