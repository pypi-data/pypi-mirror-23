...
class LangPackStringPluralized(MTProtoRequest):
    ...
    def __str__(self):
        return '(langPackStringPluralized (ID: 0x6c47ac9f) = (key={}, zero_value={}, one_value={}, two_value={}, few_value={}, many_value={}, other_value={}))'.format(str(self.key), str(self.zero_value), str(self.one_value), str(self.two_value), str(self.few_value), str(self.many_value), str(self.other_value))
