...
from sqrekubespawner.objects import make_pod, make_pvc
...
class SQREKubeSpawner(Spawner):
    ...
    def get_env(self):
        ...
        if gh_id and gh_token:
            ...
            if "email" in acu and acu["email"] is None:
                del acu["email"]  # SQLAlchemy serialization.
            if "email" in acu:
                gh_email = acu["email"]
                if gh_email:
                    env.update({
