...
from helpers.security_helpers import generate_unique_key
import copy
 
class BasicProfileRunAPI(BaseAPI):
 
    def __init__(self, **kwargs):
        kwargs['run'] = False
         
        self.model_name = 'BasicProfileRun'
        super(BasicProfileRunAPI, self).__init__(**kwargs)
