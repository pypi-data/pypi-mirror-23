...
def harmonic_time_independent(x, n, l):
    """ 1D time-independent component of the wave solution for the harmonic oscillator.

    Will return the time-independent solution to the wave equation for the the 
    harmonic oscillator evaluted on the spatial grid x acoording to the parameters.
...
def harmonic_time_dependent(t, c, n, l):
    """ 1D time-dependent component of the wave solution for the harmonic oscillator.

    Will return the time-dependent solution to the wave equation for the the 
    harmonic oscillator evaluted on the spatial grid x acoording to the parameters.
