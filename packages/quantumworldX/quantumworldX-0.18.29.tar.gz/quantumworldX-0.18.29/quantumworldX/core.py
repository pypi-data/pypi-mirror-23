...
def excited_overlap(t, omega_f, omega_0=1, lam=1, E_0=1.0, m=1, hbar=1):
    """ Calculates the coefficient of excited state overlap between a HO and a external field.
    ...
    Args:
        t (:obj:`np.array`): 1-D array representing a temporal grid of length `n`.
        omega_f (float): The frequency of the incoming field.

        omega_0 (float): The frequency of harmonic oscillator, default to 1.
        lam (float): The value of the pertubation variable, default to 1.
        E_0 (float): Initial energy of the HO. Defaults to 0.1.
        m (float): Mass of the Oscillator. Defaults to 1 (atomic units).
        h_bar (float): Value of plank's constant. Defaults to 1 (atomic units).

    Returns:
        Will the coefficient (float) of overlap. The probability is the square of thsi value.
