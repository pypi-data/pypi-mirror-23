...
# -------------------------------------------------------------------------
"""
Commands provided by Parsim tool.

Each available command corresponds to a function in this module.
"""
import parsim
...
def study(argv):
    ...
    description += _study_case_common_description
    description += ' ' + dedent(''' When a case study is created, case-specific values for the parameters are
        given in a CASELIST_FILE. Values in the caselist override values given on the command line.''')
    common_parent = _get_study_case_parent_argparser()
...
def doe(argv):
    ...
    # Process DOE arguemnts (into dict)
    doe_args = {}
    try:
