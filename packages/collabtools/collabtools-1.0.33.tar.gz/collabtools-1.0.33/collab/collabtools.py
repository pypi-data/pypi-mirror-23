...
_DOCKER_EXAMPLE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'fibonacci')
_truth = None
def _get_truth():
    """
...
def generate_example_program(args):
    if os.path.exists(args.folder):
        raise ValueError("the specified path already exists: %s" % args.folder)
    shutil.copytree(_DOCKER_EXAMPLE_PATH, args.folder)
