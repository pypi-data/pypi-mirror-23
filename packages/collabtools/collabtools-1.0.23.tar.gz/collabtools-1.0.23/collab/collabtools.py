...
subparser.add_argument('-p', '--path', required=True, help="the path to the folder in which the example program will be generated.")
...
subparser = subparsers.add_parser('upload-program')
subparser.add_argument('-p', '--path', required=True, help="the path to the folder that should be uploaded.")
