...
class AipFace(AipBase):
    ...
    __detectUrl = 'http://127.0.0.1:8080/rest/2.0/face/v1/detect'

    __matchUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/match'

    __addUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/user/add'

    __updateUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/user/update'

    __deleteUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/user/delete'

    __verifyUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/verify'

    __identifyUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/identify'

    __getUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/user/get'

    __getGroupListUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/group/getlist'

    __getGroupUsersUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/group/getusers'

    __addGroupUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/group/adduser'

    __deleteGroupUserUrl = 'http://127.0.0.1:8080/rest/2.0/face/v2/faceset/group/deleteuser'
