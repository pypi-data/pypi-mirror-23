...
from .languages import GPAY_LANGUAGES
...
GPAY_DEFAULT_LANGUAGE = GPAY_LANGUAGES['Italian']
...
class GestPAY(object):
    ...
    def card_transaction(self, amount, transaction_id, card_number, exp_month, exp_year, currency=GPAY_DEFAULT_CURRENCY, **kwargs):
    ...
    def token_transaction(self, amount, transaction_id, token, currency=GPAY_DEFAULT_CURRENCY, **kwargs):
        data = self._prepare_request()
        data['amount'] = amount
        data['shopTransactionId'] = transaction_id
