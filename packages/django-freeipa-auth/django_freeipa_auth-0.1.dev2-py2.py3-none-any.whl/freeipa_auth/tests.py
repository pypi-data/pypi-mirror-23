...
class TestFreeIpaBackendAuth(object):
    ...
    def test_login(self, patch_authenticate_success):
    ...
    def test_update_user_groups(self, test_group, test_permission, settings,
                                patch_authenticate_success,
                                patch_remote_user_groups):
    ...
    def test_update_user_attrs(self, monkeypatch, settings,
        ...
        # Set user attrs map in settings
    ...
    def test_authorize_all_users(self, settings, monkeypatch, patch_authenticate_success):
        """
        ...
        # Assert that user is staff with FREEIPA_AUTH_AUTHORIZE_ALL_USERS set to True
        assert user.is_staff
