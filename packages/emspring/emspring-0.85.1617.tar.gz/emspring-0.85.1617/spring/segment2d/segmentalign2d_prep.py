...
#            self.set_hidden_parameters()
    ...
    def define_flow_of_alignment(self, pixelsize, binfactor, iteration_count, x_range_A, y_range_A):
        ...
        [align_info(iteration_id=0, pixelsize=8.4000000000000004, binfactor=7, x_range=5.9523809523809526, y_range=5.9523809523809526), 
        align_info(iteration_id=1, pixelsize=8.4000000000000004, binfactor=7, x_range=5.9523809523809526, y_range=5.9523809523809526), 
        ...
        align_info(iteration_id=0, pixelsize=2.3999999999999999, binfactor=2, x_range=5.9523809523809526, y_range=5.9523809523809526), 
        align_info(iteration_id=1, pixelsize=2.3999999999999999, binfactor=2, x_range=5.9523809523809526, y_range=5.9523809523809526)]
