...
@parametrize(
    PhysicalQuantity(
        ...
        info='The total ionization cross section is used to determine how many particles per beam '
             'should be created. The resulting number of particles is proportional to the total '
             'ionization cross section. The default value is unphysical and just serves as a '
             'convenience if only one beam is specified. If you specify the total ionization '
             'cross section for one beam make sure you also specify it for all other beams. '
             'Please note that only ratios between different total ionization cross sections are '
             'deciding not their absolute values.'
    ),
