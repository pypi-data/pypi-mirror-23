...
class RADLocus:
    ...
    def __init__(self, individuals, protoread_p7, locus_name, args):
        ...
        for (barcode_p5, _), (spacer_p5, _, individual_name, *_) in individuals:
        ...
        all_spacer_lengths = [len(spacer_p5) for _, (spacer_p5, *_) in individuals]
        max_p5_spacer_length = max(all_spacer_lengths)
        p5_length_variability = max_p5_spacer_length - min(all_spacer_lengths)
