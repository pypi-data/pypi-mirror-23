...
class SingletonGenerator:
    ...
    def reads(self):
        ...
        for i in range(self.nr_singletons):
            ...
            rad_read = RADRead.from_p7_protoread(barcode_p5, spacer_p5, individual_name, self.p5_overhang, self.p5_rec_site, sequence_p5_truncated, protoread_p7, self.gc_content, self.read_length, meta_info)
