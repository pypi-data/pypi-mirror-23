...
class BehaviorScoreData(object):
  ...
  def __init__(self, behaviorScore=0.0, totalScore=0.0, behaviorID=Anki.Cozmo.BehaviorID.NoneBehavior):
...
class NewBehaviorSelected(object):
  ...
  def __init__(self, newCurrentBehavior=Anki.Cozmo.BehaviorID.NoneBehavior):
...
class MessageViz(object):
  ...
  class Tag(object):
    ...
    NewReactionTriggered          = 42 # Anki.Cozmo.VizInterface.NewReactionTriggered
    StartRobotUpdate              = 43 # Anki.Cozmo.VizInterface.StartRobotUpdate
    EndRobotUpdate                = 44 # Anki.Cozmo.VizInterface.EndRobotUpdate
    SaveImages                    = 45 # Anki.Cozmo.VizInterface.SaveImages
    SaveState                     = 46 # Anki.Cozmo.VizInterface.SaveState
    ObjectConnectionState         = 47 # Anki.Cozmo.VizInterface.ObjectConnectionState
    ObjectMovingState             = 48 # Anki.Cozmo.VizInterface.ObjectMovingState
    ObjectUpAxisState             = 49 # Anki.Cozmo.VizInterface.ObjectUpAxisState
    ObjectAccelState              = 50 # Anki.Cozmo.VizInterface.ObjectAccelState
  ...
  _tags_by_name = dict(
    ...
    NewReactionTriggered=42,
    StartRobotUpdate=43,
    EndRobotUpdate=44,
    SaveImages=45,
    SaveState=46,
    ObjectConnectionState=47,
    ObjectMovingState=48,
    ObjectUpAxisState=49,
    ObjectAccelState=50,
  )
  ...
  _tags_by_value[42] = 'NewReactionTriggered'
  _tags_by_value[43] = 'StartRobotUpdate'
  _tags_by_value[44] = 'EndRobotUpdate'
  _tags_by_value[45] = 'SaveImages'
  _tags_by_value[46] = 'SaveState'
  _tags_by_value[47] = 'ObjectConnectionState'
  _tags_by_value[48] = 'ObjectMovingState'
  _tags_by_value[49] = 'ObjectUpAxisState'
  _tags_by_value[50] = 'ObjectAccelState'
  ...
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.NewReactionTriggered.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.StartRobotUpdate.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EndRobotUpdate.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveImages.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveState.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectConnectionState.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectMovingState.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectUpAxisState.unpack_from)
  _tag_unpack_methods[50] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectAccelState.unpack_from)
  ...
  _type_by_tag_value[42] = lambda : Anki.Cozmo.VizInterface.NewReactionTriggered
  _type_by_tag_value[43] = lambda : Anki.Cozmo.VizInterface.StartRobotUpdate
  _type_by_tag_value[44] = lambda : Anki.Cozmo.VizInterface.EndRobotUpdate
  _type_by_tag_value[45] = lambda : Anki.Cozmo.VizInterface.SaveImages
  _type_by_tag_value[46] = lambda : Anki.Cozmo.VizInterface.SaveState
  _type_by_tag_value[47] = lambda : Anki.Cozmo.VizInterface.ObjectConnectionState
  _type_by_tag_value[48] = lambda : Anki.Cozmo.VizInterface.ObjectMovingState
  _type_by_tag_value[49] = lambda : Anki.Cozmo.VizInterface.ObjectUpAxisState
  _type_by_tag_value[50] = lambda : Anki.Cozmo.VizInterface.ObjectAccelState
