...
Full command line: ../tools/message-buffers/emitters/Python_emitter.py -C ./src/ -I ../robot/clad/src/ ../coretech/vision/clad/src/ ../coretech/common/clad/src/ -o ../generated/cladPython// clad/types/voiceCommandTypes.clad
"""
...
class CommandHeardEvent(object):
  ...
  def voiceCommandType(self, value):
    self._voiceCommandType = msgbuffers.validate_integer(
      'CommandHeardEvent.voiceCommandType', value, 0, 255)

  def __init__(self, voiceCommandType=Anki.Cozmo.VoiceCommand.VoiceCommandType.HeyCozmo):
    self.voiceCommandType = voiceCommandType

  @classmethod
  def unpack(cls, buffer):
    "Reads a new CommandHeardEvent from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('CommandHeardEvent.unpack received a buffer of length {length}, ' +
  ...
  def unpack_from(cls, reader):
    "Reads a new CommandHeardEvent from the given BinaryReader."
    _voiceCommandType = reader.read('B')
    return cls(_voiceCommandType)

  def pack(self):
    "Writes the current CommandHeardEvent, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current CommandHeardEvent to the given BinaryWriter."
...
Anki.Cozmo.VoiceCommand.CommandHeardEvent = CommandHeardEvent
del CommandHeardEvent
