...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    VoiceCommandEvent               = 0x24 # Anki.Cozmo.VoiceCommand.VoiceCommandEvent
    UiDeviceAvailable               = 0x25 # Anki.Cozmo.ExternalInterface.UiDeviceAvailable
    RobotConnectionResponse         = 0x26 # Anki.Cozmo.ExternalInterface.RobotConnectionResponse
    RobotDisconnected               = 0x27 # Anki.Cozmo.ExternalInterface.RobotDisconnected
    EngineRobotCLADVersionMismatch  = 0x28 # Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch
    ...
    RobotHiccupsChanged             = 0x36 # Anki.Cozmo.ExternalInterface.RobotHiccupsChanged
    ChargerEvent                    = 0x37 # Anki.Cozmo.ExternalInterface.ChargerEvent
    UnexpectedMovement              = 0x38 # Anki.Cozmo.ExternalInterface.UnexpectedMovement
    RestoreRobotStatus              = 0x39 # Anki.Cozmo.ExternalInterface.RestoreRobotStatus
    RestoreRobotOptions             = 0x3a # Anki.Cozmo.ExternalInterface.RestoreRobotOptions
    DebugString                     = 0x3b # Anki.Cozmo.ExternalInterface.DebugString
    DebugAnimationString            = 0x3c # Anki.Cozmo.ExternalInterface.DebugAnimationString
    RobotProcessedImage             = 0x3d # Anki.Cozmo.ExternalInterface.RobotProcessedImage
    RobotObservedObject             = 0x3e # Anki.Cozmo.ExternalInterface.RobotObservedObject
    RobotObservedPossibleObject     = 0x3f # Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
    ...
    RobotObservedLaserPoint         = 0x44 # Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint
    RobotDeletedFace                = 0x45 # Anki.Cozmo.ExternalInterface.RobotDeletedFace
    RobotDeletedLocatedObject       = 0x46 # Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
    RobotDeletedAllCustomObjects    = 0x47 # Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
    RobotDeletedFixedCustomObjects  = 0x48 # Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
    RobotDeletedCustomMarkerObjects = 0x49 # Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
    CreatedFixedCustomObject        = 0x4a # Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
    DefinedCustomObject             = 0x4b # Anki.Cozmo.ExternalInterface.DefinedCustomObject
    RobotMarkedObjectPoseUnknown    = 0x4c # Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
    LocatedObjectStates             = 0x4d # Anki.Cozmo.ExternalInterface.LocatedObjectStates
    ConnectedObjectStates           = 0x4e # Anki.Cozmo.ExternalInterface.ConnectedObjectStates
    RobotReadToolCode               = 0x4f # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted         = 0x50 # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace         = 0x51 # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces     = 0x52 # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest    = 0x53 # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction            = 0x54 # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                   = 0x55 # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                     = 0x56 # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable              = 0x57 # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable         = 0x58 # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted                = 0x59 # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                  = 0x5a # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                       = 0x5b # Anki.Cozmo.ExternalInterface.MoodState
    NeedsState                      = 0x5c # Anki.Cozmo.ExternalInterface.NeedsState
    NeedsPauseState                 = 0x5d # Anki.Cozmo.ExternalInterface.NeedsPauseState
    NeedsPauseStates                = 0x5e # Anki.Cozmo.ExternalInterface.NeedsPauseStates
    StarLevelCompleted              = 0x5f # Anki.Cozmo.ExternalInterface.StarLevelCompleted
    StarUnlocked                    = 0x60 # Anki.Cozmo.ExternalInterface.StarUnlocked
    RequestSetUnlockResult          = 0x61 # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                    = 0x62 # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults                = 0x63 # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InitDebugConsoleVarMessage      = 0x64 # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage               = 0x65 # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage        = 0x66 # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage   = 0x67 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage    = 0x68 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine       = 0x69 # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                  = 0x6a # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage               = 0x6b # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus            = 0x6c # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState               = 0x6d # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage          = 0x6e # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition       = 0x6f # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage            = 0x70 # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult               = 0x71 # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress          = 0x72 # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete          = 0x73 # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart                = 0x74 # Anki.Cozmo.ExternalInterface.RequestGameStart
    HardSparkEndedByEngine          = 0x75 # Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
    SdkConnectionStatus             = 0x76 # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                       = 0x77 # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition              = 0x78 # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionTriggerTransition       = 0x79 # Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
    RespondAllBehaviorsList         = 0x7a # Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList
    RespondReactionTriggerMap       = 0x7b # Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap
    BehaviorObjectiveAchieved       = 0x7c # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    BuildPyramidPreReqsChanged      = 0x7d # Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
    GuardDogStart                   = 0x7e # Anki.Cozmo.ExternalInterface.GuardDogStart
    GuardDogEnd                     = 0x7f # Anki.Cozmo.ExternalInterface.GuardDogEnd
    OnboardingState                 = 0x80 # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin           = 0x81 # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage                = 0x82 # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd             = 0x83 # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                     = 0x84 # Anki.Cozmo.ExternalInterface.SupportInfo
    EndOfMessage                    = 0x85 # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  def VoiceCommandEvent(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.VoiceCommandEvent', value, Anki.Cozmo.VoiceCommand.VoiceCommandEvent)
  ...
  _tags_by_name = dict(
    ...
    SetBodyRadioMode=34,
    AnimationState=35,
    VoiceCommandEvent=36,
    UiDeviceAvailable=37,
    RobotConnectionResponse=38,
    RobotDisconnected=39,
    EngineRobotCLADVersionMismatch=40,
    ...
    RobotHiccupsChanged=54,
    ChargerEvent=55,
    UnexpectedMovement=56,
    RestoreRobotStatus=57,
    RestoreRobotOptions=58,
    DebugString=59,
    DebugAnimationString=60,
    RobotProcessedImage=61,
    RobotObservedObject=62,
    RobotObservedPossibleObject=63,
    RobotObservedFace=64,
    RobotChangedObservedFaceID=65,
    RobotObservedPet=66,
    RobotObservedMotion=67,
    RobotObservedLaserPoint=68,
    RobotDeletedFace=69,
    RobotDeletedLocatedObject=70,
    RobotDeletedAllCustomObjects=71,
    RobotDeletedFixedCustomObjects=72,
    RobotDeletedCustomMarkerObjects=73,
    CreatedFixedCustomObject=74,
    DefinedCustomObject=75,
    RobotMarkedObjectPoseUnknown=76,
    LocatedObjectStates=77,
    ConnectedObjectStates=78,
    RobotReadToolCode=79,
    FaceEnrollmentCompleted=80,
    RobotErasedEnrolledFace=81,
    RobotErasedAllEnrolledFaces=82,
    RobotCompletedFactoryDotTest=83,
    RobotCompletedAction=84,
    BlockPickedUp=85,
    BlockPlaced=86,
    AnimationAvailable=87,
    AnimationGroupAvailable=88,
    AnimationAborted=89,
    AnimationEvent=90,
    MoodState=91,
    NeedsState=92,
    NeedsPauseState=93,
    NeedsPauseStates=94,
    StarLevelCompleted=95,
    StarUnlocked=96,
    RequestSetUnlockResult=97,
    UnlockStatus=98,
    UnlockedDefaults=99,
    InitDebugConsoleVarMessage=100,
    JsonDasLogMessage=101,
    JsonDasLogAllSentMessage=102,
    VerifyDebugConsoleFuncMessage=103,
    VerifyDebugConsoleVarMessage=104,
    DebugAppendConsoleLogLine=105,
    LatencyMessage=106,
    DeviceDataMessage=107,
    BlockTapFilterStatus=108,
    UpdateEngineState=109,
    EngineErrorCodeMessage=110,
    CubeLightsStateTransition=111,
    BlockPoolDataMessage=112,
    NVStorageOpResult=113,
    FirmwareUpdateProgress=114,
    FirmwareUpdateComplete=115,
    RequestGameStart=116,
    HardSparkEndedByEngine=117,
    SdkConnectionStatus=118,
    SdkStatus=119,
    BehaviorTransition=120,
    ReactionTriggerTransition=121,
    RespondAllBehaviorsList=122,
    RespondReactionTriggerMap=123,
    BehaviorObjectiveAchieved=124,
    BuildPyramidPreReqsChanged=125,
    GuardDogStart=126,
    GuardDogEnd=127,
    OnboardingState=128,
    MemoryMapMessageBegin=129,
    MemoryMapMessage=130,
    MemoryMapMessageEnd=131,
    SupportInfo=132,
    EndOfMessage=133,
  )
  ...
  _tags_by_value[36] = 'VoiceCommandEvent'
  _tags_by_value[37] = 'UiDeviceAvailable'
  _tags_by_value[38] = 'RobotConnectionResponse'
  _tags_by_value[39] = 'RobotDisconnected'
  _tags_by_value[40] = 'EngineRobotCLADVersionMismatch'
  ...
  _tags_by_value[54] = 'RobotHiccupsChanged'
  _tags_by_value[55] = 'ChargerEvent'
  _tags_by_value[56] = 'UnexpectedMovement'
  _tags_by_value[57] = 'RestoreRobotStatus'
  _tags_by_value[58] = 'RestoreRobotOptions'
  _tags_by_value[59] = 'DebugString'
  _tags_by_value[60] = 'DebugAnimationString'
  _tags_by_value[61] = 'RobotProcessedImage'
  _tags_by_value[62] = 'RobotObservedObject'
  _tags_by_value[63] = 'RobotObservedPossibleObject'
  ...
  _tags_by_value[68] = 'RobotObservedLaserPoint'
  _tags_by_value[69] = 'RobotDeletedFace'
  _tags_by_value[70] = 'RobotDeletedLocatedObject'
  _tags_by_value[71] = 'RobotDeletedAllCustomObjects'
  _tags_by_value[72] = 'RobotDeletedFixedCustomObjects'
  _tags_by_value[73] = 'RobotDeletedCustomMarkerObjects'
  _tags_by_value[74] = 'CreatedFixedCustomObject'
  _tags_by_value[75] = 'DefinedCustomObject'
  _tags_by_value[76] = 'RobotMarkedObjectPoseUnknown'
  _tags_by_value[77] = 'LocatedObjectStates'
  _tags_by_value[78] = 'ConnectedObjectStates'
  _tags_by_value[79] = 'RobotReadToolCode'
  _tags_by_value[80] = 'FaceEnrollmentCompleted'
  _tags_by_value[81] = 'RobotErasedEnrolledFace'
  _tags_by_value[82] = 'RobotErasedAllEnrolledFaces'
  _tags_by_value[83] = 'RobotCompletedFactoryDotTest'
  _tags_by_value[84] = 'RobotCompletedAction'
  _tags_by_value[85] = 'BlockPickedUp'
  _tags_by_value[86] = 'BlockPlaced'
  _tags_by_value[87] = 'AnimationAvailable'
  _tags_by_value[88] = 'AnimationGroupAvailable'
  _tags_by_value[89] = 'AnimationAborted'
  _tags_by_value[90] = 'AnimationEvent'
  _tags_by_value[91] = 'MoodState'
  _tags_by_value[92] = 'NeedsState'
  _tags_by_value[93] = 'NeedsPauseState'
  _tags_by_value[94] = 'NeedsPauseStates'
  _tags_by_value[95] = 'StarLevelCompleted'
  _tags_by_value[96] = 'StarUnlocked'
  _tags_by_value[97] = 'RequestSetUnlockResult'
  _tags_by_value[98] = 'UnlockStatus'
  _tags_by_value[99] = 'UnlockedDefaults'
  _tags_by_value[100] = 'InitDebugConsoleVarMessage'
  _tags_by_value[101] = 'JsonDasLogMessage'
  _tags_by_value[102] = 'JsonDasLogAllSentMessage'
  _tags_by_value[103] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[104] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[105] = 'DebugAppendConsoleLogLine'
  _tags_by_value[106] = 'LatencyMessage'
  _tags_by_value[107] = 'DeviceDataMessage'
  _tags_by_value[108] = 'BlockTapFilterStatus'
  _tags_by_value[109] = 'UpdateEngineState'
  _tags_by_value[110] = 'EngineErrorCodeMessage'
  _tags_by_value[111] = 'CubeLightsStateTransition'
  _tags_by_value[112] = 'BlockPoolDataMessage'
  _tags_by_value[113] = 'NVStorageOpResult'
  _tags_by_value[114] = 'FirmwareUpdateProgress'
  _tags_by_value[115] = 'FirmwareUpdateComplete'
  _tags_by_value[116] = 'RequestGameStart'
  _tags_by_value[117] = 'HardSparkEndedByEngine'
  _tags_by_value[118] = 'SdkConnectionStatus'
  _tags_by_value[119] = 'SdkStatus'
  _tags_by_value[120] = 'BehaviorTransition'
  _tags_by_value[121] = 'ReactionTriggerTransition'
  _tags_by_value[122] = 'RespondAllBehaviorsList'
  _tags_by_value[123] = 'RespondReactionTriggerMap'
  _tags_by_value[124] = 'BehaviorObjectiveAchieved'
  _tags_by_value[125] = 'BuildPyramidPreReqsChanged'
  _tags_by_value[126] = 'GuardDogStart'
  _tags_by_value[127] = 'GuardDogEnd'
  _tags_by_value[128] = 'OnboardingState'
  _tags_by_value[129] = 'MemoryMapMessageBegin'
  _tags_by_value[130] = 'MemoryMapMessage'
  _tags_by_value[131] = 'MemoryMapMessageEnd'
  _tags_by_value[132] = 'SupportInfo'
  _tags_by_value[133] = 'EndOfMessage'
  ...
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.VoiceCommand.VoiceCommandEvent.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UiDeviceAvailable.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotConnectionResponse.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDisconnected.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch.unpack_from)
  ...
  _tag_unpack_methods[54] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotHiccupsChanged.unpack_from)
  _tag_unpack_methods[55] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ChargerEvent.unpack_from)
  _tag_unpack_methods[56] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnexpectedMovement.unpack_from)
  _tag_unpack_methods[57] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotStatus.unpack_from)
  _tag_unpack_methods[58] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotOptions.unpack_from)
  _tag_unpack_methods[59] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugString.unpack_from)
  _tag_unpack_methods[60] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAnimationString.unpack_from)
  _tag_unpack_methods[61] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotProcessedImage.unpack_from)
  _tag_unpack_methods[62] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedObject.unpack_from)
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject.unpack_from)
  ...
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFace.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject.unpack_from)
  ...
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefinedCustomObject.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LocatedObjectStates.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectedObjectStates.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsState.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseState.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseStates.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarLevelCompleted.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarUnlocked.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionTriggerTransition.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GuardDogStart.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GuardDogEnd.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[36] = lambda : Anki.Cozmo.VoiceCommand.VoiceCommandEvent
  _type_by_tag_value[37] = lambda : Anki.Cozmo.ExternalInterface.UiDeviceAvailable
  _type_by_tag_value[38] = lambda : Anki.Cozmo.ExternalInterface.RobotConnectionResponse
  _type_by_tag_value[39] = lambda : Anki.Cozmo.ExternalInterface.RobotDisconnected
  _type_by_tag_value[40] = lambda : Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch
  ...
  _type_by_tag_value[54] = lambda : Anki.Cozmo.ExternalInterface.RobotHiccupsChanged
  _type_by_tag_value[55] = lambda : Anki.Cozmo.ExternalInterface.ChargerEvent
  _type_by_tag_value[56] = lambda : Anki.Cozmo.ExternalInterface.UnexpectedMovement
  _type_by_tag_value[57] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotStatus
  _type_by_tag_value[58] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotOptions
  _type_by_tag_value[59] = lambda : Anki.Cozmo.ExternalInterface.DebugString
  _type_by_tag_value[60] = lambda : Anki.Cozmo.ExternalInterface.DebugAnimationString
  _type_by_tag_value[61] = lambda : Anki.Cozmo.ExternalInterface.RobotProcessedImage
  _type_by_tag_value[62] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedObject
  _type_by_tag_value[63] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
  ...
  _type_by_tag_value[68] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFace
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.DefinedCustomObject
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.LocatedObjectStates
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.ConnectedObjectStates
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.NeedsState
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseState
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseStates
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.StarLevelCompleted
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.StarUnlocked
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.GuardDogStart
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.GuardDogEnd
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage
