...
from clad.types.voiceCommandTypes import Anki as _Anki
Anki.update(_Anki.deep_clone())
...
class ActivateHighLevelActivity(object):
  ...
  def __init__(self, activityType=Anki.Cozmo.HighLevelActivity.Freeplay):
...
class ExecuteBehaviorByExecutableType(object):
  ...
  def __init__(self, behaviorType=Anki.Cozmo.ExecutableBehaviorType.NoneBehavior, numRuns=-1):
...
class ExecuteBehaviorByID(object):
  ...
  def __init__(self, behaviorID=Anki.Cozmo.BehaviorID.NoneBehavior, numRuns=-1):
...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    TrackToLaserPoint                       = 0x27 # Anki.Cozmo.ExternalInterface.TrackToLaserPoint
    TrackToPet                              = 0x28 # Anki.Cozmo.ExternalInterface.TrackToPet
    TraverseObject                          = 0x29 # Anki.Cozmo.ExternalInterface.TraverseObject
    TurnInPlace                             = 0x2a # Anki.Cozmo.ExternalInterface.TurnInPlace
    TurnInPlaceAtSpeed                      = 0x2b # Anki.Cozmo.ExternalInterface.TurnInPlaceAtSpeed
    TurnTowardsFace                         = 0x2c # Anki.Cozmo.ExternalInterface.TurnTowardsFace
    TurnTowardsImagePoint                   = 0x2d # Anki.Cozmo.ExternalInterface.TurnTowardsImagePoint
    TurnTowardsLastFacePose                 = 0x2e # Anki.Cozmo.ExternalInterface.TurnTowardsLastFacePose
    TurnTowardsObject                       = 0x2f # Anki.Cozmo.ExternalInterface.TurnTowardsObject
    TurnTowardsPose                         = 0x30 # Anki.Cozmo.ExternalInterface.TurnTowardsPose
    VisuallyVerifyFace                      = 0x31 # Anki.Cozmo.ExternalInterface.VisuallyVerifyFace
    VisuallyVerifyObject                    = 0x32 # Anki.Cozmo.ExternalInterface.VisuallyVerifyObject
    VisuallyVerifyNoObjectAtPose            = 0x33 # Anki.Cozmo.ExternalInterface.VisuallyVerifyNoObjectAtPose
    Wait                                    = 0x34 # Anki.Cozmo.ExternalInterface.Wait
    WaitForImages                           = 0x35 # Anki.Cozmo.ExternalInterface.WaitForImages
    AdvertisementRegistrationMsg            = 0x36 # Anki.Cozmo.AdvertisementRegistrationMsg
    AdvertisementMsg                        = 0x37 # Anki.Cozmo.AdvertisementMsg
    Ping                                    = 0x38 # Anki.Cozmo.ExternalInterface.Ping
    DenyGameStart                           = 0x39 # Anki.Cozmo.ExternalInterface.DenyGameStart
    DeviceAccelerometerValuesRaw            = 0x3a # Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesRaw
    DeviceAccelerometerValuesUser           = 0x3b # Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesUser
    DeviceGyroValues                        = 0x3c # Anki.Cozmo.ExternalInterface.DeviceGyroValues
    EnableDeviceIMUData                     = 0x3d # Anki.Cozmo.ExternalInterface.EnableDeviceIMUData
    IsDeviceIMUSupported                    = 0x3e # Anki.Cozmo.ExternalInterface.IsDeviceIMUSupported
    SetVizOrigin                            = 0x3f # Anki.Cozmo.SetVizOrigin
    ImageChunk                              = 0x40 # Anki.Cozmo.ImageChunk
    ImageImuData                            = 0x41 # Anki.Cozmo.ImageImuData
    CameraCalibration                       = 0x42 # Anki.Cozmo.CameraCalibration
    IMURequest                              = 0x43 # Anki.Cozmo.IMURequest
    StartControllerTestMode                 = 0x44 # Anki.Cozmo.StartControllerTestMode
    RawPWM                                  = 0x45 # Anki.Cozmo.RawPWM
    VoiceCommandEvent                       = 0x46 # Anki.Cozmo.VoiceCommand.VoiceCommandEvent
    UiDeviceConnectionSuccess               = 0x47 # Anki.Cozmo.ExternalInterface.UiDeviceConnectionSuccess
    ConnectToRobot                          = 0x48 # Anki.Cozmo.ExternalInterface.ConnectToRobot
    ConnectToUiDevice                       = 0x49 # Anki.Cozmo.ExternalInterface.ConnectToUiDevice
    DisconnectFromUiDevice                  = 0x4a # Anki.Cozmo.ExternalInterface.DisconnectFromUiDevice
    StartEngine                             = 0x4b # Anki.Cozmo.ExternalInterface.StartEngine
    ReliableTransportRunMode                = 0x4c # Anki.Cozmo.ExternalInterface.ReliableTransportRunMode
    RequestFeatureToggles                   = 0x4d # Anki.Cozmo.ExternalInterface.RequestFeatureToggles
    SetFeatureToggle                        = 0x4e # Anki.Cozmo.ExternalInterface.SetFeatureToggle
    StartIdleTimeout                        = 0x4f # Anki.Cozmo.ExternalInterface.StartIdleTimeout
    CancelIdleTimeout                       = 0x50 # Anki.Cozmo.ExternalInterface.CancelIdleTimeout
    SetGameBeingPaused                      = 0x51 # Anki.Cozmo.ExternalInterface.SetGameBeingPaused
    UpdateFirmware                          = 0x52 # Anki.Cozmo.ExternalInterface.UpdateFirmware
    ResetFirmware                           = 0x53 # Anki.Cozmo.ExternalInterface.ResetFirmware
    DriveWheels                             = 0x54 # Anki.Cozmo.ExternalInterface.DriveWheels
    DriveArc                                = 0x55 # Anki.Cozmo.ExternalInterface.DriveArc
    MoveHead                                = 0x56 # Anki.Cozmo.ExternalInterface.MoveHead
    MoveLift                                = 0x57 # Anki.Cozmo.ExternalInterface.MoveLift
    EnableLiftPower                         = 0x58 # Anki.Cozmo.ExternalInterface.EnableLiftPower
    EnableCliffSensor                       = 0x59 # Anki.Cozmo.ExternalInterface.EnableCliffSensor
    EnableBlockTapFilter                    = 0x5a # Anki.Cozmo.ExternalInterface.EnableBlockTapFilter
    GetBlockTapFilterStatus                 = 0x5b # Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus
    StopAllMotors                           = 0x5c # Anki.Cozmo.ExternalInterface.StopAllMotors
    ControllerGains                         = 0x5d # Anki.Cozmo.ExternalInterface.ControllerGains
    RollActionParams                        = 0x5e # Anki.Cozmo.ExternalInterface.RollActionParams
    SetMotionModelParams                    = 0x5f # Anki.Cozmo.ExternalInterface.SetMotionModelParams
    SetRobotVolume                          = 0x60 # Anki.Cozmo.ExternalInterface.SetRobotVolume
    SetRobotAudioOutputSource               = 0x61 # Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource
    ForceDelocalizeRobot                    = 0x62 # Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot
    RestoreRobotFromBackup                  = 0x63 # Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup
    RequestRobotRestoreData                 = 0x64 # Anki.Cozmo.ExternalInterface.RequestRobotRestoreData
    WipeRobotGameData                       = 0x65 # Anki.Cozmo.ExternalInterface.WipeRobotGameData
    RequestUnlockDataFromBackup             = 0x66 # Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup
    CancelAction                            = 0x67 # Anki.Cozmo.ExternalInterface.CancelAction
    CancelActionByIdTag                     = 0x68 # Anki.Cozmo.ExternalInterface.CancelActionByIdTag
    QueueSingleAction                       = 0x69 # Anki.Cozmo.ExternalInterface.QueueSingleAction
    QueueCompoundAction                     = 0x6a # Anki.Cozmo.ExternalInterface.QueueCompoundAction
    ImageRequest                            = 0x6b # Anki.Cozmo.ExternalInterface.ImageRequest
    SetRobotImageSendMode                   = 0x6c # Anki.Cozmo.ExternalInterface.SetRobotImageSendMode
    SaveImages                              = 0x6d # Anki.Cozmo.ExternalInterface.SaveImages
    EnableColorImages                       = 0x6e # Anki.Cozmo.ExternalInterface.EnableColorImages
    SaveRobotState                          = 0x6f # Anki.Cozmo.ExternalInterface.SaveRobotState
    EnableDisplay                           = 0x70 # Anki.Cozmo.ExternalInterface.EnableDisplay
    ExecuteTestPlan                         = 0x71 # Anki.Cozmo.ExternalInterface.ExecuteTestPlan
    PlannerRunMode                          = 0x72 # Anki.Cozmo.ExternalInterface.PlannerRunMode
    SelectNextObject                        = 0x73 # Anki.Cozmo.ExternalInterface.SelectNextObject
    SetRobotCarryingObject                  = 0x74 # Anki.Cozmo.ExternalInterface.SetRobotCarryingObject
    DeleteAllCustomObjects                  = 0x75 # Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
    DeleteCustomMarkerObjects               = 0x76 # Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects
    DeleteFixedCustomObjects                = 0x77 # Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects
    UndefineAllCustomMarkerObjects          = 0x78 # Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects
    CreateFixedCustomObject                 = 0x79 # Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
    DefineCustomBox                         = 0x7a # Anki.Cozmo.ExternalInterface.DefineCustomBox
    DefineCustomCube                        = 0x7b # Anki.Cozmo.ExternalInterface.DefineCustomCube
    DefineCustomWall                        = 0x7c # Anki.Cozmo.ExternalInterface.DefineCustomWall
    VisionWhileMoving                       = 0x7d # Anki.Cozmo.ExternalInterface.VisionWhileMoving
    SetFaceToEnroll                         = 0x7e # Anki.Cozmo.ExternalInterface.SetFaceToEnroll
    CancelFaceEnrollment                    = 0x7f # Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
    EraseEnrolledFaceByID                   = 0x80 # Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
    EraseAllEnrolledFaces                   = 0x81 # Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
    EnableVisionMode                        = 0x82 # Anki.Cozmo.ExternalInterface.EnableVisionMode
    UpdateEnrolledFaceByID                  = 0x83 # Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
    VisionRunMode                           = 0x84 # Anki.Cozmo.ExternalInterface.VisionRunMode
    SaveFaceAlbumToFile                     = 0x85 # Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
    LoadFaceAlbumFromFile                   = 0x86 # Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
    SetMemoryMapRenderEnabled               = 0x87 # Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
    SetMemoryMapBroadcastFrequency_sec      = 0x88 # Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
    ActivateHighLevelActivity               = 0x89 # Anki.Cozmo.ExternalInterface.ActivateHighLevelActivity
    ExecuteBehaviorByExecutableType         = 0x8a # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
    ExecuteBehaviorByID                     = 0x8b # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByID
    SetLiftLoadTestAsRunnable               = 0x8c # Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
    BehaviorManagerMessage                  = 0x8d # Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
    AbortPath                               = 0x8e # Anki.Cozmo.ExternalInterface.AbortPath
    AbortAll                                = 0x8f # Anki.Cozmo.ExternalInterface.AbortAll
    StartTestMode                           = 0x90 # Anki.Cozmo.ExternalInterface.StartTestMode
    RequestAllBehaviorsList                 = 0x91 # Anki.Cozmo.ExternalInterface.RequestAllBehaviorsList
    RequestReactionTriggerMap               = 0x92 # Anki.Cozmo.ExternalInterface.RequestReactionTriggerMap
    ExecuteReactionTrigger                  = 0x93 # Anki.Cozmo.ExternalInterface.ExecuteReactionTrigger
    DisableReactionsWithLock                = 0x94 # Anki.Cozmo.ExternalInterface.DisableReactionsWithLock
    RemoveDisableReactionsLock              = 0x95 # Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock
    DisableAllReactionsWithLock             = 0x96 # Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock
    SetDefaultHeadAndLiftState              = 0x97 # Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
    SetSparkedMusicState                    = 0x98 # Anki.Cozmo.ExternalInterface.SetSparkedMusicState
    RequestLocatedObjectStates              = 0x99 # Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates
    RequestConnectedObjects                 = 0x9a # Anki.Cozmo.ExternalInterface.RequestConnectedObjects
    DrawPoseMarker                          = 0x9b # Anki.Cozmo.ExternalInterface.DrawPoseMarker
    ErasePoseMarker                         = 0x9c # Anki.Cozmo.ExternalInterface.ErasePoseMarker
    VisualizeQuad                           = 0x9d # Anki.Cozmo.ExternalInterface.VisualizeQuad
    EraseQuad                               = 0x9e # Anki.Cozmo.ExternalInterface.EraseQuad
    ReplayLastAnimation                     = 0x9f # Anki.Cozmo.ExternalInterface.ReplayLastAnimation
    SetIdleAnimation                        = 0xa0 # Anki.Cozmo.ExternalInterface.SetIdleAnimation
    PushIdleAnimation                       = 0xa1 # Anki.Cozmo.ExternalInterface.PushIdleAnimation
    PopIdleAnimation                        = 0xa2 # Anki.Cozmo.ExternalInterface.PopIdleAnimation
    ReadFaceAnimationDir                    = 0xa3 # Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
    ReadAnimationFile                       = 0xa4 # Anki.Cozmo.ExternalInterface.ReadAnimationFile
    RequestAvailableAnimations              = 0xa5 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
    RequestAvailableAnimationGroups         = 0xa6 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
    SetLiveIdleAnimationParameters          = 0xa7 # Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
    PushDrivingAnimations                   = 0xa8 # Anki.Cozmo.ExternalInterface.PushDrivingAnimations
    PopDrivingAnimations                    = 0xa9 # Anki.Cozmo.ExternalInterface.PopDrivingAnimations
    SetHeadlight                            = 0xaa # Anki.Cozmo.ExternalInterface.SetHeadlight
    SetActiveObjectLEDs                     = 0xab # Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
    SetAllActiveObjectLEDs                  = 0xac # Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
    SetBackpackLEDs                         = 0xad # Anki.Cozmo.ExternalInterface.SetBackpackLEDs
    EnableLightStates                       = 0xae # Anki.Cozmo.ExternalInterface.EnableLightStates
    EnableCubeSleep                         = 0xaf # Anki.Cozmo.ExternalInterface.EnableCubeSleep
    EnableCubeLightsStateTransitionMessages = 0xb0 # Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
    FlashCurrentLightsState                 = 0xb1 # Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
    PlayCubeAnim                            = 0xb2 # Anki.Cozmo.ExternalInterface.PlayCubeAnim
    StopCubeAnim                            = 0xb3 # Anki.Cozmo.ExternalInterface.StopCubeAnim
    StreamObjectAccel                       = 0xb4 # Anki.Cozmo.ExternalInterface.StreamObjectAccel
    TransitionToNextOnboardingState         = 0xb5 # Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
    MoodMessage                             = 0xb6 # Anki.Cozmo.ExternalInterface.MoodMessage
    GetNeedsState                           = 0xb7 # Anki.Cozmo.ExternalInterface.GetNeedsState
    SetNeedsPauseState                      = 0xb8 # Anki.Cozmo.ExternalInterface.SetNeedsPauseState
    GetNeedsPauseState                      = 0xb9 # Anki.Cozmo.ExternalInterface.GetNeedsPauseState
    SetNeedsPauseStates                     = 0xba # Anki.Cozmo.ExternalInterface.SetNeedsPauseStates
    GetNeedsPauseStates                     = 0xbb # Anki.Cozmo.ExternalInterface.GetNeedsPauseStates
    RegisterNeedsActionCompleted            = 0xbc # Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
    RequestSetUnlock                        = 0xbd # Anki.Cozmo.ExternalInterface.RequestSetUnlock
    RequestDeviceData                       = 0xbe # Anki.Cozmo.ExternalInterface.RequestDeviceData
    SetDebugConsoleVarMessage               = 0xbf # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xc0 # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xc1 # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xc2 # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xc3 # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    SetEnableSpeedChooser                   = 0xc4 # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    BlockPoolEnabledMessage                 = 0xc5 # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xc6 # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xc7 # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xc8 # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xc9 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xca # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xcb # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xcc # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xcd # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xce # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xcf # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xd0 # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xd1 # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xd2 # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xd3 # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xd4 # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xd5 # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xd6 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xd7 # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xd8 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xd9 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xda # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xdb # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xdc # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  def VoiceCommandEvent(self):
    "Anki.Cozmo.VoiceCommand.VoiceCommandEvent VoiceCommandEvent union property."
    msgbuffers.safety_check_tag('VoiceCommandEvent', self._tag, self.Tag.VoiceCommandEvent, self._tags_by_value)
    return self._data

  @VoiceCommandEvent.setter
  def VoiceCommandEvent(self, value):
    self._data = msgbuffers.validate_object(
      'MessageGameToEngine.VoiceCommandEvent', value, Anki.Cozmo.VoiceCommand.VoiceCommandEvent)
    self._tag = self.Tag.VoiceCommandEvent
  ...
  _tags_by_name = dict(
    ...
    TrackToFace=37,
    TrackToObject=38,
    TrackToLaserPoint=39,
    TrackToPet=40,
    TraverseObject=41,
    TurnInPlace=42,
    TurnInPlaceAtSpeed=43,
    TurnTowardsFace=44,
    TurnTowardsImagePoint=45,
    TurnTowardsLastFacePose=46,
    TurnTowardsObject=47,
    TurnTowardsPose=48,
    VisuallyVerifyFace=49,
    VisuallyVerifyObject=50,
    VisuallyVerifyNoObjectAtPose=51,
    Wait=52,
    WaitForImages=53,
    AdvertisementRegistrationMsg=54,
    AdvertisementMsg=55,
    Ping=56,
    DenyGameStart=57,
    DeviceAccelerometerValuesRaw=58,
    DeviceAccelerometerValuesUser=59,
    DeviceGyroValues=60,
    EnableDeviceIMUData=61,
    IsDeviceIMUSupported=62,
    SetVizOrigin=63,
    ImageChunk=64,
    ImageImuData=65,
    CameraCalibration=66,
    IMURequest=67,
    StartControllerTestMode=68,
    RawPWM=69,
    VoiceCommandEvent=70,
    UiDeviceConnectionSuccess=71,
    ConnectToRobot=72,
    ConnectToUiDevice=73,
    DisconnectFromUiDevice=74,
    StartEngine=75,
    ReliableTransportRunMode=76,
    RequestFeatureToggles=77,
    SetFeatureToggle=78,
    StartIdleTimeout=79,
    CancelIdleTimeout=80,
    SetGameBeingPaused=81,
    UpdateFirmware=82,
    ResetFirmware=83,
    DriveWheels=84,
    DriveArc=85,
    ...
    MoveLift=87,
    EnableLiftPower=88,
    EnableCliffSensor=89,
    EnableBlockTapFilter=90,
    GetBlockTapFilterStatus=91,
    StopAllMotors=92,
    ControllerGains=93,
    RollActionParams=94,
    SetMotionModelParams=95,
    SetRobotVolume=96,
    SetRobotAudioOutputSource=97,
    ForceDelocalizeRobot=98,
    RestoreRobotFromBackup=99,
    RequestRobotRestoreData=100,
    WipeRobotGameData=101,
    RequestUnlockDataFromBackup=102,
    CancelAction=103,
    CancelActionByIdTag=104,
    QueueSingleAction=105,
    QueueCompoundAction=106,
    ImageRequest=107,
    SetRobotImageSendMode=108,
    SaveImages=109,
    EnableColorImages=110,
    SaveRobotState=111,
    EnableDisplay=112,
    ExecuteTestPlan=113,
    PlannerRunMode=114,
    SelectNextObject=115,
    SetRobotCarryingObject=116,
    DeleteAllCustomObjects=117,
    DeleteCustomMarkerObjects=118,
    DeleteFixedCustomObjects=119,
    UndefineAllCustomMarkerObjects=120,
    CreateFixedCustomObject=121,
    DefineCustomBox=122,
    DefineCustomCube=123,
    DefineCustomWall=124,
    VisionWhileMoving=125,
    SetFaceToEnroll=126,
    CancelFaceEnrollment=127,
    EraseEnrolledFaceByID=128,
    EraseAllEnrolledFaces=129,
    EnableVisionMode=130,
    UpdateEnrolledFaceByID=131,
    VisionRunMode=132,
    SaveFaceAlbumToFile=133,
    LoadFaceAlbumFromFile=134,
    SetMemoryMapRenderEnabled=135,
    SetMemoryMapBroadcastFrequency_sec=136,
    ActivateHighLevelActivity=137,
    ExecuteBehaviorByExecutableType=138,
    ExecuteBehaviorByID=139,
    SetLiftLoadTestAsRunnable=140,
    BehaviorManagerMessage=141,
    AbortPath=142,
    AbortAll=143,
    StartTestMode=144,
    RequestAllBehaviorsList=145,
    RequestReactionTriggerMap=146,
    ExecuteReactionTrigger=147,
    DisableReactionsWithLock=148,
    RemoveDisableReactionsLock=149,
    DisableAllReactionsWithLock=150,
    SetDefaultHeadAndLiftState=151,
    SetSparkedMusicState=152,
    RequestLocatedObjectStates=153,
    RequestConnectedObjects=154,
    DrawPoseMarker=155,
    ErasePoseMarker=156,
    VisualizeQuad=157,
    EraseQuad=158,
    ReplayLastAnimation=159,
    SetIdleAnimation=160,
    PushIdleAnimation=161,
    PopIdleAnimation=162,
    ReadFaceAnimationDir=163,
    ReadAnimationFile=164,
    RequestAvailableAnimations=165,
    RequestAvailableAnimationGroups=166,
    SetLiveIdleAnimationParameters=167,
    PushDrivingAnimations=168,
    PopDrivingAnimations=169,
    SetHeadlight=170,
    SetActiveObjectLEDs=171,
    SetAllActiveObjectLEDs=172,
    SetBackpackLEDs=173,
    EnableLightStates=174,
    EnableCubeSleep=175,
    EnableCubeLightsStateTransitionMessages=176,
    FlashCurrentLightsState=177,
    PlayCubeAnim=178,
    StopCubeAnim=179,
    StreamObjectAccel=180,
    TransitionToNextOnboardingState=181,
    MoodMessage=182,
    GetNeedsState=183,
    SetNeedsPauseState=184,
    GetNeedsPauseState=185,
    SetNeedsPauseStates=186,
    GetNeedsPauseStates=187,
    RegisterNeedsActionCompleted=188,
    RequestSetUnlock=189,
    RequestDeviceData=190,
    SetDebugConsoleVarMessage=191,
    RunDebugConsoleFuncMessage=192,
    GetDebugConsoleVarMessage=193,
    GetAllDebugConsoleVarMessage=194,
    GetJsonDasLogsMessage=195,
    SetEnableSpeedChooser=196,
    BlockPoolEnabledMessage=197,
    BlockSelectedMessage=198,
    GetBlockPoolMessage=199,
    SendAvailableObjects=200,
    BlockPoolResetMessage=201,
    SaveCalibrationImage=202,
    ClearCalibrationImages=203,
    ComputeCameraCalibration=204,
    ContinueFreeplayFromIdle=205,
    EnableDroneMode=206,
    EnterSdkMode=207,
    ExitSdkMode=208,
    SetStopRobotOnSdkDisconnect=209,
    StopRobotForSdk=210,
    SetShouldAutoConnectToCubesAtStart=211,
    SetShouldAutoDisconnectFromCubesAtEnd=212,
    TransferFile=213,
    NVStorageEraseEntry=214,
    NVStorageWipeAll=215,
    NVStorageWriteEntry=216,
    NVStorageClearPartialPendingWriteEntry=217,
    NVStorageReadEntry=218,
    SetCameraSettings=219,
    RequestRobotSettings=220,
  )
  ...
  _tags_by_value[39] = 'TrackToLaserPoint'
  _tags_by_value[40] = 'TrackToPet'
  _tags_by_value[41] = 'TraverseObject'
  _tags_by_value[42] = 'TurnInPlace'
  _tags_by_value[43] = 'TurnInPlaceAtSpeed'
  _tags_by_value[44] = 'TurnTowardsFace'
  _tags_by_value[45] = 'TurnTowardsImagePoint'
  _tags_by_value[46] = 'TurnTowardsLastFacePose'
  _tags_by_value[47] = 'TurnTowardsObject'
  _tags_by_value[48] = 'TurnTowardsPose'
  _tags_by_value[49] = 'VisuallyVerifyFace'
  _tags_by_value[50] = 'VisuallyVerifyObject'
  _tags_by_value[51] = 'VisuallyVerifyNoObjectAtPose'
  _tags_by_value[52] = 'Wait'
  _tags_by_value[53] = 'WaitForImages'
  _tags_by_value[54] = 'AdvertisementRegistrationMsg'
  _tags_by_value[55] = 'AdvertisementMsg'
  _tags_by_value[56] = 'Ping'
  _tags_by_value[57] = 'DenyGameStart'
  _tags_by_value[58] = 'DeviceAccelerometerValuesRaw'
  _tags_by_value[59] = 'DeviceAccelerometerValuesUser'
  _tags_by_value[60] = 'DeviceGyroValues'
  _tags_by_value[61] = 'EnableDeviceIMUData'
  _tags_by_value[62] = 'IsDeviceIMUSupported'
  _tags_by_value[63] = 'SetVizOrigin'
  _tags_by_value[64] = 'ImageChunk'
  _tags_by_value[65] = 'ImageImuData'
  _tags_by_value[66] = 'CameraCalibration'
  _tags_by_value[67] = 'IMURequest'
  _tags_by_value[68] = 'StartControllerTestMode'
  _tags_by_value[69] = 'RawPWM'
  _tags_by_value[70] = 'VoiceCommandEvent'
  _tags_by_value[71] = 'UiDeviceConnectionSuccess'
  _tags_by_value[72] = 'ConnectToRobot'
  _tags_by_value[73] = 'ConnectToUiDevice'
  _tags_by_value[74] = 'DisconnectFromUiDevice'
  _tags_by_value[75] = 'StartEngine'
  _tags_by_value[76] = 'ReliableTransportRunMode'
  _tags_by_value[77] = 'RequestFeatureToggles'
  _tags_by_value[78] = 'SetFeatureToggle'
  _tags_by_value[79] = 'StartIdleTimeout'
  _tags_by_value[80] = 'CancelIdleTimeout'
  _tags_by_value[81] = 'SetGameBeingPaused'
  _tags_by_value[82] = 'UpdateFirmware'
  _tags_by_value[83] = 'ResetFirmware'
  _tags_by_value[84] = 'DriveWheels'
  _tags_by_value[85] = 'DriveArc'
  _tags_by_value[86] = 'MoveHead'
  _tags_by_value[87] = 'MoveLift'
  _tags_by_value[88] = 'EnableLiftPower'
  _tags_by_value[89] = 'EnableCliffSensor'
  _tags_by_value[90] = 'EnableBlockTapFilter'
  _tags_by_value[91] = 'GetBlockTapFilterStatus'
  _tags_by_value[92] = 'StopAllMotors'
  _tags_by_value[93] = 'ControllerGains'
  _tags_by_value[94] = 'RollActionParams'
  _tags_by_value[95] = 'SetMotionModelParams'
  _tags_by_value[96] = 'SetRobotVolume'
  _tags_by_value[97] = 'SetRobotAudioOutputSource'
  _tags_by_value[98] = 'ForceDelocalizeRobot'
  _tags_by_value[99] = 'RestoreRobotFromBackup'
  _tags_by_value[100] = 'RequestRobotRestoreData'
  _tags_by_value[101] = 'WipeRobotGameData'
  _tags_by_value[102] = 'RequestUnlockDataFromBackup'
  _tags_by_value[103] = 'CancelAction'
  _tags_by_value[104] = 'CancelActionByIdTag'
  _tags_by_value[105] = 'QueueSingleAction'
  _tags_by_value[106] = 'QueueCompoundAction'
  _tags_by_value[107] = 'ImageRequest'
  _tags_by_value[108] = 'SetRobotImageSendMode'
  _tags_by_value[109] = 'SaveImages'
  _tags_by_value[110] = 'EnableColorImages'
  _tags_by_value[111] = 'SaveRobotState'
  _tags_by_value[112] = 'EnableDisplay'
  _tags_by_value[113] = 'ExecuteTestPlan'
  _tags_by_value[114] = 'PlannerRunMode'
  _tags_by_value[115] = 'SelectNextObject'
  _tags_by_value[116] = 'SetRobotCarryingObject'
  _tags_by_value[117] = 'DeleteAllCustomObjects'
  _tags_by_value[118] = 'DeleteCustomMarkerObjects'
  _tags_by_value[119] = 'DeleteFixedCustomObjects'
  _tags_by_value[120] = 'UndefineAllCustomMarkerObjects'
  _tags_by_value[121] = 'CreateFixedCustomObject'
  _tags_by_value[122] = 'DefineCustomBox'
  _tags_by_value[123] = 'DefineCustomCube'
  _tags_by_value[124] = 'DefineCustomWall'
  _tags_by_value[125] = 'VisionWhileMoving'
  _tags_by_value[126] = 'SetFaceToEnroll'
  _tags_by_value[127] = 'CancelFaceEnrollment'
  _tags_by_value[128] = 'EraseEnrolledFaceByID'
  _tags_by_value[129] = 'EraseAllEnrolledFaces'
  _tags_by_value[130] = 'EnableVisionMode'
  _tags_by_value[131] = 'UpdateEnrolledFaceByID'
  _tags_by_value[132] = 'VisionRunMode'
  _tags_by_value[133] = 'SaveFaceAlbumToFile'
  _tags_by_value[134] = 'LoadFaceAlbumFromFile'
  _tags_by_value[135] = 'SetMemoryMapRenderEnabled'
  _tags_by_value[136] = 'SetMemoryMapBroadcastFrequency_sec'
  _tags_by_value[137] = 'ActivateHighLevelActivity'
  _tags_by_value[138] = 'ExecuteBehaviorByExecutableType'
  _tags_by_value[139] = 'ExecuteBehaviorByID'
  _tags_by_value[140] = 'SetLiftLoadTestAsRunnable'
  _tags_by_value[141] = 'BehaviorManagerMessage'
  _tags_by_value[142] = 'AbortPath'
  _tags_by_value[143] = 'AbortAll'
  _tags_by_value[144] = 'StartTestMode'
  _tags_by_value[145] = 'RequestAllBehaviorsList'
  _tags_by_value[146] = 'RequestReactionTriggerMap'
  _tags_by_value[147] = 'ExecuteReactionTrigger'
  _tags_by_value[148] = 'DisableReactionsWithLock'
  _tags_by_value[149] = 'RemoveDisableReactionsLock'
  _tags_by_value[150] = 'DisableAllReactionsWithLock'
  _tags_by_value[151] = 'SetDefaultHeadAndLiftState'
  _tags_by_value[152] = 'SetSparkedMusicState'
  _tags_by_value[153] = 'RequestLocatedObjectStates'
  _tags_by_value[154] = 'RequestConnectedObjects'
  _tags_by_value[155] = 'DrawPoseMarker'
  _tags_by_value[156] = 'ErasePoseMarker'
  _tags_by_value[157] = 'VisualizeQuad'
  _tags_by_value[158] = 'EraseQuad'
  _tags_by_value[159] = 'ReplayLastAnimation'
  _tags_by_value[160] = 'SetIdleAnimation'
  _tags_by_value[161] = 'PushIdleAnimation'
  _tags_by_value[162] = 'PopIdleAnimation'
  _tags_by_value[163] = 'ReadFaceAnimationDir'
  _tags_by_value[164] = 'ReadAnimationFile'
  _tags_by_value[165] = 'RequestAvailableAnimations'
  _tags_by_value[166] = 'RequestAvailableAnimationGroups'
  _tags_by_value[167] = 'SetLiveIdleAnimationParameters'
  _tags_by_value[168] = 'PushDrivingAnimations'
  _tags_by_value[169] = 'PopDrivingAnimations'
  _tags_by_value[170] = 'SetHeadlight'
  _tags_by_value[171] = 'SetActiveObjectLEDs'
  _tags_by_value[172] = 'SetAllActiveObjectLEDs'
  _tags_by_value[173] = 'SetBackpackLEDs'
  _tags_by_value[174] = 'EnableLightStates'
  _tags_by_value[175] = 'EnableCubeSleep'
  _tags_by_value[176] = 'EnableCubeLightsStateTransitionMessages'
  _tags_by_value[177] = 'FlashCurrentLightsState'
  _tags_by_value[178] = 'PlayCubeAnim'
  _tags_by_value[179] = 'StopCubeAnim'
  _tags_by_value[180] = 'StreamObjectAccel'
  _tags_by_value[181] = 'TransitionToNextOnboardingState'
  _tags_by_value[182] = 'MoodMessage'
  _tags_by_value[183] = 'GetNeedsState'
  _tags_by_value[184] = 'SetNeedsPauseState'
  _tags_by_value[185] = 'GetNeedsPauseState'
  _tags_by_value[186] = 'SetNeedsPauseStates'
  _tags_by_value[187] = 'GetNeedsPauseStates'
  _tags_by_value[188] = 'RegisterNeedsActionCompleted'
  _tags_by_value[189] = 'RequestSetUnlock'
  _tags_by_value[190] = 'RequestDeviceData'
  _tags_by_value[191] = 'SetDebugConsoleVarMessage'
  _tags_by_value[192] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[193] = 'GetDebugConsoleVarMessage'
  _tags_by_value[194] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[195] = 'GetJsonDasLogsMessage'
  _tags_by_value[196] = 'SetEnableSpeedChooser'
  _tags_by_value[197] = 'BlockPoolEnabledMessage'
  _tags_by_value[198] = 'BlockSelectedMessage'
  _tags_by_value[199] = 'GetBlockPoolMessage'
  _tags_by_value[200] = 'SendAvailableObjects'
  _tags_by_value[201] = 'BlockPoolResetMessage'
  _tags_by_value[202] = 'SaveCalibrationImage'
  _tags_by_value[203] = 'ClearCalibrationImages'
  _tags_by_value[204] = 'ComputeCameraCalibration'
  _tags_by_value[205] = 'ContinueFreeplayFromIdle'
  _tags_by_value[206] = 'EnableDroneMode'
  _tags_by_value[207] = 'EnterSdkMode'
  _tags_by_value[208] = 'ExitSdkMode'
  _tags_by_value[209] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[210] = 'StopRobotForSdk'
  _tags_by_value[211] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[212] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[213] = 'TransferFile'
  _tags_by_value[214] = 'NVStorageEraseEntry'
  _tags_by_value[215] = 'NVStorageWipeAll'
  _tags_by_value[216] = 'NVStorageWriteEntry'
  _tags_by_value[217] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[218] = 'NVStorageReadEntry'
  _tags_by_value[219] = 'SetCameraSettings'
  _tags_by_value[220] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TrackToLaserPoint.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TrackToPet.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TraverseObject.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnInPlace.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnInPlaceAtSpeed.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsFace.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsImagePoint.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsLastFacePose.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsObject.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TurnTowardsPose.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisuallyVerifyFace.unpack_from)
  _tag_unpack_methods[50] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisuallyVerifyObject.unpack_from)
  _tag_unpack_methods[51] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisuallyVerifyNoObjectAtPose.unpack_from)
  _tag_unpack_methods[52] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.Wait.unpack_from)
  _tag_unpack_methods[53] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WaitForImages.unpack_from)
  _tag_unpack_methods[54] = lambda reader: reader.read_object(Anki.Cozmo.AdvertisementRegistrationMsg.unpack_from)
  _tag_unpack_methods[55] = lambda reader: reader.read_object(Anki.Cozmo.AdvertisementMsg.unpack_from)
  _tag_unpack_methods[56] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.Ping.unpack_from)
  _tag_unpack_methods[57] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DenyGameStart.unpack_from)
  _tag_unpack_methods[58] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesRaw.unpack_from)
  _tag_unpack_methods[59] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesUser.unpack_from)
  _tag_unpack_methods[60] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceGyroValues.unpack_from)
  _tag_unpack_methods[61] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDeviceIMUData.unpack_from)
  _tag_unpack_methods[62] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.IsDeviceIMUSupported.unpack_from)
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.SetVizOrigin.unpack_from)
  _tag_unpack_methods[64] = lambda reader: reader.read_object(Anki.Cozmo.ImageChunk.unpack_from)
  _tag_unpack_methods[65] = lambda reader: reader.read_object(Anki.Cozmo.ImageImuData.unpack_from)
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.CameraCalibration.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.IMURequest.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.StartControllerTestMode.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.RawPWM.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.VoiceCommand.VoiceCommandEvent.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UiDeviceConnectionSuccess.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectToRobot.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectToUiDevice.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisconnectFromUiDevice.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartEngine.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReliableTransportRunMode.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestFeatureToggles.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFeatureToggle.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartIdleTimeout.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelIdleTimeout.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetGameBeingPaused.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateFirmware.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ResetFirmware.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveWheels.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveArc.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoveHead.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoveLift.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLiftPower.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCliffSensor.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableBlockTapFilter.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopAllMotors.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ControllerGains.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RollActionParams.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMotionModelParams.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotVolume.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotRestoreData.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeRobotGameData.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelAction.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelActionByIdTag.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.QueueSingleAction.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.QueueCompoundAction.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ImageRequest.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotImageSendMode.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveImages.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableColorImages.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveRobotState.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDisplay.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteTestPlan.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlannerRunMode.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SelectNextObject.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotCarryingObject.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreateFixedCustomObject.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomBox.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomCube.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomWall.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionWhileMoving.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFaceToEnroll.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelFaceEnrollment.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableVisionMode.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionRunMode.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ActivateHighLevelActivity.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByID.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorManagerMessage.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortPath.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortAll.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartTestMode.unpack_from)
  _tag_unpack_methods[145] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAllBehaviorsList.unpack_from)
  _tag_unpack_methods[146] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestReactionTriggerMap.unpack_from)
  _tag_unpack_methods[147] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteReactionTrigger.unpack_from)
  _tag_unpack_methods[148] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisableReactionsWithLock.unpack_from)
  _tag_unpack_methods[149] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock.unpack_from)
  _tag_unpack_methods[150] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock.unpack_from)
  _tag_unpack_methods[151] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState.unpack_from)
  _tag_unpack_methods[152] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetSparkedMusicState.unpack_from)
  _tag_unpack_methods[153] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates.unpack_from)
  _tag_unpack_methods[154] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestConnectedObjects.unpack_from)
  _tag_unpack_methods[155] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DrawPoseMarker.unpack_from)
  _tag_unpack_methods[156] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ErasePoseMarker.unpack_from)
  _tag_unpack_methods[157] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisualizeQuad.unpack_from)
  _tag_unpack_methods[158] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[159] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReplayLastAnimation.unpack_from)
  _tag_unpack_methods[160] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetIdleAnimation.unpack_from)
  _tag_unpack_methods[161] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushIdleAnimation.unpack_from)
  _tag_unpack_methods[162] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopIdleAnimation.unpack_from)
  _tag_unpack_methods[163] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir.unpack_from)
  _tag_unpack_methods[164] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadAnimationFile.unpack_from)
  _tag_unpack_methods[165] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimations.unpack_from)
  _tag_unpack_methods[166] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups.unpack_from)
  _tag_unpack_methods[167] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters.unpack_from)
  _tag_unpack_methods[168] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushDrivingAnimations.unpack_from)
  _tag_unpack_methods[169] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopDrivingAnimations.unpack_from)
  _tag_unpack_methods[170] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetHeadlight.unpack_from)
  _tag_unpack_methods[171] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[172] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[173] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetBackpackLEDs.unpack_from)
  _tag_unpack_methods[174] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLightStates.unpack_from)
  _tag_unpack_methods[175] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeSleep.unpack_from)
  _tag_unpack_methods[176] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages.unpack_from)
  _tag_unpack_methods[177] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FlashCurrentLightsState.unpack_from)
  _tag_unpack_methods[178] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayCubeAnim.unpack_from)
  _tag_unpack_methods[179] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopCubeAnim.unpack_from)
  _tag_unpack_methods[180] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StreamObjectAccel.unpack_from)
  _tag_unpack_methods[181] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState.unpack_from)
  _tag_unpack_methods[182] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodMessage.unpack_from)
  _tag_unpack_methods[183] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsState.unpack_from)
  _tag_unpack_methods[184] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseState.unpack_from)
  _tag_unpack_methods[185] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseState.unpack_from)
  _tag_unpack_methods[186] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseStates.unpack_from)
  _tag_unpack_methods[187] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseStates.unpack_from)
  _tag_unpack_methods[188] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted.unpack_from)
  _tag_unpack_methods[189] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlock.unpack_from)
  _tag_unpack_methods[190] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDeviceData.unpack_from)
  _tag_unpack_methods[191] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[192] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[193] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[194] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[195] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[196] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[197] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[198] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[199] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[200] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[201] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[202] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[203] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[204] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[205] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[206] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[207] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[208] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[209] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[210] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[211] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[212] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[213] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[214] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[215] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[216] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[217] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[218] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[219] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[220] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[39] = lambda : Anki.Cozmo.ExternalInterface.TrackToLaserPoint
  _type_by_tag_value[40] = lambda : Anki.Cozmo.ExternalInterface.TrackToPet
  _type_by_tag_value[41] = lambda : Anki.Cozmo.ExternalInterface.TraverseObject
  _type_by_tag_value[42] = lambda : Anki.Cozmo.ExternalInterface.TurnInPlace
  _type_by_tag_value[43] = lambda : Anki.Cozmo.ExternalInterface.TurnInPlaceAtSpeed
  _type_by_tag_value[44] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsFace
  _type_by_tag_value[45] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsImagePoint
  _type_by_tag_value[46] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsLastFacePose
  _type_by_tag_value[47] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsObject
  _type_by_tag_value[48] = lambda : Anki.Cozmo.ExternalInterface.TurnTowardsPose
  _type_by_tag_value[49] = lambda : Anki.Cozmo.ExternalInterface.VisuallyVerifyFace
  _type_by_tag_value[50] = lambda : Anki.Cozmo.ExternalInterface.VisuallyVerifyObject
  _type_by_tag_value[51] = lambda : Anki.Cozmo.ExternalInterface.VisuallyVerifyNoObjectAtPose
  _type_by_tag_value[52] = lambda : Anki.Cozmo.ExternalInterface.Wait
  _type_by_tag_value[53] = lambda : Anki.Cozmo.ExternalInterface.WaitForImages
  _type_by_tag_value[54] = lambda : Anki.Cozmo.AdvertisementRegistrationMsg
  _type_by_tag_value[55] = lambda : Anki.Cozmo.AdvertisementMsg
  _type_by_tag_value[56] = lambda : Anki.Cozmo.ExternalInterface.Ping
  _type_by_tag_value[57] = lambda : Anki.Cozmo.ExternalInterface.DenyGameStart
  _type_by_tag_value[58] = lambda : Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesRaw
  _type_by_tag_value[59] = lambda : Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesUser
  _type_by_tag_value[60] = lambda : Anki.Cozmo.ExternalInterface.DeviceGyroValues
  _type_by_tag_value[61] = lambda : Anki.Cozmo.ExternalInterface.EnableDeviceIMUData
  _type_by_tag_value[62] = lambda : Anki.Cozmo.ExternalInterface.IsDeviceIMUSupported
  _type_by_tag_value[63] = lambda : Anki.Cozmo.SetVizOrigin
  _type_by_tag_value[64] = lambda : Anki.Cozmo.ImageChunk
  _type_by_tag_value[65] = lambda : Anki.Cozmo.ImageImuData
  _type_by_tag_value[66] = lambda : Anki.Cozmo.CameraCalibration
  _type_by_tag_value[67] = lambda : Anki.Cozmo.IMURequest
  _type_by_tag_value[68] = lambda : Anki.Cozmo.StartControllerTestMode
  _type_by_tag_value[69] = lambda : Anki.Cozmo.RawPWM
  _type_by_tag_value[70] = lambda : Anki.Cozmo.VoiceCommand.VoiceCommandEvent
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.UiDeviceConnectionSuccess
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.ConnectToRobot
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.ConnectToUiDevice
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.DisconnectFromUiDevice
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.StartEngine
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.ReliableTransportRunMode
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.RequestFeatureToggles
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.SetFeatureToggle
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.StartIdleTimeout
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.CancelIdleTimeout
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.SetGameBeingPaused
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.UpdateFirmware
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.ResetFirmware
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.DriveWheels
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.DriveArc
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.MoveHead
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.MoveLift
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.EnableLiftPower
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.EnableCliffSensor
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.EnableBlockTapFilter
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.StopAllMotors
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.ControllerGains
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.RollActionParams
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.SetMotionModelParams
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.SetRobotVolume
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotRestoreData
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.WipeRobotGameData
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.CancelAction
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.CancelActionByIdTag
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.QueueSingleAction
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.QueueCompoundAction
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.ImageRequest
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.SetRobotImageSendMode
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.SaveImages
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.EnableColorImages
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.SaveRobotState
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.EnableDisplay
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.ExecuteTestPlan
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.PlannerRunMode
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.SelectNextObject
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.SetRobotCarryingObject
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.DeleteCustomMarkerObjects
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.DeleteFixedCustomObjects
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.UndefineAllCustomMarkerObjects
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomBox
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomCube
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomWall
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.VisionWhileMoving
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.SetFaceToEnroll
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.EnableVisionMode
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.VisionRunMode
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.ActivateHighLevelActivity
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByID
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.AbortPath
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.AbortAll
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.StartTestMode
  _type_by_tag_value[145] = lambda : Anki.Cozmo.ExternalInterface.RequestAllBehaviorsList
  _type_by_tag_value[146] = lambda : Anki.Cozmo.ExternalInterface.RequestReactionTriggerMap
  _type_by_tag_value[147] = lambda : Anki.Cozmo.ExternalInterface.ExecuteReactionTrigger
  _type_by_tag_value[148] = lambda : Anki.Cozmo.ExternalInterface.DisableReactionsWithLock
  _type_by_tag_value[149] = lambda : Anki.Cozmo.ExternalInterface.RemoveDisableReactionsLock
  _type_by_tag_value[150] = lambda : Anki.Cozmo.ExternalInterface.DisableAllReactionsWithLock
  _type_by_tag_value[151] = lambda : Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
  _type_by_tag_value[152] = lambda : Anki.Cozmo.ExternalInterface.SetSparkedMusicState
  _type_by_tag_value[153] = lambda : Anki.Cozmo.ExternalInterface.RequestLocatedObjectStates
  _type_by_tag_value[154] = lambda : Anki.Cozmo.ExternalInterface.RequestConnectedObjects
  _type_by_tag_value[155] = lambda : Anki.Cozmo.ExternalInterface.DrawPoseMarker
  _type_by_tag_value[156] = lambda : Anki.Cozmo.ExternalInterface.ErasePoseMarker
  _type_by_tag_value[157] = lambda : Anki.Cozmo.ExternalInterface.VisualizeQuad
  _type_by_tag_value[158] = lambda : Anki.Cozmo.ExternalInterface.EraseQuad
  _type_by_tag_value[159] = lambda : Anki.Cozmo.ExternalInterface.ReplayLastAnimation
  _type_by_tag_value[160] = lambda : Anki.Cozmo.ExternalInterface.SetIdleAnimation
  _type_by_tag_value[161] = lambda : Anki.Cozmo.ExternalInterface.PushIdleAnimation
  _type_by_tag_value[162] = lambda : Anki.Cozmo.ExternalInterface.PopIdleAnimation
  _type_by_tag_value[163] = lambda : Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
  _type_by_tag_value[164] = lambda : Anki.Cozmo.ExternalInterface.ReadAnimationFile
  _type_by_tag_value[165] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
  _type_by_tag_value[166] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
  _type_by_tag_value[167] = lambda : Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
  _type_by_tag_value[168] = lambda : Anki.Cozmo.ExternalInterface.PushDrivingAnimations
  _type_by_tag_value[169] = lambda : Anki.Cozmo.ExternalInterface.PopDrivingAnimations
  _type_by_tag_value[170] = lambda : Anki.Cozmo.ExternalInterface.SetHeadlight
  _type_by_tag_value[171] = lambda : Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
  _type_by_tag_value[172] = lambda : Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
  _type_by_tag_value[173] = lambda : Anki.Cozmo.ExternalInterface.SetBackpackLEDs
  _type_by_tag_value[174] = lambda : Anki.Cozmo.ExternalInterface.EnableLightStates
  _type_by_tag_value[175] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeSleep
  _type_by_tag_value[176] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
  _type_by_tag_value[177] = lambda : Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
  _type_by_tag_value[178] = lambda : Anki.Cozmo.ExternalInterface.PlayCubeAnim
  _type_by_tag_value[179] = lambda : Anki.Cozmo.ExternalInterface.StopCubeAnim
  _type_by_tag_value[180] = lambda : Anki.Cozmo.ExternalInterface.StreamObjectAccel
  _type_by_tag_value[181] = lambda : Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
  _type_by_tag_value[182] = lambda : Anki.Cozmo.ExternalInterface.MoodMessage
  _type_by_tag_value[183] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsState
  _type_by_tag_value[184] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseState
  _type_by_tag_value[185] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseState
  _type_by_tag_value[186] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseStates
  _type_by_tag_value[187] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseStates
  _type_by_tag_value[188] = lambda : Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
  _type_by_tag_value[189] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlock
  _type_by_tag_value[190] = lambda : Anki.Cozmo.ExternalInterface.RequestDeviceData
  _type_by_tag_value[191] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[192] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[193] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[194] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[195] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[196] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[197] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[198] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[199] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[200] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[201] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[202] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[203] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[204] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[205] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[206] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[207] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[208] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[209] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[210] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[211] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[212] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[213] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[214] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[215] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[216] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[217] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[218] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[219] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[220] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
