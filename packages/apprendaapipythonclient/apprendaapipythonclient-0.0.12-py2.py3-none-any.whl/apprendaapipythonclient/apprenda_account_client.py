...
class ApprendaAccountClient(ApprendaAPIClient):
    ...
    def assign_user_to_subscription(self, subscription_id, user_id, application_version_id):
        api = SubscriptionsApi(self.internalClient)
        
        return api.api_v1_application_versions_application_version_key_subscriptions_locator_assignedto_post(application_version_id, subscription_id, user_id)
