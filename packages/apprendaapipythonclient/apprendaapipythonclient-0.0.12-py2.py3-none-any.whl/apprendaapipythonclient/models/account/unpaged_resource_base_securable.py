...
class UnpagedResourceBaseSecurable(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseSecurable - a model defined in Swagger
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseSecurable.

        :return: The href of this UnpagedResourceBaseSecurable.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseSecurable.

        :param href: The href of this UnpagedResourceBaseSecurable.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseSecurable.

        :return: The items of this UnpagedResourceBaseSecurable.
        :rtype: list[Securable]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseSecurable.

        :param items: The items of this UnpagedResourceBaseSecurable.
        :type: list[Securable]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseSecurable):
            return False
