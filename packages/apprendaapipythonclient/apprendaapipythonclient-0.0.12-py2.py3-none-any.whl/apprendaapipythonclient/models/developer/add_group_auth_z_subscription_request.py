...
class AddGroupAuthZSubscriptionRequest(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, group_ids=None, plan_name=None):
        """
        AddGroupAuthZSubscriptionRequest - a model defined in Swagger
    ...
    def group_ids(self):
        """
        Gets the group_ids of this AddGroupAuthZSubscriptionRequest.

        :return: The group_ids of this AddGroupAuthZSubscriptionRequest.
        :rtype: list[str]
        """
    ...
    def group_ids(self, group_ids):
        """
        Sets the group_ids of this AddGroupAuthZSubscriptionRequest.

        :param group_ids: The group_ids of this AddGroupAuthZSubscriptionRequest.
        :type: list[str]
        """
    ...
    def plan_name(self):
        """
        Gets the plan_name of this AddGroupAuthZSubscriptionRequest.

        :return: The plan_name of this AddGroupAuthZSubscriptionRequest.
        :rtype: str
        """
    ...
    def plan_name(self, plan_name):
        """
        Sets the plan_name of this AddGroupAuthZSubscriptionRequest.

        :param plan_name: The plan_name of this AddGroupAuthZSubscriptionRequest.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AddGroupAuthZSubscriptionRequest):
            return False
