...
class StorageQuotaReference(object):
    """
    ...
    def __init__(self, name=None, href=None):
        """
        StorageQuotaReference - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this StorageQuotaReference.

        :return: The name of this StorageQuotaReference.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this StorageQuotaReference.

        :param name: The name of this StorageQuotaReference.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this StorageQuotaReference.

        :return: The href of this StorageQuotaReference.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this StorageQuotaReference.

        :param href: The href of this StorageQuotaReference.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, StorageQuotaReference):
            return False
