...
class CustomProperty(object):
    ...
    def __init__(self, version=None, referenced_object=None, property_model=None, values=None, href=None):
        ...
        self.swagger_types = {
            ...
            'referenced_object': 'ResourceBase',
            'property_model': 'CustomPropertyModel',
            'values': 'list[str]',
            'href': 'str'
        }
    ...
    def version(self):
        """
        Gets the version of this CustomProperty.

        :return: The version of this CustomProperty.
        :rtype: ResourceBase
        """
    ...
    def version(self, version):
        """
        Sets the version of this CustomProperty.

        :param version: The version of this CustomProperty.
        :type: ResourceBase
        """
    ...
    def referenced_object(self):
        """
        Gets the referenced_object of this CustomProperty.

        :return: The referenced_object of this CustomProperty.
        :rtype: ResourceBase
        """
    ...
    def referenced_object(self, referenced_object):
        """
        Sets the referenced_object of this CustomProperty.

        :param referenced_object: The referenced_object of this CustomProperty.
        :type: ResourceBase
        """
    ...
    def property_model(self):
        """
        Gets the property_model of this CustomProperty.

        :return: The property_model of this CustomProperty.
        :rtype: CustomPropertyModel
        """
    ...
    def property_model(self, property_model):
        """
        Sets the property_model of this CustomProperty.

        :param property_model: The property_model of this CustomProperty.
    ...
    def values(self):
        """
        Gets the values of this CustomProperty.

        :return: The values of this CustomProperty.
        :rtype: list[str]
        """
        return self._values
    ...
    def values(self, values):
        """
        Sets the values of this CustomProperty.

        :param values: The values of this CustomProperty.
        :type: list[str]
        """
