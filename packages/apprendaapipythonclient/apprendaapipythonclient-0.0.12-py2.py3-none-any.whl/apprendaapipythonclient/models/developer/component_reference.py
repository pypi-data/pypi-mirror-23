...
class ComponentReference(object):
    ...
    def __init__(self, name=None, type=None, alias=None, href=None):
        """
        ComponentReference - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this ComponentReference.

        :return: The name of this ComponentReference.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ComponentReference.

        :param name: The name of this ComponentReference.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this ComponentReference.

        :return: The type of this ComponentReference.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this ComponentReference.

        :param type: The type of this ComponentReference.
        :type: str
        """
    ...
    def alias(self):
        """
        Gets the alias of this ComponentReference.

        :return: The alias of this ComponentReference.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this ComponentReference.

        :param alias: The alias of this ComponentReference.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this ComponentReference.

        :return: The href of this ComponentReference.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ComponentReference.

        :param href: The href of this ComponentReference.
        :type: str
        """
