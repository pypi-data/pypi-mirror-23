...
class LogOverrideSubscriber(object):
    """
    ...
    def __init__(self, alias=None, name=None):
        """
        LogOverrideSubscriber - a model defined in Swagger
    ...
    def alias(self):
        """
        Gets the alias of this LogOverrideSubscriber.

        :return: The alias of this LogOverrideSubscriber.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this LogOverrideSubscriber.

        :param alias: The alias of this LogOverrideSubscriber.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this LogOverrideSubscriber.

        :return: The name of this LogOverrideSubscriber.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this LogOverrideSubscriber.

        :param name: The name of this LogOverrideSubscriber.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LogOverrideSubscriber):
            return False
