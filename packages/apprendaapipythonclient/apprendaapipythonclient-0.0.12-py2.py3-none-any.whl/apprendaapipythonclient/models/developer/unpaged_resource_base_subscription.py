...
class UnpagedResourceBaseSubscription(object):
    """
    ...
    def __init__(self, items=None, href=None):
        """
        UnpagedResourceBaseSubscription - a model defined in Swagger
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseSubscription.

        :return: The items of this UnpagedResourceBaseSubscription.
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseSubscription.

        :param items: The items of this UnpagedResourceBaseSubscription.
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseSubscription.

        :return: The href of this UnpagedResourceBaseSubscription.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseSubscription.

        :param href: The href of this UnpagedResourceBaseSubscription.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseSubscription):
            return False
