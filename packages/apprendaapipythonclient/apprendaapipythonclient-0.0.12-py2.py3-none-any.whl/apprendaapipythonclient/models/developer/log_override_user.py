...
class LogOverrideUser(object):
    ...
    def __init__(self, id=None, first_name=None, last_name=None, email_address=None):
        """
        LogOverrideUser - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this LogOverrideUser.

        :return: The id of this LogOverrideUser.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this LogOverrideUser.

        :param id: The id of this LogOverrideUser.
        :type: str
        """
    ...
    def first_name(self):
        """
        Gets the first_name of this LogOverrideUser.

        :return: The first_name of this LogOverrideUser.
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """
        Sets the first_name of this LogOverrideUser.

        :param first_name: The first_name of this LogOverrideUser.
        :type: str
        """
    ...
    def last_name(self):
        """
        Gets the last_name of this LogOverrideUser.

        :return: The last_name of this LogOverrideUser.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """
        Sets the last_name of this LogOverrideUser.

        :param last_name: The last_name of this LogOverrideUser.
        :type: str
        """
    ...
    def email_address(self):
        """
        Gets the email_address of this LogOverrideUser.

        :return: The email_address of this LogOverrideUser.
        :rtype: str
        """
    ...
    def email_address(self, email_address):
        """
        Sets the email_address of this LogOverrideUser.

        :param email_address: The email_address of this LogOverrideUser.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LogOverrideUser):
            return False
