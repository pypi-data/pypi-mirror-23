...
class JavaRuntimeReturn(object):
    """
    ...
    def __init__(self, name=None):
        """
        JavaRuntimeReturn - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this JavaRuntimeReturn.

        :return: The name of this JavaRuntimeReturn.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this JavaRuntimeReturn.

        :param name: The name of this JavaRuntimeReturn.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, JavaRuntimeReturn):
            return False
