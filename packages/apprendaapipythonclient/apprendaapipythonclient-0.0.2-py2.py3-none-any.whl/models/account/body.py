...
class Body(object):
    ...
    def plan_requests(self):
        """
        Gets the plan_requests of this Body.

        :return: The plan_requests of this Body.
    ...
    def plan_requests(self, plan_requests):
        """
        Sets the plan_requests of this Body.

        :param plan_requests: The plan_requests of this Body.
