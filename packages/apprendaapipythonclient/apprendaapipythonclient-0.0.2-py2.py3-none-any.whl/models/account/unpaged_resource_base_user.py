...
class UnpagedResourceBaseUser(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseUser - a model defined in Swagger
        ...
        self.swagger_types = {
            'href': 'str',
            'items': 'list[InlineResponse2004AssignedTo]'
        }
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseUser.

        :return: The href of this UnpagedResourceBaseUser.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseUser.

        :param href: The href of this UnpagedResourceBaseUser.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseUser.

        :return: The items of this UnpagedResourceBaseUser.
        :rtype: list[InlineResponse2004AssignedTo]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseUser.

        :param items: The items of this UnpagedResourceBaseUser.
        :type: list[InlineResponse2004AssignedTo]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseUser):
            return False
