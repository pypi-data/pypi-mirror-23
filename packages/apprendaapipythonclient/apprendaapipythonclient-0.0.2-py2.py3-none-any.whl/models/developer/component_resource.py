...
class ComponentResource(object):
    ...
    """
    def __init__(self, name=None, path=None, is_directory=None, component=None, href=None):
        """
        ComponentResource - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'path': 'str',
            'is_directory': 'bool',
            'component': 'InlineResponse200Roles',
            'href': 'str'
        }
    ...
    def name(self):
        """
        Gets the name of this ComponentResource.

        :return: The name of this ComponentResource.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ComponentResource.

        :param name: The name of this ComponentResource.
        :type: str
        """
    ...
    def path(self):
        """
        Gets the path of this ComponentResource.

        :return: The path of this ComponentResource.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this ComponentResource.

        :param path: The path of this ComponentResource.
        :type: str
        """
    ...
    def is_directory(self):
        """
        Gets the is_directory of this ComponentResource.

        :return: The is_directory of this ComponentResource.
        :rtype: bool
        """
    ...
    def is_directory(self, is_directory):
        """
        Sets the is_directory of this ComponentResource.

        :param is_directory: The is_directory of this ComponentResource.
        :type: bool
        """
    ...
    def component(self):
        """
        Gets the component of this ComponentResource.

        :return: The component of this ComponentResource.
    ...
    def component(self, component):
        """
        Sets the component of this ComponentResource.

        :param component: The component of this ComponentResource.
    ...
    def href(self):
        """
        Gets the href of this ComponentResource.

        :return: The href of this ComponentResource.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ComponentResource.

        :param href: The href of this ComponentResource.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ComponentResource):
            return False
