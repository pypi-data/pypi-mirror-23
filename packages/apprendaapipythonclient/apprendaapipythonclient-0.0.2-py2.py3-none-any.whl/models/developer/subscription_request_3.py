...
class SubscriptionRequest3(object):
    """
    ...
    def __init__(self, group_ids=None):
        """
        SubscriptionRequest3 - a model defined in Swagger
    ...
    def group_ids(self):
        """
        Gets the group_ids of this SubscriptionRequest3.

        :return: The group_ids of this SubscriptionRequest3.
        :rtype: list[str]
        """
    ...
    def group_ids(self, group_ids):
        """
        Sets the group_ids of this SubscriptionRequest3.

        :param group_ids: The group_ids of this SubscriptionRequest3.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SubscriptionRequest3):
            return False
