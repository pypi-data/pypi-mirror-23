...
class SubscribedTenant(object):
    ...
    def __init__(self, tenant_alias=None, tenant_name=None, users=None):
        """
        SubscribedTenant - a model defined in Swagger
    ...
    def tenant_alias(self):
        """
        Gets the tenant_alias of this SubscribedTenant.

        :return: The tenant_alias of this SubscribedTenant.
        :rtype: str
        """
    ...
    def tenant_alias(self, tenant_alias):
        """
        Sets the tenant_alias of this SubscribedTenant.

        :param tenant_alias: The tenant_alias of this SubscribedTenant.
        :type: str
        """
    ...
    def tenant_name(self):
        """
        Gets the tenant_name of this SubscribedTenant.

        :return: The tenant_name of this SubscribedTenant.
        :rtype: str
        """
    ...
    def tenant_name(self, tenant_name):
        """
        Sets the tenant_name of this SubscribedTenant.

        :param tenant_name: The tenant_name of this SubscribedTenant.
        :type: str
        """
    ...
    def users(self):
        """
        Gets the users of this SubscribedTenant.

        :return: The users of this SubscribedTenant.
    ...
    def users(self, users):
        """
        Sets the users of this SubscribedTenant.

        :param users: The users of this SubscribedTenant.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SubscribedTenant):
            return False
