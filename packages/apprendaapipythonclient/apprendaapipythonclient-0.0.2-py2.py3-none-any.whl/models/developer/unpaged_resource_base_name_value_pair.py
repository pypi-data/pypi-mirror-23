...
class UnpagedResourceBaseNameValuePair(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseNameValuePair - a model defined in Swagger
        ...
        self.swagger_types = {
            'href': 'str',
            'items': 'list[Apiv1ComponentsEnvironmentVariables]'
        }
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseNameValuePair.

        :return: The href of this UnpagedResourceBaseNameValuePair.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseNameValuePair.

        :param href: The href of this UnpagedResourceBaseNameValuePair.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseNameValuePair.

        :return: The items of this UnpagedResourceBaseNameValuePair.
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseNameValuePair.

        :param items: The items of this UnpagedResourceBaseNameValuePair.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseNameValuePair):
            return False
