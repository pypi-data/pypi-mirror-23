...
class Apiv1versionsappAliasversionAliasreportCardsMessages(object):
    """
    ...
    def __init__(self, severity=None, message=None):
        """
        Apiv1versionsappAliasversionAliasreportCardsMessages - a model defined in Swagger
    ...
    def severity(self):
        """
        Gets the severity of this Apiv1versionsappAliasversionAliasreportCardsMessages.

        :return: The severity of this Apiv1versionsappAliasversionAliasreportCardsMessages.
        :rtype: str
        """
    ...
    def severity(self, severity):
        """
        Sets the severity of this Apiv1versionsappAliasversionAliasreportCardsMessages.

        :param severity: The severity of this Apiv1versionsappAliasversionAliasreportCardsMessages.
        :type: str
        """
    ...
    def message(self):
        """
        Gets the message of this Apiv1versionsappAliasversionAliasreportCardsMessages.

        :return: The message of this Apiv1versionsappAliasversionAliasreportCardsMessages.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this Apiv1versionsappAliasversionAliasreportCardsMessages.

        :param message: The message of this Apiv1versionsappAliasversionAliasreportCardsMessages.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Apiv1versionsappAliasversionAliasreportCardsMessages):
            return False
