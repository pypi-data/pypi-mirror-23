...
class Apiv1ComponentsEnvironmentVariables(object):
    """
    ...
    def __init__(self, name=None, value=None):
        """
        Apiv1ComponentsEnvironmentVariables - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this Apiv1ComponentsEnvironmentVariables.

        :return: The name of this Apiv1ComponentsEnvironmentVariables.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this Apiv1ComponentsEnvironmentVariables.

        :param name: The name of this Apiv1ComponentsEnvironmentVariables.
        :type: str
        """
    ...
    def value(self):
        """
        Gets the value of this Apiv1ComponentsEnvironmentVariables.

        :return: The value of this Apiv1ComponentsEnvironmentVariables.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this Apiv1ComponentsEnvironmentVariables.

        :param value: The value of this Apiv1ComponentsEnvironmentVariables.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Apiv1ComponentsEnvironmentVariables):
            return False
