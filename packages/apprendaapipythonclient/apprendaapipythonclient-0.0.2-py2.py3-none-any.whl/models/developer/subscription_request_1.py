...
class SubscriptionRequest1(object):
    """
    ...
    def __init__(self, user_identifiers=None):
        """
        SubscriptionRequest1 - a model defined in Swagger
    ...
    def user_identifiers(self):
        """
        Gets the user_identifiers of this SubscriptionRequest1.

        :return: The user_identifiers of this SubscriptionRequest1.
        :rtype: list[str]
        """
    ...
    def user_identifiers(self, user_identifiers):
        """
        Sets the user_identifiers of this SubscriptionRequest1.

        :param user_identifiers: The user_identifiers of this SubscriptionRequest1.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SubscriptionRequest1):
            return False
