...
class Ovr(object):
    ...
    def __init__(self, id=None, log_level=None, app_alias=None, app_version=None, email_recipients=None, override_type=None, tag=None, subscriber=None, user=None, message=None, notification=None, href=None):
        """
        Ovr - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this Ovr.

        :return: The id of this Ovr.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this Ovr.

        :param id: The id of this Ovr.
        :type: str
        """
    ...
    def log_level(self):
        """
        Gets the log_level of this Ovr.

        :return: The log_level of this Ovr.
        :rtype: int
        """
    ...
    def log_level(self, log_level):
        """
        Sets the log_level of this Ovr.

        :param log_level: The log_level of this Ovr.
        :type: int
        """
    ...
    def app_alias(self):
        """
        Gets the app_alias of this Ovr.

        :return: The app_alias of this Ovr.
        :rtype: str
        """
    ...
    def app_alias(self, app_alias):
        """
        Sets the app_alias of this Ovr.

        :param app_alias: The app_alias of this Ovr.
        :type: str
        """
    ...
    def app_version(self):
        """
        Gets the app_version of this Ovr.

        :return: The app_version of this Ovr.
        :rtype: str
        """
    ...
    def app_version(self, app_version):
        """
        Sets the app_version of this Ovr.

        :param app_version: The app_version of this Ovr.
        :type: str
        """
    ...
    def email_recipients(self):
        """
        Gets the email_recipients of this Ovr.

        :return: The email_recipients of this Ovr.
        :rtype: list[str]
        """
    ...
    def email_recipients(self, email_recipients):
        """
        Sets the email_recipients of this Ovr.

        :param email_recipients: The email_recipients of this Ovr.
        :type: list[str]
        """
    ...
    def override_type(self):
        """
        Gets the override_type of this Ovr.

        :return: The override_type of this Ovr.
        :rtype: str
        """
    ...
    def override_type(self, override_type):
        """
        Sets the override_type of this Ovr.

        :param override_type: The override_type of this Ovr.
        :type: str
        """
    ...
    def tag(self):
        """
        Gets the tag of this Ovr.

        :return: The tag of this Ovr.
        :rtype: str
        """
        return self._tag
    ...
    def tag(self, tag):
        """
        Sets the tag of this Ovr.

        :param tag: The tag of this Ovr.
        :type: str
        """
    ...
    def subscriber(self):
        """
        Gets the subscriber of this Ovr.

        :return: The subscriber of this Ovr.
    ...
    def subscriber(self, subscriber):
        """
        Sets the subscriber of this Ovr.

        :param subscriber: The subscriber of this Ovr.
    ...
    def user(self):
        """
        Gets the user of this Ovr.

        :return: The user of this Ovr.
    ...
    def user(self, user):
        """
        Sets the user of this Ovr.

        :param user: The user of this Ovr.
    ...
    def message(self):
        """
        Gets the message of this Ovr.

        :return: The message of this Ovr.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this Ovr.

        :param message: The message of this Ovr.
        :type: str
        """
    ...
    def notification(self):
        """
        Gets the notification of this Ovr.

        :return: The notification of this Ovr.
    ...
    def notification(self, notification):
        """
        Sets the notification of this Ovr.

        :param notification: The notification of this Ovr.
    ...
    def href(self):
        """
        Gets the href of this Ovr.

        :return: The href of this Ovr.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this Ovr.

        :param href: The href of this Ovr.
        :type: str
        """
