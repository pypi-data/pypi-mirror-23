...
class InlineResponse2007Cloud(object):
    """
    ...
    def __init__(self, name=None, href=None):
        """
        InlineResponse2007Cloud - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this InlineResponse2007Cloud.

        :return: The name of this InlineResponse2007Cloud.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this InlineResponse2007Cloud.

        :param name: The name of this InlineResponse2007Cloud.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this InlineResponse2007Cloud.

        :return: The href of this InlineResponse2007Cloud.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this InlineResponse2007Cloud.

        :param href: The href of this InlineResponse2007Cloud.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2007Cloud):
            return False
