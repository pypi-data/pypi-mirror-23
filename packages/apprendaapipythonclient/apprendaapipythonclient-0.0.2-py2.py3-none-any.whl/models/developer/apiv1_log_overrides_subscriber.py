...
class Apiv1LogOverridesSubscriber(object):
    """
    ...
    def __init__(self, alias=None, name=None):
        """
        Apiv1LogOverridesSubscriber - a model defined in Swagger
    ...
    def alias(self):
        """
        Gets the alias of this Apiv1LogOverridesSubscriber.

        :return: The alias of this Apiv1LogOverridesSubscriber.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this Apiv1LogOverridesSubscriber.

        :param alias: The alias of this Apiv1LogOverridesSubscriber.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this Apiv1LogOverridesSubscriber.

        :return: The name of this Apiv1LogOverridesSubscriber.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this Apiv1LogOverridesSubscriber.

        :param name: The name of this Apiv1LogOverridesSubscriber.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Apiv1LogOverridesSubscriber):
            return False
