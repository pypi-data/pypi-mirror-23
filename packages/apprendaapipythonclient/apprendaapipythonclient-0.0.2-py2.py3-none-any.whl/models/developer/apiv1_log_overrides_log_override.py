...
class Apiv1LogOverridesLogOverride(object):
    """
    ...
    def __init__(self, id=None, log_level=None, version_id=None, aggregate_repeated_logs=None, repeated_log_notification_frequency=None, override_email_recipients=None):
        """
        Apiv1LogOverridesLogOverride - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'override_email_recipients': 'list[Apiv1LogOverridesLogOverrideOverrideEmailRecipients]'
        }
    ...
    def id(self):
        """
        Gets the id of this Apiv1LogOverridesLogOverride.

        :return: The id of this Apiv1LogOverridesLogOverride.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this Apiv1LogOverridesLogOverride.

        :param id: The id of this Apiv1LogOverridesLogOverride.
        :type: str
        """
    ...
    def log_level(self):
        """
        Gets the log_level of this Apiv1LogOverridesLogOverride.

        :return: The log_level of this Apiv1LogOverridesLogOverride.
        :rtype: int
        """
    ...
    def log_level(self, log_level):
        """
        Sets the log_level of this Apiv1LogOverridesLogOverride.

        :param log_level: The log_level of this Apiv1LogOverridesLogOverride.
        :type: int
        """
    ...
    def version_id(self):
        """
        Gets the version_id of this Apiv1LogOverridesLogOverride.

        :return: The version_id of this Apiv1LogOverridesLogOverride.
        :rtype: str
        """
    ...
    def version_id(self, version_id):
        """
        Sets the version_id of this Apiv1LogOverridesLogOverride.

        :param version_id: The version_id of this Apiv1LogOverridesLogOverride.
        :type: str
        """
    ...
    def aggregate_repeated_logs(self):
        """
        Gets the aggregate_repeated_logs of this Apiv1LogOverridesLogOverride.

        :return: The aggregate_repeated_logs of this Apiv1LogOverridesLogOverride.
        :rtype: bool
        """
    ...
    def aggregate_repeated_logs(self, aggregate_repeated_logs):
        """
        Sets the aggregate_repeated_logs of this Apiv1LogOverridesLogOverride.

        :param aggregate_repeated_logs: The aggregate_repeated_logs of this Apiv1LogOverridesLogOverride.
        :type: bool
        """
    ...
    def repeated_log_notification_frequency(self):
        """
        Gets the repeated_log_notification_frequency of this Apiv1LogOverridesLogOverride.

        :return: The repeated_log_notification_frequency of this Apiv1LogOverridesLogOverride.
        :rtype: int
        """
    ...
    def repeated_log_notification_frequency(self, repeated_log_notification_frequency):
        """
        Sets the repeated_log_notification_frequency of this Apiv1LogOverridesLogOverride.

        :param repeated_log_notification_frequency: The repeated_log_notification_frequency of this Apiv1LogOverridesLogOverride.
        :type: int
        """
    ...
    def override_email_recipients(self):
        """
        Gets the override_email_recipients of this Apiv1LogOverridesLogOverride.

        :return: The override_email_recipients of this Apiv1LogOverridesLogOverride.
        :rtype: list[Apiv1LogOverridesLogOverrideOverrideEmailRecipients]
        """
    ...
    def override_email_recipients(self, override_email_recipients):
        """
        Sets the override_email_recipients of this Apiv1LogOverridesLogOverride.

        :param override_email_recipients: The override_email_recipients of this Apiv1LogOverridesLogOverride.
        :type: list[Apiv1LogOverridesLogOverrideOverrideEmailRecipients]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Apiv1LogOverridesLogOverride):
            return False
