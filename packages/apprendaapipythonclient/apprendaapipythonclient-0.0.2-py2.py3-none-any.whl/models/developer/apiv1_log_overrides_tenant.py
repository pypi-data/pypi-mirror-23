...
class Apiv1LogOverridesTenant(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, id=None, alias=None, name=None):
        """
        Apiv1LogOverridesTenant - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this Apiv1LogOverridesTenant.

        :return: The id of this Apiv1LogOverridesTenant.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this Apiv1LogOverridesTenant.

        :param id: The id of this Apiv1LogOverridesTenant.
        :type: str
        """
    ...
    def alias(self):
        """
        Gets the alias of this Apiv1LogOverridesTenant.

        :return: The alias of this Apiv1LogOverridesTenant.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this Apiv1LogOverridesTenant.

        :param alias: The alias of this Apiv1LogOverridesTenant.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this Apiv1LogOverridesTenant.

        :return: The name of this Apiv1LogOverridesTenant.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this Apiv1LogOverridesTenant.

        :param name: The name of this Apiv1LogOverridesTenant.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Apiv1LogOverridesTenant):
            return False
