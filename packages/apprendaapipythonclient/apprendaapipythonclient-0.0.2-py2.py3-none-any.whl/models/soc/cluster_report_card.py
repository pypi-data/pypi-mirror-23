...
class ClusterReportCard(object):
    """
    ...
    def __init__(self, groups=None):
        """
        ClusterReportCard - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'groups': 'list[InlineResponse202Groups]'
        }
    ...
    def groups(self):
        """
        Gets the groups of this ClusterReportCard.

        :return: The groups of this ClusterReportCard.
        :rtype: list[InlineResponse202Groups]
        """
        return self._groups
    ...
    def groups(self, groups):
        """
        Sets the groups of this ClusterReportCard.

        :param groups: The groups of this ClusterReportCard.
        :type: list[InlineResponse202Groups]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ClusterReportCard):
            return False
