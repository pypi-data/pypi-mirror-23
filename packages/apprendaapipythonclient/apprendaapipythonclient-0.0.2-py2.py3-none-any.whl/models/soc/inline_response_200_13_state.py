...
class InlineResponse20013State(object):
    """
    ...
    def __init__(self, state=None, reason=None):
        """
        InlineResponse20013State - a model defined in Swagger
    ...
    def state(self):
        """
        Gets the state of this InlineResponse20013State.
        State the server should be placed into

        :return: The state of this InlineResponse20013State.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """
        Sets the state of this InlineResponse20013State.
        State the server should be placed into

        :param state: The state of this InlineResponse20013State.
        :type: str
        """
        allowed_values = ["Online", "Reserved", "Maintenance"]
    ...
    def reason(self):
        """
        Gets the reason of this InlineResponse20013State.
        Brief description of why the server is in a given state

        :return: The reason of this InlineResponse20013State.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """
        Sets the reason of this InlineResponse20013State.
        Brief description of why the server is in a given state

        :param reason: The reason of this InlineResponse20013State.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse20013State):
            return False
