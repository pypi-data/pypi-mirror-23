...
class Setting1(object):
    ...
    def __init__(self, name=None, value=None, is_encrypted=None, is_read_only=None, href=None):
        """
        Setting1 - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this Setting1.

        :return: The name of this Setting1.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this Setting1.

        :param name: The name of this Setting1.
        :type: str
        """
    ...
    def value(self):
        """
        Gets the value of this Setting1.

        :return: The value of this Setting1.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this Setting1.

        :param value: The value of this Setting1.
        :type: str
        """
    ...
    def is_encrypted(self):
        """
        Gets the is_encrypted of this Setting1.

        :return: The is_encrypted of this Setting1.
        :rtype: bool
        """
    ...
    def is_encrypted(self, is_encrypted):
        """
        Sets the is_encrypted of this Setting1.

        :param is_encrypted: The is_encrypted of this Setting1.
        :type: bool
        """
    ...
    def is_read_only(self):
        """
        Gets the is_read_only of this Setting1.

        :return: The is_read_only of this Setting1.
        :rtype: bool
        """
    ...
    def is_read_only(self, is_read_only):
        """
        Sets the is_read_only of this Setting1.

        :param is_read_only: The is_read_only of this Setting1.
        :type: bool
        """
    ...
    def href(self):
        """
        Gets the href of this Setting1.

        :return: The href of this Setting1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this Setting1.

        :param href: The href of this Setting1.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Setting1):
            return False
