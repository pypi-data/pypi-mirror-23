...
class UnpagedResourceBaseWorkload(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseWorkload - a model defined in Swagger
        ...
        self.swagger_types = {
            'href': 'str',
            'items': 'list[InlineResponse2009Items]'
        }
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseWorkload.

        :return: The href of this UnpagedResourceBaseWorkload.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseWorkload.

        :param href: The href of this UnpagedResourceBaseWorkload.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseWorkload.

        :return: The items of this UnpagedResourceBaseWorkload.
        :rtype: list[InlineResponse2009Items]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseWorkload.

        :param items: The items of this UnpagedResourceBaseWorkload.
        :type: list[InlineResponse2009Items]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseWorkload):
            return False
