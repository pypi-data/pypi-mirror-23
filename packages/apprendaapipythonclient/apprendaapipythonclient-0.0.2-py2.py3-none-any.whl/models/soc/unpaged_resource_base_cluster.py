...
class UnpagedResourceBaseCluster(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseCluster - a model defined in Swagger
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseCluster.

        :return: The href of this UnpagedResourceBaseCluster.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseCluster.

        :param href: The href of this UnpagedResourceBaseCluster.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseCluster.

        :return: The items of this UnpagedResourceBaseCluster.
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseCluster.

        :param items: The items of this UnpagedResourceBaseCluster.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseCluster):
            return False
