...
class UnpagedResourceBasePlatformDatabase(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBasePlatformDatabase - a model defined in Swagger
        ...
        self.swagger_types = {
            'href': 'str',
            'items': 'list[InlineResponse20016Items]'
        }
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBasePlatformDatabase.

        :return: The href of this UnpagedResourceBasePlatformDatabase.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBasePlatformDatabase.

        :param href: The href of this UnpagedResourceBasePlatformDatabase.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBasePlatformDatabase.

        :return: The items of this UnpagedResourceBasePlatformDatabase.
        :rtype: list[InlineResponse20016Items]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBasePlatformDatabase.

        :param items: The items of this UnpagedResourceBasePlatformDatabase.
        :type: list[InlineResponse20016Items]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBasePlatformDatabase):
            return False
