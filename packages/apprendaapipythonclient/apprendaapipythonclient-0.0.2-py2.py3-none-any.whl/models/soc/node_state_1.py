...
class NodeState1(object):
    ...
    def __init__(self, state=None, reason=None):
        """
        NodeState1 - a model defined in Swagger
    ...
    def state(self):
        """
        Gets the state of this NodeState1.
        State the server should be placed into

        :return: The state of this NodeState1.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """
        Sets the state of this NodeState1.
        State the server should be placed into

        :param state: The state of this NodeState1.
        :type: str
        """
    ...
    def reason(self):
        """
        Gets the reason of this NodeState1.
        Brief description of why the server is in a given state

        :return: The reason of this NodeState1.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """
        Sets the reason of this NodeState1.
        Brief description of why the server is in a given state

        :param reason: The reason of this NodeState1.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NodeState1):
            return False
