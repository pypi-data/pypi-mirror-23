...
class UnpagedResourceBaseCloud(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseCloud - a model defined in Swagger
        ...
        self.swagger_types = {
            'href': 'str',
            'items': 'list[InlineResponse20010Items]'
        }
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseCloud.

        :return: The href of this UnpagedResourceBaseCloud.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseCloud.

        :param href: The href of this UnpagedResourceBaseCloud.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseCloud.

        :return: The items of this UnpagedResourceBaseCloud.
        :rtype: list[InlineResponse20010Items]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseCloud.

        :param items: The items of this UnpagedResourceBaseCloud.
        :type: list[InlineResponse20010Items]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseCloud):
            return False
