...
class InlineResponse20011(object):
    ...
    def state(self):
        """
        Gets the state of this InlineResponse20011.

        :return: The state of this InlineResponse20011.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """
        Sets the state of this InlineResponse20011.

        :param state: The state of this InlineResponse20011.
        :type: str
        """
        if state is None:
    ...
    def reason(self):
        """
        Gets the reason of this InlineResponse20011.

        :return: The reason of this InlineResponse20011.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """
        Sets the reason of this InlineResponse20011.

        :param reason: The reason of this InlineResponse20011.
        :type: str
        """
        if reason is None:
