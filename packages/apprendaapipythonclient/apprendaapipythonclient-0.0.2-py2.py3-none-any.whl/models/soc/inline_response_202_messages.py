...
class InlineResponse202Messages(object):
    """
    ...
    def __init__(self, level=None, message=None):
        """
        InlineResponse202Messages - a model defined in Swagger
    ...
    def level(self):
        """
        Gets the level of this InlineResponse202Messages.

        :return: The level of this InlineResponse202Messages.
        :rtype: str
        """
        return self._level
    ...
    def level(self, level):
        """
        Sets the level of this InlineResponse202Messages.

        :param level: The level of this InlineResponse202Messages.
        :type: str
        """
    ...
    def message(self):
        """
        Gets the message of this InlineResponse202Messages.

        :return: The message of this InlineResponse202Messages.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this InlineResponse202Messages.

        :param message: The message of this InlineResponse202Messages.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse202Messages):
            return False
