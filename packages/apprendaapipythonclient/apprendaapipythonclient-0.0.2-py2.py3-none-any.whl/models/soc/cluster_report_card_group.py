...
class ClusterReportCardGroup(object):
    """
    ...
    def __init__(self, name=None, sections=None):
        """
        ClusterReportCardGroup - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this ClusterReportCardGroup.

        :return: The name of this ClusterReportCardGroup.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ClusterReportCardGroup.

        :param name: The name of this ClusterReportCardGroup.
        :type: str
        """
    ...
    def sections(self):
        """
        Gets the sections of this ClusterReportCardGroup.

        :return: The sections of this ClusterReportCardGroup.
    ...
    def sections(self, sections):
        """
        Sets the sections of this ClusterReportCardGroup.

        :param sections: The sections of this ClusterReportCardGroup.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ClusterReportCardGroup):
            return False
