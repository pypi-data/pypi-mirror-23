...
class InlineResponse20012(object):
    ...
    """
    def __init__(self, is_transitioning=None):
        """
    ...
    def is_transitioning(self):
        """
        Gets the is_transitioning of this InlineResponse20012.

        :return: The is_transitioning of this InlineResponse20012.
        :rtype: bool
        """
    ...
    def is_transitioning(self, is_transitioning):
        """
        Sets the is_transitioning of this InlineResponse20012.

        :param is_transitioning: The is_transitioning of this InlineResponse20012.
        :type: bool
        """
        if is_transitioning is None:
            raise ValueError("Invalid value for `is_transitioning`, must not be `None`")
