...
class InlineResponse202Groups(object):
    """
    ...
    def __init__(self, name=None, sections=None):
        """
        InlineResponse202Groups - a model defined in Swagger
        ...
        self.swagger_types = {
            'name': 'str',
            'sections': 'list[InlineResponse202Sections]'
        }
    ...
    def name(self):
        """
        Gets the name of this InlineResponse202Groups.

        :return: The name of this InlineResponse202Groups.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this InlineResponse202Groups.

        :param name: The name of this InlineResponse202Groups.
        :type: str
        """
    ...
    def sections(self):
        """
        Gets the sections of this InlineResponse202Groups.

        :return: The sections of this InlineResponse202Groups.
        :rtype: list[InlineResponse202Sections]
        """
    ...
    def sections(self, sections):
        """
        Sets the sections of this InlineResponse202Groups.

        :param sections: The sections of this InlineResponse202Groups.
        :type: list[InlineResponse202Sections]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse202Groups):
            return False
