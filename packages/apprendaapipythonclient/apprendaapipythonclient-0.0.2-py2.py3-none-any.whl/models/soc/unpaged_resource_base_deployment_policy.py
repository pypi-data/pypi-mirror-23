...
class UnpagedResourceBaseDeploymentPolicy(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, items=None, href=None):
        """
        UnpagedResourceBaseDeploymentPolicy - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'items': 'list[InlineResponse2008Items]',
            'href': 'str'
        }
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseDeploymentPolicy.

        :return: The items of this UnpagedResourceBaseDeploymentPolicy.
        :rtype: list[InlineResponse2008Items]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseDeploymentPolicy.

        :param items: The items of this UnpagedResourceBaseDeploymentPolicy.
        :type: list[InlineResponse2008Items]
        """
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseDeploymentPolicy.

        :return: The href of this UnpagedResourceBaseDeploymentPolicy.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseDeploymentPolicy.

        :param href: The href of this UnpagedResourceBaseDeploymentPolicy.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseDeploymentPolicy):
            return False
