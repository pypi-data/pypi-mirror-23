...
class ContextApi(object):
    ...
    def context_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.context_get(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str return_address:
        ...
        if kwargs.get('callback'):
            return self.context_get_with_http_info(**kwargs)
        else:
            (data) = self.context_get_with_http_info(**kwargs)
            return data

    def context_get_with_http_info(self, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.context_get_with_http_info(callback=callback_function)
        ...
        resource_path = '/api/v1/Context'.replace('{format}', 'json')
        path_params = {}

        query_params = {}
        if 'return_address' in params:
            query_params['returnAddress'] = params['return_address']
    ...
    def context_get_by_sub_alias(self, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.context_get_by_sub_alias(alias, sub_alias, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.context_get_by_sub_alias_with_http_info(alias, sub_alias, **kwargs)
        else:
            (data) = self.context_get_by_sub_alias_with_http_info(alias, sub_alias, **kwargs)
            return data

    def context_get_by_sub_alias_with_http_info(self, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.context_get_by_sub_alias_with_http_info(alias, sub_alias, callback=callback_function)
        ...
        all_params = ['alias', 'sub_alias', 'return_address']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method context_get_by_sub_alias" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'alias' is set
        if ('alias' not in params) or (params['alias'] is None):
            raise ValueError("Missing the required parameter `alias` when calling `context_get_by_sub_alias`")
        # verify the required parameter 'sub_alias' is set
        if ('sub_alias' not in params) or (params['sub_alias'] is None):
            raise ValueError("Missing the required parameter `sub_alias` when calling `context_get_by_sub_alias`")


        collection_formats = {}

        resource_path = '/api/v1/Context/{alias}/{subAlias}'.replace('{format}', 'json')
        path_params = {}
        if 'alias' in params:
