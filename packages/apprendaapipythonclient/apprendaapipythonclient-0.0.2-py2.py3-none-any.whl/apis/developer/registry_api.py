...
class RegistryApi(object):
    ...
    def registry_get(self, **kwargs):
        ...
        :return: list[InlineResponse2007Cloud]
    ...
    def registry_get_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='list[InlineResponse2007Cloud]',
    ...
    def registry_get_by_alias(self, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.registry_get_by_alias(alias, sub_alias, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.registry_get_by_alias_with_http_info(alias, sub_alias, **kwargs)
        else:
            (data) = self.registry_get_by_alias_with_http_info(alias, sub_alias, **kwargs)
            return data

    def registry_get_by_alias_with_http_info(self, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.registry_get_by_alias_with_http_info(alias, sub_alias, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method registry_get_by_alias" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'alias' is set
        if ('alias' not in params) or (params['alias'] is None):
            raise ValueError("Missing the required parameter `alias` when calling `registry_get_by_alias`")
        # verify the required parameter 'sub_alias' is set
        if ('sub_alias' not in params) or (params['sub_alias'] is None):
            raise ValueError("Missing the required parameter `sub_alias` when calling `registry_get_by_alias`")


        collection_formats = {}

        resource_path = '/api/v1/Registry/{alias}/{subAlias}'.replace('{format}', 'json')
        path_params = {}
        if 'alias' in params:
    ...
    def registry_get_by_id(self, id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.registry_get_by_id(id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: (required)
        :return: InlineResponse2007Cloud
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.registry_get_by_id_with_http_info(id, **kwargs)
        else:
            (data) = self.registry_get_by_id_with_http_info(id, **kwargs)
            return data

    def registry_get_by_id_with_http_info(self, id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.registry_get_by_id_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method registry_get_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `registry_get_by_id`")


        collection_formats = {}

        resource_path = '/api/v1/Registry/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='InlineResponse2007Cloud',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
