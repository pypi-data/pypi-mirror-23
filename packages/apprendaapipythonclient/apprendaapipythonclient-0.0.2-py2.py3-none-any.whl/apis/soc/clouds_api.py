...
class CloudsApi(object):
    ...
    def clouds_get_by_id_p_ublic(self, id, **kwargs):
        """
        Get cloud
        **Requires Platform version 6.7.0 or later.**   Retrieve a cloud by its ID. 
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.clouds_get_by_id_p_ublic(id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: (required)
        :return: InlineResponse20010Items
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.clouds_get_by_id_p_ublic_with_http_info(id, **kwargs)
        else:
            (data) = self.clouds_get_by_id_p_ublic_with_http_info(id, **kwargs)
            return data

    def clouds_get_by_id_p_ublic_with_http_info(self, id, **kwargs):
        """
        Get cloud
        **Requires Platform version 6.7.0 or later.**   Retrieve a cloud by its ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.clouds_get_by_id_p_ublic_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method clouds_get_by_id_p_ublic" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `clouds_get_by_id_p_ublic`")
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='InlineResponse20010Items',
    ...
    def clouds_get_public(self, **kwargs):
        """
        Get clouds
        **Requires Platform version 6.7.0 or later.**   Retrieve all clouds in the Platform. 
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.clouds_get_public(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.clouds_get_public_with_http_info(**kwargs)
        else:
            (data) = self.clouds_get_public_with_http_info(**kwargs)
            return data

    def clouds_get_public_with_http_info(self, **kwargs):
        """
        Get clouds
        **Requires Platform version 6.7.0 or later.**   Retrieve all clouds in the Platform. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.clouds_get_public_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method clouds_get_public" % key
                )
            params[key] = val
        del params['kwargs']
