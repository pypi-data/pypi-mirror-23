...
from src.apis.soc import AddOnsApi
from src.apis.soc import ApplicationsApi
from src.apis.soc import CloudsApi
from src.apis.soc import CustomPropertiesApi
from src.apis.soc import HostsApi
from src.apis.soc import NodesApi
from src.apis.soc import RegistryApi
from src.models.soc.registry_setting import RegistrySetting
...
class ApprendaSOCClient(ApprendaAPIClient):
    ...
    def __init__(self, host, username, password):
        super(ApprendaSOCClient, self).__init__(host, "soc", username, password)
