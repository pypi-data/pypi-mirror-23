...
class RolesApi(object):
    ...
    def api_v1_roles_post(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Role body: Array of role definitions to add
        :return: Role
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def api_v1_roles_post_with_http_info(self, **kwargs):
        ...
        res = self.api_client.call_api(resource_path, 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def api_v1_roles_role_id_put(self, role_id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str role_id: Required. Unique Platform assigned id of a role (required)
        :param Role body: Array of role definitions to update. All fields should be passed in every request.
        :return: Role
                 If the method is called asynchronously,
                 returns the request thread.
        """
