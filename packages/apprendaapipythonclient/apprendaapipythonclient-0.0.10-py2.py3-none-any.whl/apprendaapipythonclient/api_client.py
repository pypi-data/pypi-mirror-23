...
from apprendaapipythonclient.rest import ApiException, RESTClientObject
from apprendaapipythonclient import models
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                if self.portal == "soc":
                    klass = getattr(models.soc, klass)
                elif self.portal == "developer":
                    klass = getattr(models.developer, klass)
                elif self.portal == "account":
                    klass = getattr(models.account, klass)
