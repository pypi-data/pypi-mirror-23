...
class OverrideTenantInfoDTO(object):
    """
    ...
    def __init__(self, id=None, alias=None, name=None):
        """
        OverrideTenantInfoDTO - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this OverrideTenantInfoDTO.

        :return: The id of this OverrideTenantInfoDTO.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this OverrideTenantInfoDTO.

        :param id: The id of this OverrideTenantInfoDTO.
        :type: str
        """
    ...
    def alias(self):
        """
        Gets the alias of this OverrideTenantInfoDTO.

        :return: The alias of this OverrideTenantInfoDTO.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this OverrideTenantInfoDTO.

        :param alias: The alias of this OverrideTenantInfoDTO.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this OverrideTenantInfoDTO.

        :return: The name of this OverrideTenantInfoDTO.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this OverrideTenantInfoDTO.

        :param name: The name of this OverrideTenantInfoDTO.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, OverrideTenantInfoDTO):
            return False
