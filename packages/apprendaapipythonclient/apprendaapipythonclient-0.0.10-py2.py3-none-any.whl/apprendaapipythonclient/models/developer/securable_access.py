...
class SecurableAccess(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, name=None, user_is_authorized=None, href=None):
        """
        SecurableAccess - a model defined in Swagger
        ...
        self._name = name
        self._user_is_authorized = user_is_authorized
        self._href = href

    @property
    def name(self):
        """
        Gets the name of this SecurableAccess.

        :return: The name of this SecurableAccess.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this SecurableAccess.

        :param name: The name of this SecurableAccess.
        :type: str
        """
    ...
    def user_is_authorized(self):
        """
        Gets the user_is_authorized of this SecurableAccess.

        :return: The user_is_authorized of this SecurableAccess.
        :rtype: bool
        """
        return self._user_is_authorized

    @user_is_authorized.setter
    def user_is_authorized(self, user_is_authorized):
        """
        Sets the user_is_authorized of this SecurableAccess.

        :param user_is_authorized: The user_is_authorized of this SecurableAccess.
        :type: bool
        """
    ...
    def href(self):
        """
        Gets the href of this SecurableAccess.

        :return: The href of this SecurableAccess.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this SecurableAccess.

        :param href: The href of this SecurableAccess.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SecurableAccess):
            return False
