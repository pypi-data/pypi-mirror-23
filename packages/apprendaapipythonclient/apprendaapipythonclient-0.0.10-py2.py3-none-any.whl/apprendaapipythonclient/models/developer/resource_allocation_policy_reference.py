...
class ResourceAllocationPolicyReference(object):
    """
    ...
    def __init__(self, name=None, href=None):
        """
        ResourceAllocationPolicyReference - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this ResourceAllocationPolicyReference.

        :return: The name of this ResourceAllocationPolicyReference.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ResourceAllocationPolicyReference.

        :param name: The name of this ResourceAllocationPolicyReference.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this ResourceAllocationPolicyReference.

        :return: The href of this ResourceAllocationPolicyReference.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ResourceAllocationPolicyReference.

        :param href: The href of this ResourceAllocationPolicyReference.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ResourceAllocationPolicyReference):
            return False
