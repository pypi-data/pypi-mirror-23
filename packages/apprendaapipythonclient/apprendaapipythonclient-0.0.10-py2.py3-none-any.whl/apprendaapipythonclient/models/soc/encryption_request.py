...
class EncryptionRequest(object):
    ...
    """
    def __init__(self, value=None, intended_use=None):
        """
        EncryptionRequest - a model defined in Swagger
    ...
    def value(self):
        """
        Gets the value of this EncryptionRequest.

        :return: The value of this EncryptionRequest.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this EncryptionRequest.

        :param value: The value of this EncryptionRequest.
        :type: str
        """
        if value is None:
    ...
    def intended_use(self):
        """
        Gets the intended_use of this EncryptionRequest.

        :return: The intended_use of this EncryptionRequest.
        :rtype: str
        """
    ...
    def intended_use(self, intended_use):
        """
        Sets the intended_use of this EncryptionRequest.

        :param intended_use: The intended_use of this EncryptionRequest.
        :type: str
        """
        allowed_values = ["CoreDatabase", "CoreDatabaseJava"]
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EncryptionRequest):
            return False
