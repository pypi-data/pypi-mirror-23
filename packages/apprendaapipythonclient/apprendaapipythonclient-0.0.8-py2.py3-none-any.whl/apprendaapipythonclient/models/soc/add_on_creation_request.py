...
class AddOnCreationRequest(object):
    """
    ...
    def __init__(self, alias=None, contents=None):
        """
        AddOnCreationRequest - a model defined in Swagger
    ...
    def alias(self):
        """
        Gets the alias of this AddOnCreationRequest.

        :return: The alias of this AddOnCreationRequest.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this AddOnCreationRequest.

        :param alias: The alias of this AddOnCreationRequest.
        :type: str
        """
        if alias is None:
    ...
    def contents(self):
        """
        Gets the contents of this AddOnCreationRequest.

        :return: The contents of this AddOnCreationRequest.
        :rtype: str
        """
    ...
    def contents(self, contents):
        """
        Sets the contents of this AddOnCreationRequest.

        :param contents: The contents of this AddOnCreationRequest.
        :type: str
        """
        if contents is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AddOnCreationRequest):
            return False
