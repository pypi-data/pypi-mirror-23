...
class UnpagedResourceBaseBootstrapPolicy(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseBootstrapPolicy - a model defined in Swagger
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseBootstrapPolicy.

        :return: The href of this UnpagedResourceBaseBootstrapPolicy.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseBootstrapPolicy.

        :param href: The href of this UnpagedResourceBaseBootstrapPolicy.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseBootstrapPolicy.

        :return: The items of this UnpagedResourceBaseBootstrapPolicy.
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseBootstrapPolicy.

        :param items: The items of this UnpagedResourceBaseBootstrapPolicy.
        :type: list[Component]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseBootstrapPolicy):
            return False
