...
class ClusterReportCardMessage(object):
    """
    ...
    def __init__(self, level=None, message=None):
        """
        ClusterReportCardMessage - a model defined in Swagger
    ...
    def level(self):
        """
        Gets the level of this ClusterReportCardMessage.

        :return: The level of this ClusterReportCardMessage.
        :rtype: str
        """
        return self._level
    ...
    def level(self, level):
        """
        Sets the level of this ClusterReportCardMessage.

        :param level: The level of this ClusterReportCardMessage.
        :type: str
        """
    ...
    def message(self):
        """
        Gets the message of this ClusterReportCardMessage.

        :return: The message of this ClusterReportCardMessage.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this ClusterReportCardMessage.

        :param message: The message of this ClusterReportCardMessage.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ClusterReportCardMessage):
            return False
