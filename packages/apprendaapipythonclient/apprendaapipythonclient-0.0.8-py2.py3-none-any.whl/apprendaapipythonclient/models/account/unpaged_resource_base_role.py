...
class UnpagedResourceBaseRole(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseRole - a model defined in Swagger
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseRole.

        :return: The href of this UnpagedResourceBaseRole.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseRole.

        :param href: The href of this UnpagedResourceBaseRole.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseRole.

        :return: The items of this UnpagedResourceBaseRole.
        :rtype: list[Role]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseRole.

        :param items: The items of this UnpagedResourceBaseRole.
        :type: list[Role]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseRole):
            return False
