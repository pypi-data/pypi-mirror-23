...
class AddOnContainer(object):
    ...
    def __init__(self, available_add_ons=None, deployed_add_ons=None, href=None):
        """
        AddOnContainer - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'available_add_ons': 'list[AddOn]',
            'deployed_add_ons': 'list[DeployedAddOn]',
            'href': 'str'
        }
    ...
    def available_add_ons(self):
        """
        Gets the available_add_ons of this AddOnContainer.

        :return: The available_add_ons of this AddOnContainer.
        :rtype: list[AddOn]
        """
    ...
    def available_add_ons(self, available_add_ons):
        """
        Sets the available_add_ons of this AddOnContainer.

        :param available_add_ons: The available_add_ons of this AddOnContainer.
        :type: list[AddOn]
        """
    ...
    def deployed_add_ons(self):
        """
        Gets the deployed_add_ons of this AddOnContainer.

        :return: The deployed_add_ons of this AddOnContainer.
        :rtype: list[DeployedAddOn]
        """
    ...
    def deployed_add_ons(self, deployed_add_ons):
        """
        Sets the deployed_add_ons of this AddOnContainer.

        :param deployed_add_ons: The deployed_add_ons of this AddOnContainer.
        :type: list[DeployedAddOn]
        """
    ...
    def href(self):
        """
        Gets the href of this AddOnContainer.

        :return: The href of this AddOnContainer.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this AddOnContainer.

        :param href: The href of this AddOnContainer.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AddOnContainer):
            return False
