...
class RemoveUserAuthZSubscriptionRequest(object):
    """
    ...
    def __init__(self, user_identifiers=None):
        """
        RemoveUserAuthZSubscriptionRequest - a model defined in Swagger
    ...
    def user_identifiers(self):
        """
        Gets the user_identifiers of this RemoveUserAuthZSubscriptionRequest.

        :return: The user_identifiers of this RemoveUserAuthZSubscriptionRequest.
        :rtype: list[str]
        """
    ...
    def user_identifiers(self, user_identifiers):
        """
        Sets the user_identifiers of this RemoveUserAuthZSubscriptionRequest.

        :param user_identifiers: The user_identifiers of this RemoveUserAuthZSubscriptionRequest.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RemoveUserAuthZSubscriptionRequest):
            return False
