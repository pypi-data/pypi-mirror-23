...
class LogOverrideEmailRecipientDTO(object):
    """
    ...
    def __init__(self, address=None):
        """
        LogOverrideEmailRecipientDTO - a model defined in Swagger
    ...
    def address(self):
        """
        Gets the address of this LogOverrideEmailRecipientDTO.

        :return: The address of this LogOverrideEmailRecipientDTO.
        :rtype: str
        """
    ...
    def address(self, address):
        """
        Sets the address of this LogOverrideEmailRecipientDTO.

        :param address: The address of this LogOverrideEmailRecipientDTO.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LogOverrideEmailRecipientDTO):
            return False
