...
class UnpagedResourceBaseCustomPropertyValue(object):
    """
    ...
    def __init__(self, href=None, items=None):
        """
        UnpagedResourceBaseCustomPropertyValue - a model defined in Swagger
        ...
        self.swagger_types = {
            'href': 'str',
            'items': 'list[CustomPropertyValue]'
        }
    ...
    def href(self):
        """
        Gets the href of this UnpagedResourceBaseCustomPropertyValue.

        :return: The href of this UnpagedResourceBaseCustomPropertyValue.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this UnpagedResourceBaseCustomPropertyValue.

        :param href: The href of this UnpagedResourceBaseCustomPropertyValue.
        :type: str
        """
    ...
    def items(self):
        """
        Gets the items of this UnpagedResourceBaseCustomPropertyValue.

        :return: The items of this UnpagedResourceBaseCustomPropertyValue.
        :rtype: list[CustomPropertyValue]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UnpagedResourceBaseCustomPropertyValue.

        :param items: The items of this UnpagedResourceBaseCustomPropertyValue.
        :type: list[CustomPropertyValue]
        """
        if items is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UnpagedResourceBaseCustomPropertyValue):
            return False
