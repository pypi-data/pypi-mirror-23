...
class CacheNodesApi(object):
    ...
    def cache_nodes_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cache_nodes_get(id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.cache_nodes_get_with_http_info(id, **kwargs)
        else:
            (data) = self.cache_nodes_get_with_http_info(id, **kwargs)
            return data

    def cache_nodes_get_with_http_info(self, id, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cache_nodes_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method cache_nodes_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cache_nodes_get`")


        collection_formats = {}

        resource_path = '/api/v1/CacheNodes/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def cache_nodes_get_by_sub_alias(self, id, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cache_nodes_get_by_sub_alias(id, alias, sub_alias, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.cache_nodes_get_by_sub_alias_with_http_info(id, alias, sub_alias, **kwargs)
        else:
            (data) = self.cache_nodes_get_by_sub_alias_with_http_info(id, alias, sub_alias, **kwargs)
            return data

    def cache_nodes_get_by_sub_alias_with_http_info(self, id, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cache_nodes_get_by_sub_alias_with_http_info(id, alias, sub_alias, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cache_nodes_get_by_sub_alias" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cache_nodes_get_by_sub_alias`")
        # verify the required parameter 'alias' is set
        if ('alias' not in params) or (params['alias'] is None):
            raise ValueError("Missing the required parameter `alias` when calling `cache_nodes_get_by_sub_alias`")
        # verify the required parameter 'sub_alias' is set
        if ('sub_alias' not in params) or (params['sub_alias'] is None):
            raise ValueError("Missing the required parameter `sub_alias` when calling `cache_nodes_get_by_sub_alias`")


        collection_formats = {}

        resource_path = '/api/v1/CacheNodes/{alias}/{subAlias}'.replace('{format}', 'json')
        path_params = {}
        if 'alias' in params:
