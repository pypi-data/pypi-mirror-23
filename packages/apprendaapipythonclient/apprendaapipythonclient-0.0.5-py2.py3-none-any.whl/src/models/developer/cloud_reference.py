...
class CloudReference(object):
    ...
    def __init__(self, name=None, href=None):
        """
        CloudReference - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this CloudReference.

        :return: The name of this CloudReference.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this CloudReference.

        :param name: The name of this CloudReference.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this CloudReference.

        :return: The href of this CloudReference.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this CloudReference.

        :param href: The href of this CloudReference.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CloudReference):
            return False
