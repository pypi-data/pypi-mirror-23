...
class DeployedAddOnReference(object):
    """
    ...
    def __init__(self, instance_alias=None, href=None):
        """
        DeployedAddOnReference - a model defined in Swagger
    ...
    def instance_alias(self):
        """
        Gets the instance_alias of this DeployedAddOnReference.

        :return: The instance_alias of this DeployedAddOnReference.
        :rtype: str
        """
    ...
    def instance_alias(self, instance_alias):
        """
        Sets the instance_alias of this DeployedAddOnReference.

        :param instance_alias: The instance_alias of this DeployedAddOnReference.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this DeployedAddOnReference.

        :return: The href of this DeployedAddOnReference.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this DeployedAddOnReference.

        :param href: The href of this DeployedAddOnReference.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DeployedAddOnReference):
            return False
