...
class JavaRuntimeApi(object):
    ...
    def java_runtime_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.java_runtime_get(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :return: list[JavaRuntimeReturn]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.java_runtime_get_with_http_info(**kwargs)
        else:
            (data) = self.java_runtime_get_with_http_info(**kwargs)
            return data

    def java_runtime_get_with_http_info(self, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.java_runtime_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method java_runtime_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v1/JavaRuntime'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='list[JavaRuntimeReturn]',
    ...
    def java_runtime_get_by_sub_alias(self, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.java_runtime_get_by_sub_alias(alias, sub_alias, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.java_runtime_get_by_sub_alias_with_http_info(alias, sub_alias, **kwargs)
        else:
            (data) = self.java_runtime_get_by_sub_alias_with_http_info(alias, sub_alias, **kwargs)
            return data

    def java_runtime_get_by_sub_alias_with_http_info(self, alias, sub_alias, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.java_runtime_get_by_sub_alias_with_http_info(alias, sub_alias, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method java_runtime_get_by_sub_alias" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'alias' is set
        if ('alias' not in params) or (params['alias'] is None):
            raise ValueError("Missing the required parameter `alias` when calling `java_runtime_get_by_sub_alias`")
        # verify the required parameter 'sub_alias' is set
        if ('sub_alias' not in params) or (params['sub_alias'] is None):
            raise ValueError("Missing the required parameter `sub_alias` when calling `java_runtime_get_by_sub_alias`")


        collection_formats = {}

        resource_path = '/api/v1/JavaRuntime/{alias}/{subAlias}'.replace('{format}', 'json')
        path_params = {}
        if 'alias' in params:
