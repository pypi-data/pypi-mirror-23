...
class MinimalCustomUrlCertificate(object):
    """
    ...
    def __init__(self, valid_after=None, valid_before=None, subject=None, href=None):
        """
        MinimalCustomUrlCertificate - a model defined in Swagger
    ...
    def valid_after(self):
        """
        Gets the valid_after of this MinimalCustomUrlCertificate.

        :return: The valid_after of this MinimalCustomUrlCertificate.
        :rtype: datetime
        """
    ...
    def valid_after(self, valid_after):
        """
        Sets the valid_after of this MinimalCustomUrlCertificate.

        :param valid_after: The valid_after of this MinimalCustomUrlCertificate.
        :type: datetime
        """
    ...
    def valid_before(self):
        """
        Gets the valid_before of this MinimalCustomUrlCertificate.

        :return: The valid_before of this MinimalCustomUrlCertificate.
        :rtype: datetime
        """
    ...
    def valid_before(self, valid_before):
        """
        Sets the valid_before of this MinimalCustomUrlCertificate.

        :param valid_before: The valid_before of this MinimalCustomUrlCertificate.
        :type: datetime
        """
    ...
    def subject(self):
        """
        Gets the subject of this MinimalCustomUrlCertificate.

        :return: The subject of this MinimalCustomUrlCertificate.
        :rtype: str
        """
    ...
    def subject(self, subject):
        """
        Sets the subject of this MinimalCustomUrlCertificate.

        :param subject: The subject of this MinimalCustomUrlCertificate.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this MinimalCustomUrlCertificate.

        :return: The href of this MinimalCustomUrlCertificate.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this MinimalCustomUrlCertificate.

        :param href: The href of this MinimalCustomUrlCertificate.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MinimalCustomUrlCertificate):
            return False
