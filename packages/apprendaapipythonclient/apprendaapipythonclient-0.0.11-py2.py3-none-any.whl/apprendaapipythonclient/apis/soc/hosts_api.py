...
class HostsApi(object):
    ...
    def api_v1_hosts_host_name_is_transitioning_get(self, host_name, **kwargs):
        """
        ...
        **Requires Platform version 6.5.1 or later**   Returns true if a sever is transitioning between states or false if the server is not transitioning   Learn more about [server states transitions](/current/Managing-Apprenda-Infrastructure#maintenancereserved). 
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_v1_hosts_host_name_is_transitioning_get(host_name, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.api_v1_hosts_host_name_is_transitioning_get_with_http_info(host_name, **kwargs)
        else:
            (data) = self.api_v1_hosts_host_name_is_transitioning_get_with_http_info(host_name, **kwargs)
            return data

    def api_v1_hosts_host_name_is_transitioning_get_with_http_info(self, host_name, **kwargs):
        """
        Check server transition
        **Requires Platform version 6.5.1 or later**   Returns true if a sever is transitioning between states or false if the server is not transitioning   Learn more about [server states transitions](/current/Managing-Apprenda-Infrastructure#maintenancereserved). 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_v1_hosts_host_name_is_transitioning_get_with_http_info(host_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v1_hosts_host_name_is_transitioning_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'host_name' is set
        if ('host_name' not in params) or (params['host_name'] is None):
            raise ValueError("Missing the required parameter `host_name` when calling `api_v1_hosts_host_name_is_transitioning_get`")
    ...
    def api_v1_hosts_host_name_state_get(self, host_name, **kwargs):
        """
        Get server state
        **Requires Platform version 6.5.1 or later**   Returns the current state of the server and a reason the server has been placed into a state.   Learn more about [server states transitions](/current/Managing-Apprenda-Infrastructure#maintenancereserved). 
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_v1_hosts_host_name_state_get(host_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.api_v1_hosts_host_name_state_get_with_http_info(host_name, **kwargs)
        else:
            (data) = self.api_v1_hosts_host_name_state_get_with_http_info(host_name, **kwargs)
            return data

    def api_v1_hosts_host_name_state_get_with_http_info(self, host_name, **kwargs):
        """
        Get server state
        **Requires Platform version 6.5.1 or later**   Returns the current state of the server and a reason the server has been placed into a state.   Learn more about [server states transitions](/current/Managing-Apprenda-Infrastructure#maintenancereserved). 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_v1_hosts_host_name_state_get_with_http_info(host_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_hosts_host_name_state_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'host_name' is set
        if ('host_name' not in params) or (params['host_name'] is None):
            raise ValueError("Missing the required parameter `host_name` when calling `api_v1_hosts_host_name_state_get`")
    ...
    def api_v1_hosts_host_name_state_put(self, host_name, node_state, **kwargs):
        """
        Update server state
        **Requires Platform version 6.5.1 or later**   Updates a server's state and initiates a state transition.   In the request body, send the state the server will be transitioned to and a reason the server is being transitioned. A server can be placed into the Online, Reserved, or Maintenance states and all state transitions will take affect imediately after a sucessfull request.    Learn more about [server states transitions](/current/Managing-Apprenda-Infrastructure#maintenancereserved). 
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_v1_hosts_host_name_state_put(host_name, node_state, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.api_v1_hosts_host_name_state_put_with_http_info(host_name, node_state, **kwargs)
        else:
            (data) = self.api_v1_hosts_host_name_state_put_with_http_info(host_name, node_state, **kwargs)
            return data

    def api_v1_hosts_host_name_state_put_with_http_info(self, host_name, node_state, **kwargs):
        """
        Update server state
        **Requires Platform version 6.5.1 or later**   Updates a server's state and initiates a state transition.   In the request body, send the state the server will be transitioned to and a reason the server is being transitioned. A server can be placed into the Online, Reserved, or Maintenance states and all state transitions will take affect imediately after a sucessfull request.    Learn more about [server states transitions](/current/Managing-Apprenda-Infrastructure#maintenancereserved). 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_v1_hosts_host_name_state_put_with_http_info(host_name, node_state, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_hosts_host_name_state_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'host_name' is set
        if ('host_name' not in params) or (params['host_name'] is None):
            raise ValueError("Missing the required parameter `host_name` when calling `api_v1_hosts_host_name_state_put`")
        # verify the required parameter 'node_state' is set
        if ('node_state' not in params) or (params['node_state'] is None):
            raise ValueError("Missing the required parameter `node_state` when calling `api_v1_hosts_host_name_state_put`")
