...
class RegistrySettingBase(object):
    """
    ...
    def __init__(self, name=None, href=None):
        """
        RegistrySettingBase - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this RegistrySettingBase.

        :return: The name of this RegistrySettingBase.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this RegistrySettingBase.

        :param name: The name of this RegistrySettingBase.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this RegistrySettingBase.

        :return: The href of this RegistrySettingBase.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this RegistrySettingBase.

        :param href: The href of this RegistrySettingBase.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RegistrySettingBase):
            return False
