...
class ByteArrayContent(object):
    ...
    def __init__(self, headers=None):
        """
        ByteArrayContent - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'headers': 'list[KeyValuePairStringIEnumerableString]'
        }
    ...
    def headers(self):
        """
        Gets the headers of this ByteArrayContent.

        :return: The headers of this ByteArrayContent.
        :rtype: list[KeyValuePairStringIEnumerableString]
        """
    ...
    def headers(self, headers):
        """
        Sets the headers of this ByteArrayContent.

        :param headers: The headers of this ByteArrayContent.
        :type: list[KeyValuePairStringIEnumerableString]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ByteArrayContent):
            return False
