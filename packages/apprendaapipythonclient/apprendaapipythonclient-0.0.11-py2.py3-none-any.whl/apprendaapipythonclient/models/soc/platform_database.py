...
class PlatformDatabase(object):
    ...
    def __init__(self, connectionstring=None, encryptedpassword=None, href=None, alias=None):
        """
        PlatformDatabase - a model defined in Swagger
    ...
    def connectionstring(self):
        """
        Gets the connectionstring of this PlatformDatabase.

        :return: The connectionstring of this PlatformDatabase.
        :rtype: str
        """
    ...
    def connectionstring(self, connectionstring):
        """
        Sets the connectionstring of this PlatformDatabase.

        :param connectionstring: The connectionstring of this PlatformDatabase.
        :type: str
        """
    ...
    def encryptedpassword(self):
        """
        Gets the encryptedpassword of this PlatformDatabase.

        :return: The encryptedpassword of this PlatformDatabase.
        :rtype: str
        """
    ...
    def encryptedpassword(self, encryptedpassword):
        """
        Sets the encryptedpassword of this PlatformDatabase.

        :param encryptedpassword: The encryptedpassword of this PlatformDatabase.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this PlatformDatabase.

        :return: The href of this PlatformDatabase.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this PlatformDatabase.

        :param href: The href of this PlatformDatabase.
        :type: str
        """
    ...
    def alias(self):
        """
        Gets the alias of this PlatformDatabase.

        :return: The alias of this PlatformDatabase.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this PlatformDatabase.

        :param alias: The alias of this PlatformDatabase.
        :type: str
        """
        if alias is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PlatformDatabase):
            return False
