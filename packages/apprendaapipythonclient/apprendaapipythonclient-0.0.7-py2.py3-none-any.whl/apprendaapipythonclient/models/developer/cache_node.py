...
class CacheNode(object):
    ...
    def __init__(self, host=None, port=None, password=None):
        """
        CacheNode - a model defined in Swagger
    ...
    def host(self):
        """
        Gets the host of this CacheNode.

        :return: The host of this CacheNode.
        :rtype: str
        """
        return self._host
    ...
    def host(self, host):
        """
        Sets the host of this CacheNode.

        :param host: The host of this CacheNode.
        :type: str
        """
    ...
    def port(self):
        """
        Gets the port of this CacheNode.

        :return: The port of this CacheNode.
        :rtype: int
        """
        return self._port
    ...
    def port(self, port):
        """
        Sets the port of this CacheNode.

        :param port: The port of this CacheNode.
        :type: int
        """
    ...
    def password(self):
        """
        Gets the password of this CacheNode.

        :return: The password of this CacheNode.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this CacheNode.

        :param password: The password of this CacheNode.
        :type: str
        """
