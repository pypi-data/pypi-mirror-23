...
class OverrideUserInfoDTO(object):
    """
    ...
    def __init__(self, id=None, first_name=None, last_name=None, email_address=None):
        """
        OverrideUserInfoDTO - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this OverrideUserInfoDTO.

        :return: The id of this OverrideUserInfoDTO.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this OverrideUserInfoDTO.

        :param id: The id of this OverrideUserInfoDTO.
        :type: str
        """
    ...
    def first_name(self):
        """
        Gets the first_name of this OverrideUserInfoDTO.

        :return: The first_name of this OverrideUserInfoDTO.
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """
        Sets the first_name of this OverrideUserInfoDTO.

        :param first_name: The first_name of this OverrideUserInfoDTO.
        :type: str
        """
    ...
    def last_name(self):
        """
        Gets the last_name of this OverrideUserInfoDTO.

        :return: The last_name of this OverrideUserInfoDTO.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """
        Sets the last_name of this OverrideUserInfoDTO.

        :param last_name: The last_name of this OverrideUserInfoDTO.
        :type: str
        """
    ...
    def email_address(self):
        """
        Gets the email_address of this OverrideUserInfoDTO.

        :return: The email_address of this OverrideUserInfoDTO.
        :rtype: str
        """
    ...
    def email_address(self, email_address):
        """
        Sets the email_address of this OverrideUserInfoDTO.

        :param email_address: The email_address of this OverrideUserInfoDTO.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, OverrideUserInfoDTO):
            return False
