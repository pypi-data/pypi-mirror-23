...
class AddOn(object):
    ...
    def is_enabled(self):
        """
        Gets the is_enabled of this AddOn.

        :return: The is_enabled of this AddOn.
        :rtype: bool
        """
    ...
    def is_enabled(self, is_enabled):
        """
        Sets the is_enabled of this AddOn.

        :param is_enabled: The is_enabled of this AddOn.
        :type: bool
        """
    ...
    def temp_location(self):
        """
        Gets the temp_location of this AddOn.

        :return: The temp_location of this AddOn.
        :rtype: str
        """
    ...
    def temp_location(self, temp_location):
        """
        Sets the temp_location of this AddOn.

        :param temp_location: The temp_location of this AddOn.
        :type: str
        """
    ...
    def user(self):
        """
        Gets the user of this AddOn.

        :return: The user of this AddOn.
        :rtype: str
        """
        return self._user
    ...
    def user(self, user):
        """
        Sets the user of this AddOn.

        :param user: The user of this AddOn.
        :type: str
        """
    ...
    def password(self):
        """
        Gets the password of this AddOn.
        returned null for security

        :return: The password of this AddOn.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this AddOn.
        returned null for security

        :param password: The password of this AddOn.
        :type: str
        """
    ...
    def dev_team_access(self):
        """
        Gets the dev_team_access of this AddOn.

        :return: The dev_team_access of this AddOn.
        :rtype: str
        """
    ...
    def dev_team_access(self, dev_team_access):
        """
        Sets the dev_team_access of this AddOn.

        :param dev_team_access: The dev_team_access of this AddOn.
        :type: str
        """
    ...
    def allowed_dev_teams(self):
        """
        Gets the allowed_dev_teams of this AddOn.
        will be null if Unrestricted dev team access is enabled

        :return: The allowed_dev_teams of this AddOn.
        :rtype: list[str]
        """
    ...
    def allowed_dev_teams(self, allowed_dev_teams):
        """
        Sets the allowed_dev_teams of this AddOn.
        will be null if Unrestricted dev team access is enabled

        :param allowed_dev_teams: The allowed_dev_teams of this AddOn.
        :type: list[str]
        """
