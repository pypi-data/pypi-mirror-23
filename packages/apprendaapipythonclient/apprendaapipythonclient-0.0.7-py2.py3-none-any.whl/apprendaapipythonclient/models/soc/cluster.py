...
class Cluster(object):
    ...
    def cloudid(self):
        """
        Gets the cloudid of this Cluster.

        :return: The cloudid of this Cluster.
        :rtype: int
        """
    ...
    def cloudid(self, cloudid):
        """
        Sets the cloudid of this Cluster.

        :param cloudid: The cloudid of this Cluster.
        :type: int
        """
        if cloudid is None:
    ...
    def username(self):
        """
        Gets the username of this Cluster.

        :return: The username of this Cluster.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this Cluster.

        :param username: The username of this Cluster.
        :type: str
        """
        if username is None:
    ...
    def password(self):
        """
        Gets the password of this Cluster.

        :return: The password of this Cluster.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this Cluster.

        :param password: The password of this Cluster.
        :type: str
        """
        if password is None:
    ...
    def gatewayhostnames(self):
        """
        Gets the gatewayhostnames of this Cluster.

        :return: The gatewayhostnames of this Cluster.
        :rtype: str
        """
    ...
    def gatewayhostnames(self, gatewayhostnames):
        """
        Sets the gatewayhostnames of this Cluster.

        :param gatewayhostnames: The gatewayhostnames of this Cluster.
        :type: str
        """
    ...
    def href(self):
        """
        Gets the href of this Cluster.

        :return: The href of this Cluster.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        ...
        :param href: The href of this Cluster.
        :type: str
        """
