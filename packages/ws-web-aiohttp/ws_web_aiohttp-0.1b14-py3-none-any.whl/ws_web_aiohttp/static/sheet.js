...
function apply_sheet_data(data_new) {
	console.log('apply_sheet_data', data_new);
        apply_data(data_new);
        $("textarea#script_pre").val(data_new.script_pre);
        $("textarea#script_pre_output").val(data_new.script_pre_output);
        $("textarea#script_post").val(data_new.script_post);
        $("textarea#script_post_output").val(data_new.script_post_output);
}
...
function sheet_page_load() {
	...
	$("#button_script_pre").click(function () {
		var text = $("textarea#script_pre").val();
		var data = {
			'type':'set_script_pre',
			'csrfmiddlewaretoken':csrftoken,
			'book_id':book_id,
		...
		socket_send(JSON.stringify(data));
	});

	$("#button_script_post").click(function () {
		var text = $("textarea#script_post").val();
		var data = {
	...
	$("div#script_pre_header").click(function() {
		$("div#script_pre").toggle();
	});
	$("div#script_post_header").click(function() {
		$("div#script_post").toggle();
	});
}
