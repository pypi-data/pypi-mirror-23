...
from hbt import is_java_file, is_xml_file, is_body_start, is_update_copyright_only
...
R109    src.xml  dest.xml
    ...
    fix: src/main/java/com/wlqq/checkout/Noisy.java
...
M   src/main/java/com/wlqq/shift/adapter/ConfirmOilPriceAdapter.java
  ...
  def test_is_update_copyright_only(self):
    self.assertFalse(is_update_copyright_only('post'))
    self.assertFalse(is_update_copyright_only('land'))
    self.assertTrue(is_update_copyright_only('copyright'))
