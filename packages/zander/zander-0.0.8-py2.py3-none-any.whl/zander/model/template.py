...
class TemplateConfig(object):
    ...
    def get_postcmd(self, project_dir):
        ret = []
        for item in self.data.get('postcmd', []):
            item['cwd'] = join(project_dir, item['cwd'])
