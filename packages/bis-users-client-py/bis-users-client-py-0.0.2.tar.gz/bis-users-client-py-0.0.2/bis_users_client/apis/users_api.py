...
class UsersApi(object):
    ...
    def list(self, **kwargs):
        ...
        :param str uid: Универсальный идентификатор
        :param str username: Логин
        :param str is_active: Активный?
    ...
    def list_with_http_info(self, **kwargs):
        ...
        all_params = ['uid', 'username', 'is_active', 'fields']
    ...
    def read_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.read_with_http_info(id, callback=callback_function)
        ...
        resource_path = '/api/users/{id}/'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
