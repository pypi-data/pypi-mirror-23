            ...
            if not callable(params):
                ...
                try:
                    ...
                    if hasattr(ret, 'headers'):
                        tracker._called_traced_data[external_id] = json.loads(ret.headers.get("X-Tingyun-Tx-Data", '{}'))
                    ...
                    if isinstance(ret, tuple):
                        tracker._called_traced_data[external_id] = json.loads(ret[0].get("x-tingyun-tx-data", '{}'))
